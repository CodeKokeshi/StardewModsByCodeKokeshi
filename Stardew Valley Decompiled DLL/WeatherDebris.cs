...
public class WeatherDebris
{
  ...
  public WeatherDebris(Vector2 position, int which, float rotationVelocity, float dx, float dy)
  {
    ...
    {
      case 0:
        this.sourceRect = new Rectangle(352, 1184, 16 /*0x10*/, 16 /*0x10*/);
        this.animationIntervalOffset = (Game1.random.Next(25) - 12) * 2;
        break;
      case 1:
        this.sourceRect = new Rectangle(352, 1200, 16 /*0x10*/, 16 /*0x10*/);
        this.animationIntervalOffset = (Game1.random.Next(25) - 12) * 2;
        break;
      case 2:
        this.sourceRect = new Rectangle(352, 1216, 16 /*0x10*/, 16 /*0x10*/);
        this.animationIntervalOffset = (Game1.random.Next(25) - 12) * 2;
        break;
      case 3:
  ...
  public void update(bool slow)
  {
    ...
    if (!Game1.fadeToBlack && (double) Game1.fadeToBlackAlpha <= 0.0)
    {
      if ((double) this.position.X < -80.0)
      {
        ...
        this.position.Y = (float) Game1.random.Next(0, Game1.viewport.Height - 64 /*0x40*/);
      }
      if ((double) this.position.Y > (double) (Game1.viewport.Height + 16 /*0x10*/))
      {
    ...
    switch (this.which)
    {
      ...
      case 3:
        ...
        if (this.which == 3)
          break;
        this.sourceRect.X = 352 + this.animationIndex * 16 /*0x10*/;
        break;
    }
  }
  ...
  {
    b.Draw(Game1.mouseCursors, this.position, new Rectangle?(this.sourceRect), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1E-06f);
  }
}
