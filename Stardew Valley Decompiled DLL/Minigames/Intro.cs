...
public class Intro : IMinigame
{
  ...
  public const int skyLoopWidth = 112 /*0x70*/;
  ...
  public const int busYRest = 240 /*0xF0*/;
  ...
  public Intro()
  {
    ...
    this.skyColor = new Color(64 /*0x40*/, 136, 248);
    this.roadColor = new Color(130, 130, 130);
    this.createBeginningOfLevel();
    Game1.player.FarmerSprite.SourceRect = new Rectangle(0, 0, 16 /*0x10*/, 32 /*0x20*/);
  ...
  public void createBeginningOfLevel()
  {
    ...
    for (int index = 0; index < this.screenWidth / 112 /*0x70*/ + 2; ++index)
      this.sky.Add(Game1.random.Choose<int>(0, 1, 1));
  ...
  public void updateRoad(GameTime time)
  {
    ...
    this.skyPosition += (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 12.0));
    ...
    this.treePosition += (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 2.0));
    if ((double) this.treePosition >= 256.0)
      this.treePosition -= 256f;
    this.valleyPosition += (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 6.0));
    ...
    else
    {
      if (this.carPosition.Equals(Vector2.Zero))
        return;
      this.carPosition.X -= (float) (0.10000000149011612 * time.ElapsedGameTime.TotalMilliseconds * ((double) this.carColor.G / 60.0));
  ...
  {
    this.bigCloudPosition += (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 24.0));
    if ((double) this.bigCloudPosition >= (double) (this.cloudTexture.Width * 3))
      this.bigCloudPosition -= (float) (this.cloudTexture.Width * 3);
    this.backCloudPosition += (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 36.0));
    ...
    if (Game1.random.NextDouble() < 0.0002)
    {
      ...
      if (Game1.random.NextDouble() < 0.1)
      {
        ...
        this.balloons.Add(new Intro.Balloon(this.screenWidth, this.screenHeight)
        {
          position = new Vector2(vector2.X + (float) Game1.random.Next(-16, 16 /*0x10*/), vector2.Y + (float) Game1.random.Next(8))
        });
        this.balloons.Add(new Intro.Balloon(this.screenWidth, this.screenHeight)
        {
          position = new Vector2(vector2.X + (float) Game1.random.Next(-16, 16 /*0x10*/), vector2.Y + (float) Game1.random.Next(8))
  ...
  public bool tick(GameTime time)
  {
    ...
    switch (this.currentState)
    {
      case 0:
        ...
        break;
      case 1:
        this.globalYPanDY = Math.Min(4f, this.globalYPanDY + (float) (time.ElapsedGameTime.TotalMilliseconds * ((double) this.speed / 140.0)));
        ...
        break;
      case 2:
        int num1 = this.screenHeight * this.pixelScale;
        int num2 = -Math.Max(0, 900 - Game1.graphics.GraphicsDevice.Viewport.Height);
        int num3 = -(int) (240.0 * (540.0 / (double) Game1.graphics.GraphicsDevice.Viewport.Height));
        this.globalYPanDY = Math.Max(1f, this.globalYPan / 100f);
        this.globalYPan -= this.globalYPanDY;
        if ((double) this.globalYPan <= (double) num3)
          this.globalYPan = (float) num3;
        this.transformMatrix = Matrix.CreateScale((float) this.pixelScale);
        this.transformMatrix.Translation = new Vector3(0.0f, this.globalYPan, 0.0f);
        this.updateRoad(time);
        if (Intro.roadNoise != null)
        {
          float val = (float) (((double) this.globalYPan - (double) num1) / (double) (num3 - num1) * 10.0 + 90.0);
      ...
      case 3:
        ...
        if ((double) this.drivingTimer > 4700.0)
        {
      ...
      case 4:
        ...
        {
          this.busPosition.X += (float) (time.ElapsedGameTime.TotalMilliseconds / 8.0);
          ...
          double num4 = elapsedGameTime.TotalMilliseconds / 70000.0;
          this.speed = Math.Max(0.0f, (float) (speed - num4));
          if (!this.addedSign)
          {
            this.addedSign = true;
          ...
          if ((double) this.speed <= 0.0 && this.birdPosition.Equals(Vector2.Zero))
          {
            ...
            this.birdPosition = new Vector2((float) ((double) (num5 * 16 /*0x10*/) - (double) this.roadPosition - 32.0 + 16.0), -16f);
            Game1.playSound("SpringBirds");
            this.fadeAlpha = 0.0f;
          }
          if (!this.birdPosition.Equals(Vector2.Zero) && (double) this.birdPosition.Y < 116.0)
          {
            float num6 = Math.Max(0.5f, (float) ((116.0 - (double) this.birdPosition.Y) / 116.0 * 2.0));
            this.birdPosition.Y += num6;
            this.birdPosition.X += (float) (Math.Sin((double) this.birdXTimer / (16.0 * Math.PI)) * (double) num6 / 2.0);
            double birdTimer = (double) this.birdTimer;
            elapsedGameTime = time.ElapsedGameTime;
            double totalMilliseconds1 = elapsedGameTime.TotalMilliseconds;
            this.birdTimer = (float) (birdTimer + totalMilliseconds1);
            double birdXtimer = (double) this.birdXTimer;
            elapsedGameTime = time.ElapsedGameTime;
            double totalMilliseconds2 = elapsedGameTime.TotalMilliseconds;
            this.birdXTimer = (float) (birdXtimer + totalMilliseconds2);
            if ((double) this.birdTimer >= 100.0)
            {
          ...
          {
            this.birdFrame = (double) this.birdTimer > 1500.0 ? 5 : 4;
            double birdTimer = (double) this.birdTimer;
            elapsedGameTime = time.ElapsedGameTime;
            double totalMilliseconds = elapsedGameTime.TotalMilliseconds;
            this.birdTimer = (float) (birdTimer + totalMilliseconds);
            if ((double) this.birdTimer > 2400.0 || (double) this.birdTimer > 1800.0 && Game1.random.NextDouble() < 0.006)
            {
              this.birdTimer = 0.0f;
              if (Game1.random.NextBool())
              {
          ...
          if ((double) this.drivingTimer > 14000.0)
          {
            ...
            elapsedGameTime = time.ElapsedGameTime;
            double num7 = elapsedGameTime.TotalMilliseconds * 0.10000000149011612 / 128.0;
            this.fadeAlpha = (float) (fadeAlpha + num7);
  ...
  public void receiveLeftClick(int x, int y, bool playSound = true)
  {
    ...
    for (int index = this.balloons.Count - 1; index >= 0; --index)
    {
      if (new Rectangle((int) this.balloons[index].position.X * 4 + 16 /*0x10*/, (int) this.balloons[index].position.Y * 4 + 16 /*0x10*/, 32 /*0x20*/, 32 /*0x20*/).Contains(x, y))
      {
        this.balloons.RemoveAt(index);
  ...
  public void releaseLeftClick(int x, int y) => this.characterCreateMenu?.releaseLeftClick(x, y);

  public void leftClickHeld(int x, int y) => this.characterCreateMenu?.leftClickHeld(x, y);
  ...
  public void draw(SpriteBatch b)
  {
    switch (this.currentState)
    {
      case 1:
        ...
        int x = 64 /*0x40*/;
        int y = Game1.graphics.GraphicsDevice.Viewport.Height - 64 /*0x40*/;
        int width = 0;
        int height = 64 /*0x40*/;
  ...
  public void drawRoadArea(SpriteBatch b)
  {
    ...
    b.Draw(Game1.staminaRect, new Rectangle(0, this.screenHeight / 2 + 80 /*0x50*/ - 100, this.screenWidth, this.screenHeight * 4), this.roadColor);
    for (int index = 0; index < this.screenWidth / 112 /*0x70*/ + 2; ++index)
    {
      if (this.sky[index] == 0)
      {
        b.Draw(this.texture, new Vector2(-this.skyPosition + (float) (index * 112 /*0x70*/) - (float) (index * 2), -16f), new Rectangle?(new Rectangle(129, 0, 110, 96 /*0x60*/)), Color.White);
      }
      else
      {
        Rectangle rectangle = new Rectangle(128 /*0x80*/, 0, 1, 96 /*0x60*/);
        b.Draw(this.texture, new Rectangle((int) -(double) this.skyPosition - 1 + index * 112 /*0x70*/ - index * 2, -16, 114, 96 /*0x60*/), new Rectangle?(rectangle), Color.White);
      }
    }
    for (int index = 0; index < 12; ++index)
    {
      b.Draw(Game1.mouseCursors, new Vector2((float) (-(double) this.valleyPosition / 2.0 - 10.0) + (float) (index * 639) - (float) (index * 2), 70f), new Rectangle?(new Rectangle(0, 886, 639, 148)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.08f);
      b.Draw(Game1.mouseCursors, new Vector2(-this.valleyPosition + (float) (index * 639) - (float) (index * 2), 80f), new Rectangle?(new Rectangle(0, 737, 639, 120)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.08f);
    }
    for (int index = 0; index < 8; ++index)
      b.Draw(this.treeStripTexture, new Vector2((float) (index * 256 /*0x0100*/) - this.treePosition, 110f), new Rectangle?(new Rectangle(0, 0, 256 /*0x0100*/, 64 /*0x40*/)), Color.White);
    for (int index = 0; index < this.road.Count; ++index)
    {
      if (index % 3 == 0)
      {
        b.Draw(this.texture, new Vector2((float) (index * 16 /*0x10*/) - this.roadPosition, 160f), new Rectangle?(new Rectangle(0, 176 /*0xB0*/, 48 /*0x30*/, 48 /*0x30*/)), Color.White);
        b.Draw(this.texture, new Vector2((float) (index * 16 /*0x10*/ + this.tileSize) - this.roadPosition, 272f), new Rectangle?(new Rectangle(0, 64 /*0x40*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White);
      }
      b.Draw(this.texture, new Vector2((float) (index * 16 /*0x10*/) - this.roadPosition, 208f), new Rectangle?(new Rectangle(this.road[index] * 16 /*0x10*/, 240 /*0xF0*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White);
    }
    for (int index = 0; index < this.roadsideObjects.Count; ++index)
    {
      ...
      {
        case 0:
          b.Draw(this.roadsideTexture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 32.0), 96f), new Rectangle?(new Rectangle(48 /*0x30*/, 0, 48 /*0x30*/, 96 /*0x60*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          break;
        case 1:
          b.Draw(this.roadsideTexture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 32.0), 96f), new Rectangle?(new Rectangle(0, 0, 48 /*0x30*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          b.Draw(this.roadsideTexture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 16.0), 160f), new Rectangle?(new Rectangle(16 /*0x10*/, 64 /*0x40*/, 16 /*0x10*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          break;
        case 2:
          b.Draw(this.roadsideTexture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 32.0), 176f), new Rectangle?(new Rectangle(112 /*0x70*/, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          break;
        case 3:
          b.Draw(this.roadsideTexture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 32.0), 176f), new Rectangle?(new Rectangle(112 /*0x70*/, 160 /*0xA0*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          break;
        case 5:
          b.Draw(this.texture, new Vector2((float) ((double) (index * 16 /*0x10*/) - (double) this.roadPosition - 32.0), 128f), new Rectangle?(new Rectangle(48 /*0x30*/, 176 /*0xB0*/, 64 /*0x40*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
          break;
      }
    }
    for (int index = 0; index < this.roadsideFences.Count; ++index)
    {
      if (this.roadsideFences[index] != -1)
      {
        if (this.roadsideFences[index] == 3)
          b.Draw(this.roadsideTexture, new Vector2((float) (index * 16 /*0x10*/) - this.roadPosition, 176f), new Rectangle?(new Rectangle(144 /*0x90*/, 256 /*0x0100*/, 16 /*0x10*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
        else
          b.Draw(this.roadsideTexture, new Vector2((float) (index * 16 /*0x10*/) - this.roadPosition, 176f), new Rectangle?(new Rectangle(128 /*0x80*/ + this.roadsideFences[index] * 16 /*0x10*/, 224 /*0xE0*/, 16 /*0x10*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
      }
    }
    if (!this.carPosition.Equals(Vector2.Zero))
    {
      b.Draw(this.texture, this.carPosition, new Rectangle?(new Rectangle(160 /*0xA0*/, 112 /*0x70*/, 80 /*0x50*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
      b.Draw(this.texture, this.carPosition, new Rectangle?(new Rectangle(160 /*0xA0*/, 176 /*0xB0*/, 80 /*0x50*/, 64 /*0x40*/)), this.carColor, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
    }
    b.Draw(this.texture, this.busPosition, new Rectangle?(new Rectangle(0, 0, 128 /*0x80*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0f);
    b.Draw(this.texture, this.busPosition + new Vector2(23.5f, 56.5f) * 1f, new Rectangle?(new Rectangle(21, 54, 5, 5)), Color.White, (float) ((double) this.roadPosition / 3.0 / 16.0 * Math.PI * 2.0), new Vector2(2.5f, 2.5f), 1f, SpriteEffects.None, 0.0f);
    b.Draw(this.texture, this.busPosition + new Vector2(87.5f, 56.5f) * 1f, new Rectangle?(new Rectangle(21, 54, 5, 5)), Color.White, (float) (((double) this.roadPosition + 4.0) / 3.0 / 16.0 * Math.PI * 2.0), new Vector2(2.5f, 2.5f), 1f, SpriteEffects.None, 0.0f);
    if (!this.birdPosition.Equals(Vector2.Zero))
      b.Draw(this.texture, this.birdPosition, new Rectangle?(new Rectangle(16 /*0x10*/ + this.birdFrame * 16 /*0x10*/, 64 /*0x40*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White);
  ...
  {
    this.pixelScale = Game1.graphics.GraphicsDevice.Viewport.Height >= 1000 ? (Game1.graphics.GraphicsDevice.Viewport.Width <= 2600 ? 4 : 5) : 3;
    this.transformMatrix = Matrix.CreateScale((float) this.pixelScale);
    Viewport viewport = Game1.graphics.GraphicsDevice.Viewport;
    this.screenWidth = viewport.Width / this.pixelScale;
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    this.screenHeight = viewport.Height / this.pixelScale;
    this.createBeginningOfLevel();
  }
  ...
  public class Balloon
  {
    ...
    public Balloon(int screenWidth, int screenHeight)
    {
      ...
      int r = Game1.random.Choose<int>((int) byte.MaxValue, 0);
    ...
    {
      this.position.Y -= (float) ((double) speed * time.ElapsedGameTime.TotalMilliseconds / 16.0);
      this.position.X -= (float) ((double) speed * time.ElapsedGameTime.TotalMilliseconds / 32.0);
    }
  }
}
