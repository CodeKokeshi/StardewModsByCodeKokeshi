...
public class TargetGame : IMinigame
{
  ...
  public TargetGame()
  {
    ...
    tool.attachments[0] = ItemRegistry.Create<StardewValley.Object>("(O)390", 999);
  ...
  public bool tick(GameTime time)
  {
    ...
    else if (!this.gameDone)
    {
      ...
      this.targets.RemoveAll((Predicate<TargetGame.Target>) (target => target.update(time, this.location)));
    }
  ...
  public void gameDoneAfterFade()
  {
    ...
    Game1.player.Position = Game1.year % 2 == 0 ? new Vector2(24f, 70f) * 64f : new Vector2(24f, 63f) * 64f;
    Game1.player.TemporaryPassableTiles.Add(new Microsoft.Xna.Framework.Rectangle(Game1.player.TilePoint.X * 64 /*0x40*/, Game1.player.TilePoint.Y * 64 /*0x40*/, 64 /*0x40*/, 64 /*0x40*/));
  ...
  public void draw(SpriteBatch b)
  {
    if (this.showResultsTimer < 0)
    {
      ...
      this.location.Map.RequireLayer("Back").Draw(Game1.mapDisplayDevice, Game1.viewport, Location.Origin, false, 4);
      ...
      double layerDepth = (double) Math.Max(0.0f, (float) ((double) Game1.player.StandingPixel.Y / 10000.0 + 0.00011000000085914508)) - 1.0000000116860974E-07;
      spriteBatch.Draw(shadowTexture, local, sourceRectangle, white, 0.0f, origin, (float) scale, SpriteEffects.None, (float) layerDepth);
      this.location.Map.RequireLayer("Buildings").Draw(Game1.mapDisplayDevice, Game1.viewport, Location.Origin, false, 4);
      ...
      b.Begin(blendState: BlendState.AlphaBlend, samplerState: SamplerState.PointClamp);
      Game1.mapDisplayDevice.BeginScene(b);
      this.location.Map.RequireLayer("Front").Draw(Game1.mapDisplayDevice, Game1.viewport, Location.Origin, false, 4);
      Game1.mapDisplayDevice.EndScene();
    ...
    {
      b.Begin(blendState: BlendState.AlphaBlend, samplerState: SamplerState.PointClamp);
      Vector2 position = new Vector2((float) (Game1.viewport.Width / 2 - 128 /*0x80*/), (float) (Game1.viewport.Height / 2 - 64 /*0x40*/));
  ...
  {
    Game1.viewport.X = this.location.Map.Layers[0].LayerWidth * 64 /*0x40*/ / 2 - Game1.viewport.Width / 2;
    Game1.viewport.Y = this.location.Map.Layers[0].LayerHeight * 64 /*0x40*/ / 2 - Game1.viewport.Height / 2;
  }
  ...
  public class Target
  {
    ...
    public static int farLane = 128 /*0x80*/;
    ...
    public static int pauseLeft = 256 /*0x0100*/;
    public static int pauseFarLeft = 128 /*0x80*/;
      ...
      int pauseTime = -1)
    {
      ...
      this.sourceRect = new Microsoft.Xna.Framework.Rectangle(289, 1184 + type * 16 /*0x10*/, 14, 14);
    }
    ...
    public bool update(GameTime time, GameLocation location)
    {
      ...
      if (this.Position.X < 0 || this.Position.Right > TargetGame.Target.spawnRightPosition + 64 /*0x40*/)
        return true;
    ...
    public void shatter(GameLocation location, Projectile stone)
    {
      ...
      location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(304, 1183 + this.targetType * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/), 60f, 3, 0, new Vector2((float) (this.Position.X - 4), (float) (this.Position.Y - 4)), false, false, 1f, 0.0f, Color.White, 4f, 0.0f, 0.0f, 0.0f));
    ...
    public void draw(SpriteBatch b)
    {
      if (!this.spawned)
        return;
      b.Draw(Game1.shadowTexture, Game1.GlobalToLocal(Game1.viewport, new Vector2((float) this.Position.X, (float) (this.Position.Bottom + 32 /*0x20*/))), new Microsoft.Xna.Framework.Rectangle?(Game1.shadowTexture.Bounds), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0001f);
