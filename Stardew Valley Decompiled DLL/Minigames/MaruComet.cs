...
public class MaruComet : IMinigame
{
  ...
  public void draw(SpriteBatch b)
  {
    ...
    Rectangle? sourceRectangle1 = new Rectangle?(new Rectangle(247, 0, 265, 240 /*0xF0*/));
    ...
    Rectangle? sourceRectangle2 = new Rectangle?(new Rectangle(247, 0, 265, 240 /*0xF0*/));
    ...
    b.Draw(this.cometTexture, this.centerOfScreen + new Vector2(-71f, -71f) * (float) this.zoom, new Rectangle?(new Rectangle((int) (Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 300.0 / 100.0) * 143, 240 /*0xF0*/, 143, 143)), Color.White, 0.0f, Vector2.Zero, (float) this.zoom, SpriteEffects.None, 0.2f);
    ...
    SpriteText.drawStringHorizontallyCenteredAt(b, this.currentString, (int) this.centerOfScreen.X, (int) y3, this.currentStringCharacter, height: 99999, layerDepth: 0.99f, color: new Color?(SpriteText.color_Purple), maxWidth: Game1.game1.localMultiplayerWindow.Width);
