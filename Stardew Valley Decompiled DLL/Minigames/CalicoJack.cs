...
public class CalicoJack : IMinigame
{
  ...
  public const int cardWidth = 96 /*0x60*/;
  ...
  public CalicoJack(int toBet = -1, bool highStakes = false)
  {
    ...
    this.r = Utility.CreateRandom((double) Club.timesPlayedCalicoJack, (double) Game1.stats.DaysPlayed, (double) Game1.uniqueIDForThisGame);
    ...
    int y1 = viewport.Height / 2 - 64 /*0x40*/;
    int widthOfString1 = SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11924") + "  ");
    this.hit = new ClickableComponent(new Rectangle(x1, y1, widthOfString1, 64 /*0x40*/), "", $" {Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11924")} ");
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    ...
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    int y2 = viewport.Height / 2 + 32 /*0x20*/;
    int widthOfString2 = SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11927") + "  ");
    this.stand = new ClickableComponent(new Rectangle(x2, y2, widthOfString2, 64 /*0x40*/), "", $" {Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11927")} ");
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    ...
    int width1 = SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11930")) + 64 /*0x40*/;
    this.doubleOrNothing = new ClickableComponent(new Rectangle(x3, y3, width1, 64 /*0x40*/), "", Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11930"));
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    ...
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    int y4 = (int) ((double) (viewport.Height / 2) / (double) Game1.options.zoomLevel) + 64 /*0x40*/ + 16 /*0x10*/;
    int width2 = SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11933")) + 64 /*0x40*/;
    this.playAgain = new ClickableComponent(new Rectangle(x4, y4, width2, 64 /*0x40*/), "", Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11933"));
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    ...
    viewport = Game1.graphics.GraphicsDevice.Viewport;
    int y5 = (int) ((double) (viewport.Height / 2) / (double) Game1.options.zoomLevel) + 64 /*0x40*/ + 96 /*0x60*/;
    int width3 = SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11936")) + 64 /*0x40*/;
    this.quit = new ClickableComponent(new Rectangle(x5, y5, width3, 64 /*0x40*/), "", Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11936"));
    ...
    else if (this.dealerTurnTimer > 0 && !this.showingResultsScreen)
    {
      ...
      if (this.dealerTurnTimer <= 0)
      {
        ...
        else if (num1 < 18 || num1 < num2 && num2 <= 21)
        {
          ...
          int num4 = 21 - num1;
          if (num2 == 20 && this.r.NextBool())
            num3 = num4 + this.r.Next(1, 4);
          else if (num2 == 19 && this.r.NextDouble() < 0.25)
            num3 = num4 + this.r.Next(1, 4);
          else if (num2 == 18 && this.r.NextDouble() < 0.1)
            num3 = num4 + this.r.Next(1, 4);
          if (this.r.NextDouble() < Math.Max(0.0005, 0.001 + Game1.player.DailyLuck / 20.0 + (double) Game1.player.LuckLevel * (1.0 / 500.0)))
          {
            num3 = 999;
            this.currentBet *= 3;
          }
          ...
          Game1.playSound(num3 == 999 ? "batScreech" : "shwip");
          if (num5 > 21)
            this.bustTimer = 2000;
        }
        else
  ...
  public void receiveLeftClick(int x, int y, bool playSound = true)
  {
    if (this.playButtonsActive() && this.bustTimer <= 0)
    {
      if (this.hit.bounds.Contains(x, y))
      {
        ...
        int optionA = 21 - num1;
        if (optionA > 1 && optionA < 6 && this.r.NextDouble() < 1.0 / (double) optionA)
          num2 = this.r.Choose<int>(optionA, optionA - 1);
  ...
  public void draw(SpriteBatch b)
  {
    ...
    Vector2 vector2_1 = new Vector2((float) (Game1.graphics.GraphicsDevice.Viewport.Width - 192 /*0xC0*/), 32f);
    ...
    if (this.showingResultsScreen)
    {
      SpriteText.drawStringWithScrollCenteredAt(b, this.endMessage, Game1.graphics.GraphicsDevice.Viewport.Width / 2, 48 /*0x30*/);
      SpriteText.drawStringWithScrollCenteredAt(b, this.endTitle, Game1.graphics.GraphicsDevice.Viewport.Width / 2, 128 /*0x80*/);
      if (!this.endTitle.Equals(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11951")))
      {
        ...
        SpriteText.drawStringWithScrollCenteredAt(b1, s, x, 256 /*0x0100*/, color: color2);
        SpriteBatch b2 = b;
        Texture2D mouseCursors = Game1.mouseCursors;
        viewport2 = Game1.graphics.GraphicsDevice.Viewport;
        Vector2 position = new Vector2((float) (viewport2.Width / 2 - 32 /*0x20*/ + SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11965", (object) $"{(this.playerWon ? "" : "-")}{this.currentBet.ToString()}   ")) / 2), 260f) + new Vector2(8f, 0.0f);
      ...
      if (this.playerWon)
      {
        ...
        SpriteText.drawString(b, this.doubleOrNothing.label, this.doubleOrNothing.bounds.X + 32 /*0x20*/, this.doubleOrNothing.bounds.Y + 8);
      }
      if (Game1.player.clubCoins >= this.currentBet)
      {
        ...
        SpriteText.drawString(b, this.playAgain.label, this.playAgain.bounds.X + 32 /*0x20*/, this.playAgain.bounds.Y + 8);
      }
      ...
      SpriteText.drawString(b, this.quit.label, this.quit.bounds.X + 32 /*0x20*/, this.quit.bounds.Y + 8);
    }
    else
    {
      ...
      foreach (int[] playerCard in this.playerCards)
      {
        int height2 = 144 /*0x90*/;
        if (playerCard[1] > 0)
          height2 = (int) ((double) Math.Abs((float) playerCard[1] - 200f) / 200.0 * 144.0);
        IClickableMenu.drawTextureBox(b, Game1.mouseCursors, playerCard[1] > 200 || playerCard[1] == -1 ? new Rectangle(399, 396, 15, 15) : new Rectangle(384, 396, 15, 15), (int) vector2_2.X, (int) vector2_2.Y + 72 - height2 / 2, 96 /*0x60*/, height2, Color.White, 4f);
        if (playerCard[1] == 0)
          SpriteText.drawStringHorizontallyCenteredAt(b, playerCard[0].ToString() ?? "", (int) vector2_2.X + 48 /*0x30*/ - 8 + 4, (int) vector2_2.Y + 72 - 16 /*0x10*/);
        vector2_2.X += 112f;
        if (playerCard[1] == 0)
          num1 += playerCard[0];
      }
      SpriteText.drawStringWithScrollBackground(b, $"{Game1.player.Name}: {num1.ToString()}", 160 /*0xA0*/, (int) vector2_2.Y + 144 /*0x90*/ + 32 /*0x20*/);
      vector2_2.X = 128f;
      vector2_2.Y = 128f;
      int num2 = 0;
      foreach (int[] dealerCard in this.dealerCards)
      {
        int height3 = 144 /*0x90*/;
        if (dealerCard[1] > 0)
          height3 = (int) ((double) Math.Abs((float) dealerCard[1] - 200f) / 200.0 * 144.0);
        IClickableMenu.drawTextureBox(b, Game1.mouseCursors, dealerCard[1] > 200 || dealerCard[1] == -1 ? new Rectangle(399, 396, 15, 15) : new Rectangle(384, 396, 15, 15), (int) vector2_2.X, (int) vector2_2.Y + 72 - height3 / 2, 96 /*0x60*/, height3, Color.White, 4f);
        if (dealerCard[1] == 0)
        {
          if (dealerCard[0] == 999)
            b.Draw(Game1.objectSpriteSheet, new Vector2((float) ((double) vector2_2.X + 48.0 - 32.0), (float) ((double) vector2_2.Y + 72.0 - 32.0)), new Rectangle?(new Rectangle(16 /*0x10*/, 592, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.9f);
          else
            SpriteText.drawStringHorizontallyCenteredAt(b, dealerCard[0].ToString() ?? "", (int) vector2_2.X + 48 /*0x30*/ - 8 + 4, (int) vector2_2.Y + 72 - 16 /*0x10*/);
        }
        vector2_2.X += 112f;
        switch (dealerCard[1])
        {
      ...
      SpriteText.drawStringWithScrollBackground(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11970", num2 >= 999 ? (object) "!!!" : (num2 > 0 ? (object) (num2.ToString() ?? "") : (object) "?")), 160 /*0xA0*/, 32 /*0x20*/);
      SpriteText.drawStringWithScrollBackground(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11972", (object) (this.currentBet.ToString() + this.coinBuffer)), 160 /*0xA0*/, Game1.graphics.GraphicsDevice.Viewport.Height / 2 - 48 /*0x30*/);
      Utility.drawWithShadow(b, Game1.mouseCursors, new Vector2((float) (172 + SpriteText.getWidthOfString(Game1.content.LoadString("Strings\\StringsFromCSFiles:CalicoJack.cs.11972", (object) this.currentBet))), (float) (Game1.graphics.GraphicsDevice.Viewport.Height / 2 + 4 - 48 /*0x30*/)), new Rectangle(211, 373, 9, 10), Color.White, 0.0f, Vector2.Zero, 4f, layerDepth: 1f);
      if (this.playButtonsActive())
      {
    ...
    if (Game1.IsMultiplayer)
    {
      ...
      viewport2 = Game1.graphics.GraphicsDevice.Viewport;
      double x = (double) viewport2.Width - (double) Game1.dialogueFont.MeasureString(Game1.getTimeOfDayString(Game1.timeOfDay)).X - 16.0;
      viewport2 = Game1.graphics.GraphicsDevice.Viewport;
      double y = (double) viewport2.Height - (double) Game1.dialogueFont.MeasureString(Game1.getTimeOfDayString(Game1.timeOfDay)).Y - 10.0;
      Vector2 position = new Vector2((float) x, (float) y);
      Color white = Color.White;
      Color shadowColor = Color.Black * 0.2f;
      Utility.drawTextWithColoredShadow(b3, timeOfDayString, dialogueFont, position, white, shadowColor);
    }
