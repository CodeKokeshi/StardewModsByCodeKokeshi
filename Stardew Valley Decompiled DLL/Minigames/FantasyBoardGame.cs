...
public class FantasyBoardGame : IMinigame
{
  ...
  public int slideSourceWidth = 128 /*0x80*/;
  public int slideSourceHeight = 64 /*0x40*/;
  ...
  public void draw(SpriteBatch b)
  {
    ...
    if (this.whichSlide >= 0)
    {
      ...
      b.Draw(this.border, vector2 + new Vector2((float) (Game1.viewport.Width / 2 - this.borderSourceWidth * 4 / 2), (float) (Game1.viewport.Height / 2 - this.borderSourceHeight * 4 / 2 - 128 /*0x80*/)), new Rectangle?(new Rectangle(0, 0, this.borderSourceWidth, this.borderSourceHeight)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0f);
      b.Draw(this.slides, vector2 + new Vector2((float) (Game1.viewport.Width / 2 - this.slideSourceWidth * 4 / 2), (float) (Game1.viewport.Height / 2 - this.slideSourceHeight * 4 / 2 - 128 /*0x80*/)), new Rectangle?(new Rectangle(this.whichSlide % 2 * this.slideSourceWidth, this.whichSlide / 2 * this.slideSourceHeight, this.slideSourceWidth, this.slideSourceHeight)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.01f);
    }
    else
    {
