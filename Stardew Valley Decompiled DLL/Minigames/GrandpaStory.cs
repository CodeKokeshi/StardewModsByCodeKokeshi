...
public class GrandpaStory : IMinigame
{
  ...
  public bool tick(GameTime time)
  {
    ...
    double num1 = foregroundFadeChange * milliseconds1;
    this.foregroundFade = (float) (foregroundFade + num1);
    ...
    switch (this.scene)
    {
      ...
      case 1:
        ...
        this.grandpaSpeechTimer = grandpaSpeechTimer2 + milliseconds2;
        ...
        if (this.letterReceived && (double) this.letterPosition.Y <= (double) Game1.viewport.Height)
        {
          ...
          double num2 = letterDyDy * milliseconds3;
          this.letterDy = (float) (letterDy1 + num2);
          ref float local1 = ref this.letterPosition.Y;
          double num3 = (double) local1;
          double letterDy2 = (double) this.letterDy;
          elapsedGameTime = time.ElapsedGameTime;
          double milliseconds4 = (double) elapsedGameTime.Milliseconds;
          double num4 = letterDy2 * milliseconds4;
          local1 = (float) (num3 + num4);
          ref float local2 = ref this.letterPosition.X;
          double num5 = (double) local2;
          elapsedGameTime = time.ElapsedGameTime;
          double num6 = 0.0099999997764825821 * (double) elapsedGameTime.Milliseconds;
          local2 = (float) (num5 + num6);
          double letterScale = (double) this.letterScale;
          elapsedGameTime = time.ElapsedGameTime;
          double num7 = 1.0 / 800.0 * (double) elapsedGameTime.Milliseconds;
          this.letterScale = (float) (letterScale + num7);
      ...
      case 3:
        ...
        this.grandpaSpeechTimer = grandpaSpeechTimer3 + milliseconds5;
      ...
      case 4:
        ...
        this.grandpaSpeechTimer = grandpaSpeechTimer4 + milliseconds6;
        ...
        if (this.grandpaSpeechTimer >= 7000)
        {
          ...
          elapsedGameTime = time.ElapsedGameTime;
          double num8 = 0.20000000298023224 * (double) elapsedGameTime.Milliseconds;
          this.panX = (float) (panX - num8);
      ...
      case 5:
        if ((double) this.panX > (double) (Math.Max(1600, Game1.viewport.Width) - 4800))
        {
          ...
          double panX = (double) this.panX;
          elapsedGameTime = time.ElapsedGameTime;
          double num9 = 0.20000000298023224 * (double) elapsedGameTime.Milliseconds;
        ...
        this.grandpaSpeechTimer = grandpaSpeechTimer5 + milliseconds7;
      ...
      case 6:
        ...
        this.grandpaSpeechTimer = grandpaSpeechTimer6 + milliseconds8;
        if (this.grandpaSpeechTimer >= 2000)
        {
          int parallaxPan = this.parallaxPan;
          elapsedGameTime = time.ElapsedGameTime;
          int num10 = (int) Math.Ceiling(0.1 * (double) elapsedGameTime.Milliseconds);
          this.parallaxPan = parallaxPan + num10;
        ...
        if (this.clickedLetter)
        {
          ...
          this.letterOpenTimer = letterOpenTimer + milliseconds9;
          break;
        }
        break;
    }
  ...
  public void draw(SpriteBatch b)
  {
    ...
    b.Draw(Game1.staminaRect, new Rectangle(0, 0, Game1.viewport.Width, Game1.viewport.Height), new Color(64 /*0x40*/, 136, 248));
    b.Draw(Game1.staminaRect, new Rectangle(0, 0, Game1.viewport.Width, Game1.viewport.Height), Color.Black * this.backgroundFade);
    if (this.drawGrandpa)
    {
      b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730), new Rectangle?(new Rectangle(427, this.totalMilliseconds % 300 < 150 ? 240 /*0xF0*/ : 0, 427, 240 /*0xF0*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
      ...
      b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730) + new Vector2(320f, 75f) * 3f, new Rectangle?(new Rectangle(427, 522, 70, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
      ...
      if (this.letterReceived)
      {
        ...
        b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730) + this.letterPosition, new Rectangle?(new Rectangle(729, 524, 131, 63 /*0x3F*/)), Color.White, 0.0f, Vector2.Zero, this.letterScale, SpriteEffects.None, 1f);
      }
    }
    else if (this.scene == 3)
      SpriteText.drawString(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:GrandpaStory.cs.12059"), (int) Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 0, 0, -200).X, (int) Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 0, 0, yOffset: -50).Y, 999, height: 999, layerDepth: 1f, color: new Color?(SpriteText.color_White));
    else if (this.scene == 4)
    {
      float num = (float) (1.0 - ((double) this.grandpaSpeechTimer - 7000.0) / 2000.0);
      b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730), new Rectangle?(new Rectangle(0, 0, 427, 240 /*0xF0*/)), Color.White * num, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
      ...
      b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730) + new Vector2(189f, 81f) * 3f, new Rectangle?(new Rectangle(426 + this.totalMilliseconds % 800 / 400 * 16 /*0x10*/, 581, 16 /*0x10*/, 16 /*0x10*/)), Color.White * num, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
    }
    ...
    if (this.scene == 6)
    {
      ...
      b.Draw(this.texture, Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 1294, 730), new Rectangle?(new Rectangle(this.parallaxPan, 240 /*0xF0*/, 320, 180)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
    ...
    if (this.mouseActive)
      b.Draw(Game1.mouseCursors, new Vector2((float) Game1.getOldMouseX(), (float) Game1.getOldMouseY()), new Rectangle?(Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, (float) (4.0 + (double) Game1.dialogueButtonScale / 150.0), SpriteEffects.None, 1f);
    b.End();
    Game1.PopUIMode();
    b.Begin(blendState: BlendState.AlphaBlend, samplerState: SamplerState.PointClamp);
    b.Draw(Game1.staminaRect, new Rectangle(0, 0, Game1.viewport.Width, Game1.viewport.Height), this.fadingToQuit ? new Color(64 /*0x40*/, 136, 248) * this.foregroundFade : Color.Black * this.foregroundFade);
    b.End();
  }
