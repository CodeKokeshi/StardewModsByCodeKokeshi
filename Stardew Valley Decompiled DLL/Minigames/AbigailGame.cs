...
{
  public const int mapWidth = 16 /*0x10*/;
  public const int mapHeight = 16 /*0x10*/;
  ...
  public const int baseTileSize = 16 /*0x10*/;
  ...
  public static int[,] map = new int[16 /*0x10*/, 16 /*0x10*/];
  public static int[,] nextMap = new int[16 /*0x10*/, 16 /*0x10*/];
  ...
  public static int TileSize => 48 /*0x30*/;
  ...
  {
    this.monsterChances[0] = new Vector2((float) (0.014000000432133675 + (double) this.whichRound * 0.004999999888241291), (float) (0.40999999642372131 + (double) this.whichRound * 0.05000000074505806));
    this.monsterChances[4] = new Vector2(1f / 500f, 0.1f);
  }

  public void reset(bool playingWithAbby)
  {
    this._borderTiles = new HashSet<Vector2>((IEnumerable<Vector2>) Utility.getBorderOfThisRectangle(new Rectangle(0, 0, 16 /*0x10*/, 16 /*0x10*/)));
    this.died = false;
    ...
    AbigailGame.newMapPosition = 16 /*0x10*/ * AbigailGame.TileSize;
      ...
      switch (which)
      {
        ...
        case 4:
          ...
          for (int index = 0; index < 30; ++index)
            AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, new Vector2((float) Game1.random.Next(1, 16 /*0x10*/), (float) Game1.random.Next(1, 16 /*0x10*/)) * (float) AbigailGame.TileSize + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
            {
        ...
        case 9:
          ...
          for (num = 0; ((double) Math.Abs((float) position.X - this.playerPosition.X) < 8.0 || (double) Math.Abs((float) position.Y - this.playerPosition.Y) < 8.0 || AbigailGame.isCollidingWithMap(position) || AbigailGame.isCollidingWithMonster(new Rectangle(position.X, position.Y, AbigailGame.TileSize, AbigailGame.TileSize), (AbigailGame.CowboyMonster) null)) && num < 10; ++num)
            position = new Point(Game1.random.Next(AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize), Game1.random.Next(AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize));
          if (num < 10)
          {
            AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 120f, 5, 0, this.playerPosition + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
            AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 120f, 5, 0, new Vector2((float) position.X, (float) position.Y) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
            AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 120f, 5, 0, new Vector2((float) (position.X - AbigailGame.TileSize / 2), (float) position.Y) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
            {
            ...
            AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 120f, 5, 0, new Vector2((float) position.X, (float) (position.Y - AbigailGame.TileSize / 2)) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
            {
  ...
  public static void addGuts(Point position, int whichGuts)
  {
    switch (whichGuts)
    {
      ...
      case 6:
      case 7:
        AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(512 /*0x0200*/, 1696, 16 /*0x10*/, 16 /*0x10*/), 80f, 6, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) position.X, (float) position.Y), false, Game1.random.NextBool(), 1f / 1000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
        AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(592, 1696, 16 /*0x10*/, 16 /*0x10*/), 10000f, 1, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) position.X, (float) position.Y), false, Game1.random.NextBool(), 1f / 1000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
        {
      ...
      case 1:
      case 4:
        AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(544, 1728, 16 /*0x10*/, 16 /*0x10*/), 80f, 4, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) position.X, (float) position.Y), false, Game1.random.NextBool(), 1f / 1000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
        break;
      case 3:
        AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) position.X, (float) position.Y), false, Game1.random.NextBool(), 1f / 1000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
        break;
    }
  }
  ...
  {
    AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(384, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 120f, 4, 2, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.gopherBox.X + AbigailGame.TileSize / 2), (float) (AbigailGame.gopherBox.Y + AbigailGame.TileSize / 2)), false, false, (float) AbigailGame.gopherBox.Y / 10000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
    {
  ...
  public void updateBullets(GameTime time)
  {
    for (int index1 = this.bullets.Count - 1; index1 >= 0; --index1)
    {
      ...
      if (this.bullets[index1].position.X <= 0 || this.bullets[index1].position.Y <= 0 || this.bullets[index1].position.X >= 768 /*0x0300*/ || this.bullets[index1].position.Y >= 768 /*0x0300*/)
        this.bullets.RemoveAt(index1);
      else if (AbigailGame.map[this.bullets[index1].position.X / 16 /*0x10*/ / 3, this.bullets[index1].position.Y / 16 /*0x10*/ / 3] == 7)
      {
        this.bullets.RemoveAt(index1);
      }
      else
            ...
            if (AbigailGame.monsters[index2].takeDamage(this.bullets[index1].damage))
            {
              ...
              if (AbigailGame.shootoutLevel)
              {
                if (AbigailGame.whichWave == 12 && AbigailGame.monsters[index2].type == -2)
                {
                  ...
                  {
                    AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(512 /*0x0200*/, 1696, 16 /*0x10*/, 16 /*0x10*/), 70f, 6, 0, new Vector2((float) (AbigailGame.monsters[index2].position.X + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize)), (float) (AbigailGame.monsters[index2].position.Y + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize))) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
                    {
                    ...
                    if (index3 % 4 == 0)
                      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, new Vector2((float) (AbigailGame.monsters[index2].position.X + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize)), (float) (AbigailGame.monsters[index2].position.Y + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize))) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
                      {
                        delayBeforeAnimationStart = index3 * 75
                      });
                    if (index3 % 3 == 0)
                      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(544, 1728, 16 /*0x10*/, 16 /*0x10*/), 100f, 4, 0, new Vector2((float) (AbigailGame.monsters[index2].position.X + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize)), (float) (AbigailGame.monsters[index2].position.Y + Game1.random.Next(-AbigailGame.TileSize, AbigailGame.TileSize))) + AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
                      {
                        delayBeforeAnimationStart = index3 * 75
                      });
                  }
    ...
    for (int index = AbigailGame.enemyBullets.Count - 1; index >= 0; --index)
    {
      ...
      else if (AbigailGame.map[(AbigailGame.enemyBullets[index].position.X + 6) / 16 /*0x10*/ / 3, (AbigailGame.enemyBullets[index].position.Y + 6) / 16 /*0x10*/ / 3] == 7)
        AbigailGame.enemyBullets.RemoveAt(index);
  ...
  public void playerDie()
  {
    ...
    if (AbigailGame.overworldSong != null && AbigailGame.overworldSong.IsPlaying)
      AbigailGame.overworldSong.Stop(AudioStopOptions.Immediate);
    AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1808, 16 /*0x10*/, 16 /*0x10*/), 120f, 5, 0, this.playerPosition + AbigailGame.topLeftScreenCoordinate, false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true));
    ...
    if (this.lives < 0)
    {
      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1808, 16 /*0x10*/, 16 /*0x10*/), 550f, 5, 0, this.playerPosition + AbigailGame.topLeftScreenCoordinate, false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
      {
        alpha = 1f / 1000f,
  ...
  public bool tick(GameTime time)
  {
    ...
    {
      int gamerestartTimer = this.gamerestartTimer;
      elapsedGameTime = time.ElapsedGameTime;
      int milliseconds = elapsedGameTime.Milliseconds;
      this.gamerestartTimer = gamerestartTimer - milliseconds;
      if (this.gamerestartTimer <= 0)
      {
        this.unload();
    ...
    {
      int fadethenQuitTimer = this.fadethenQuitTimer;
      elapsedGameTime = time.ElapsedGameTime;
      int milliseconds = elapsedGameTime.Milliseconds;
      this.fadethenQuitTimer = fadethenQuitTimer - milliseconds;
    ...
    {
      int abigailPortraitTimer = this.abigailPortraitTimer;
      elapsedGameTime = time.ElapsedGameTime;
      int milliseconds = elapsedGameTime.Milliseconds;
      this.abigailPortraitTimer = abigailPortraitTimer - milliseconds;
      if (this.abigailPortraitTimer > 1000 && this.abigailPortraitYposition > Game1.viewport.Height - 240 /*0xF0*/)
        this.abigailPortraitYposition -= 16 /*0x10*/;
    ...
    if (AbigailGame.endCutscene)
    {
      ...
      if (AbigailGame.endCutsceneTimer < 0)
      {
        ...
        {
          case 1:
            int num1 = (int) Game1.player.stats.Increment("completedPrairieKing");
            if (!this.died)
            {
              int num2 = (int) Game1.player.stats.Increment("completedPrairieKingWithoutDying");
            }
    ...
    {
      int motionPause = this.motionPause;
      elapsedGameTime = time.ElapsedGameTime;
      int milliseconds = elapsedGameTime.Milliseconds;
      this.motionPause = motionPause - milliseconds;
    ...
    if (AbigailGame.gopherTrain)
    {
      ...
      if (AbigailGame.gopherTrainPosition > 16 /*0x10*/ * AbigailGame.TileSize + AbigailGame.TileSize)
      {
    ...
    if (this.motionPause <= 0)
    {
      ...
      {
        int key1 = this.activePowerups.ElementAt<KeyValuePair<int, int>>(index).Key;
        Dictionary<int, int> activePowerups = this.activePowerups;
        int key2 = key1;
        Dictionary<int, int> dictionary = activePowerups;
        int key3 = key2;
        int num3 = activePowerups[key2];
        elapsedGameTime = time.ElapsedGameTime;
        int milliseconds = elapsedGameTime.Milliseconds;
        int num4 = num3 - milliseconds;
        dictionary[key3] = num4;
        if (this.activePowerups[key1] <= 0)
          this.activePowerups.Remove(key1);
      }
      if ((double) AbigailGame.deathTimer <= 0.0 && AbigailGame.playerMovementDirections.Count > 0 && !AbigailGame.scrollingMap)
      {
        ...
        this.playerMotionAnimationTimer = (float) (motionAnimationTimer + milliseconds3);
        this.playerMotionAnimationTimer %= 400f;
        double footstepSoundTimer = (double) this.playerFootstepSoundTimer;
        elapsedGameTime = time.ElapsedGameTime;
        double milliseconds4 = (double) elapsedGameTime.Milliseconds;
        this.playerFootstepSoundTimer = (float) (footstepSoundTimer - milliseconds4);
        if ((double) this.playerFootstepSoundTimer <= 0.0)
        {
          Game1.playSound("Cowboy_Footstep");
          this.playerFootstepSoundTimer = 200f;
        }
        AbigailGame.powerups.RemoveAll((Predicate<AbigailGame.CowboyPowerup>) (item =>
        {
        ...
        if (AbigailGame.waitingForPlayerToMoveDownAMap && this.playerBoundingBox.Bottom >= 16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize / 2)
        {
          this.SaveGame();
          AbigailGame.shopping = false;
          AbigailGame.merchantArriving = false;
      ...
      if (AbigailGame.shopping)
      {
        ...
        else if (AbigailGame.merchantShopOpen)
        {
          for (int index = this.storeItems.Count - 1; index >= 0; --index)
          {
            ...
            if (!this.playerBoundingBox.Intersects(this.shoppingCarpetNoPickup) && this.playerBoundingBox.Intersects(keyValuePair.Key) && this.coins >= this.getPriceForItem(keyValuePair.Value))
            {
              Game1.playSound("Cowboy_Secret");
              AbigailGame.holdItemTimer = 2500;
              this.motionPause = 2500;
              AbigailGame.itemToHold = keyValuePair.Value;
              this.storeItems.Remove(keyValuePair.Key);
      ...
      this.cactusDanceTimer = (float) (cactusDanceTimer + milliseconds5);
      ...
      if (this.shotTimer > 0)
      {
        ...
        this.shotTimer = shotTimer - milliseconds6;
      }
      if ((double) AbigailGame.deathTimer <= 0.0 && AbigailGame.playerShootingDirections.Count > 0 && this.shotTimer <= 0)
      {
        ...
        {
          this.spawnBullets((IList<int>) new int[1], this.playerPosition);
          this.spawnBullets((IList<int>) new int[1]{ 1 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[1]{ 2 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[1]{ 3 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[2]{ 0, 1 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[2]{ 1, 2 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[2]{ 2, 3 }, this.playerPosition);
          this.spawnBullets((IList<int>) new int[2]{ 3, 0 }, this.playerPosition);
        }
          ...
          this.spawnBullets((IList<int>) new int[1]
          {
          ...
          this.spawnBullets((IList<int>) AbigailGame.playerShootingDirections, this.playerPosition);
      ...
      foreach (AbigailGame.CowboyPowerup powerup in AbigailGame.powerups)
      {
        ...
        Vector2 vector2_5 = new Vector2((float) (powerup.position.X / AbigailGame.TileSize), (float) ((powerup.position.Y + 64 /*0x40*/) / AbigailGame.TileSize));
      ...
      else if ((double) AbigailGame.deathTimer <= 0.0 && !AbigailGame.waitingForPlayerToMoveDownAMap && !AbigailGame.shopping && !AbigailGame.shootoutLevel)
      {
        if (AbigailGame.waveTimer > 0)
        {
          ...
          if (!AbigailGame.hasGopherAppeared && AbigailGame.monsters.Count > 6 && Game1.random.NextDouble() < 0.0004 && AbigailGame.waveTimer > 7000 && AbigailGame.waveTimer < 50000)
          {
            ...
            AbigailGame.gopherBox = new Rectangle(Game1.random.Next(16 /*0x10*/ * AbigailGame.TileSize), Game1.random.Next(16 /*0x10*/ * AbigailGame.TileSize), AbigailGame.TileSize, AbigailGame.TileSize);
            int num;
            ...
            {
              AbigailGame.gopherBox.X = Game1.random.Next(16 /*0x10*/ * AbigailGame.TileSize);
              AbigailGame.gopherBox.Y = Game1.random.Next(16 /*0x10*/ * AbigailGame.TileSize);
            }
            if (num < 10)
              AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(256 /*0x0100*/, 1664, 16 /*0x10*/, 32 /*0x20*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.gopherBox.X + AbigailGame.TileSize / 2), (float) (AbigailGame.gopherBox.Y - AbigailGame.TileSize + AbigailGame.TileSize / 2)), false, false, (float) AbigailGame.gopherBox.Y / 10000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
              {
        ...
        for (int index1 = 0; index1 < 4; ++index1)
        {
          if (this.spawnQueue[index1].Count > 0)
          {
            ...
            {
              List<Vector2> borderOfThisRectangle = Utility.getBorderOfThisRectangle(new Rectangle(0, 0, 16 /*0x10*/, 16 /*0x10*/));
              ...
              if (num < 10)
              {
                AbigailGame.CowboyMonster cowboyMonster = new AbigailGame.CowboyMonster(this.spawnQueue[index1][0].X, new Point((int) vector2.X * AbigailGame.TileSize, (int) vector2.Y * AbigailGame.TileSize));
                if (this.whichRound > 0)
                  cowboyMonster.health += this.whichRound * 2;
                AbigailGame.monsters.Add(cowboyMonster);
            ...
            else
            {
              switch (index1)
              {
                case 0:
                  ...
                  {
                    if (Game1.random.NextBool() && !AbigailGame.isCollidingWithMonster(new Rectangle(index2 * 16 /*0x10*/ * 3, 0, 48 /*0x30*/, 48 /*0x30*/), (AbigailGame.CowboyMonster) null))
                    {
                      AbigailGame.CowboyMonster cowboyMonster = new AbigailGame.CowboyMonster(this.spawnQueue[index1][0].X, new Point(index2 * AbigailGame.TileSize, 0));
                      if (this.whichRound > 0)
                        cowboyMonster.health += this.whichRound * 2;
                      AbigailGame.monsters.Add(cowboyMonster);
                      this.spawnQueue[index1][0] = new Point(this.spawnQueue[index1][0].X, this.spawnQueue[index1][0].Y - 1);
                ...
                case 1:
                  ...
                  {
                    if (Game1.random.NextBool() && !AbigailGame.isCollidingWithMonster(new Rectangle(720, index3 * AbigailGame.TileSize, 48 /*0x30*/, 48 /*0x30*/), (AbigailGame.CowboyMonster) null))
                    {
                      AbigailGame.CowboyMonster cowboyMonster = new AbigailGame.CowboyMonster(this.spawnQueue[index1][0].X, new Point(15 * AbigailGame.TileSize, index3 * AbigailGame.TileSize));
                      if (this.whichRound > 0)
                        cowboyMonster.health += this.whichRound * 2;
                      AbigailGame.monsters.Add(cowboyMonster);
                      this.spawnQueue[index1][0] = new Point(this.spawnQueue[index1][0].X, this.spawnQueue[index1][0].Y - 1);
                ...
                case 2:
                  ...
                  {
                    if (Game1.random.NextBool() && !AbigailGame.isCollidingWithMonster(new Rectangle(index4 * 16 /*0x10*/ * 3, 15 * AbigailGame.TileSize, 48 /*0x30*/, 48 /*0x30*/), (AbigailGame.CowboyMonster) null))
                    {
                      AbigailGame.CowboyMonster cowboyMonster = new AbigailGame.CowboyMonster(this.spawnQueue[index1][0].X, new Point(index4 * AbigailGame.TileSize, 15 * AbigailGame.TileSize));
                      if (this.whichRound > 0)
                        cowboyMonster.health += this.whichRound * 2;
                      AbigailGame.monsters.Add(cowboyMonster);
                      this.spawnQueue[index1][0] = new Point(this.spawnQueue[index1][0].X, this.spawnQueue[index1][0].Y - 1);
                ...
                case 3:
                  ...
                  {
                    if (Game1.random.NextBool() && !AbigailGame.isCollidingWithMonster(new Rectangle(0, index5 * AbigailGame.TileSize, 48 /*0x30*/, 48 /*0x30*/), (AbigailGame.CowboyMonster) null))
                    {
                      AbigailGame.CowboyMonster cowboyMonster = new AbigailGame.CowboyMonster(this.spawnQueue[index1][0].X, new Point(0, index5 * AbigailGame.TileSize));
                      if (this.whichRound > 0)
                        cowboyMonster.health += this.whichRound * 2;
                      AbigailGame.monsters.Add(cowboyMonster);
                      this.spawnQueue[index1][0] = new Point(this.spawnQueue[index1][0].X, this.spawnQueue[index1][0].Y - 1);
        ...
        if (AbigailGame.waveTimer <= 0 && AbigailGame.monsters.Count == 0 && this.isSpawnQueueEmpty())
        {
          ...
          switch (AbigailGame.whichWave)
          {
            ...
            case 7:
              if (this.monsterChances[5].Equals(Vector2.Zero))
              {
                ...
                if (this.whichRound > 0)
                  this.monsterChances[5] = new Vector2((float) (0.0099999997764825821 + (double) this.whichRound * 0.0040000001899898052), (float) (0.15000000596046448 + (double) this.whichRound * 0.039999999105930328));
              }
            ...
            case 11:
              ...
              if (this.monsterChances[3].Equals(Vector2.Zero))
              {
                ...
                if (this.whichRound > 0)
                  this.monsterChances[3] = new Vector2((float) (0.012000000104308128 + (double) this.whichRound * 0.004999999888241291), (float) (0.40000000596046448 + (double) this.whichRound * 0.075000002980232239));
              }
          ...
          if (this.whichRound > 0)
          {
            ...
            {
              Vector2 monsterChance = this.monsterChances[index];
  ...
  public virtual void ApplyLevelSpecificStates()
  {
    if (AbigailGame.whichWave == 12)
    {
      ...
      AbigailGame.Dracula dracula = new AbigailGame.Dracula();
      if (this.whichRound > 0)
        dracula.health *= 2;
      AbigailGame.monsters.Add((AbigailGame.CowboyMonster) dracula);
    }
    else
    {
  ...
  public void updateAbigail(GameTime time)
  {
    ...
    if (this.player2MovementDirections.Count > 0)
    {
      ...
      AbigailGame.powerups.RemoveAll((Predicate<AbigailGame.CowboyPowerup>) (item => this.player2BoundingBox.Intersects(new Rectangle(item.position.X, item.position.Y, AbigailGame.TileSize, AbigailGame.TileSize)) && !this.player2BoundingBox.Intersects(this.noPickUpBox)));
    }
    ...
    if (this.player2ShootingDirections.Count == 1)
      ...
      this.spawnBullets((IList<int>) this.player2ShootingDirections, AbigailGame.player2Position);
    Game1.playSound("Cowboy_gunshot");
  ...
  {
    int[,] map = new int[16 /*0x10*/, 16 /*0x10*/];
    for (int index1 = 0; index1 < 16 /*0x10*/; ++index1)
    {
      for (int index2 = 0; index2 < 16 /*0x10*/; ++index2)
    ...
    switch (wave)
    {
        ...
        for (int index5 = 0; index5 < 16 /*0x10*/; ++index5)
        {
          for (int index6 = 0; index6 < 16 /*0x10*/; ++index6)
          {
            if (map[index5, index6] == 5)
              map[index5, index6] = Game1.random.Choose<int>(0, 1);
          }
        }
        for (int index = 0; index < 16 /*0x10*/; ++index)
          map[index, 8] = Game1.random.Choose<int>(8, 9);
        map[8, 4] = 7;
        map[8, 12] = 7;
        map[9, 12] = 7;
        map[7, 12] = 7;
      ...
      case 11:
        ...
        break;
      case 12:
        for (int index7 = 0; index7 < 16 /*0x10*/; ++index7)
        {
  ...
  public void spawnBullets(IList<int> directions, Vector2 spawn)
  {
    ...
    {
      if (!directions.Contains(2) || !directions.Contains(3))
        return;
      position.X -= AbigailGame.TileSize / 2;
      position.Y += AbigailGame.TileSize / 4;
      this.bullets.Add(new AbigailGame.CowboyBullet(position, new Point(-movementSpeed, movementSpeed), this.bulletDamage));
  ...
  public static bool isCollidingWithMonster(Rectangle r, AbigailGame.CowboyMonster subject)
  {
    foreach (AbigailGame.CowboyMonster monster in AbigailGame.monsters)
    {
      if ((subject == null || !subject.Equals((object) monster)) && Math.Abs(monster.position.X - r.X) < 48 /*0x30*/ && Math.Abs(monster.position.Y - r.Y) < 48 /*0x30*/ && r.Intersects(new Rectangle(monster.position.X, monster.position.Y, 48 /*0x30*/, 48 /*0x30*/)))
        return true;
    }
    return false;
  }
  ...
  public static bool isCollidingWithMapForMonsters(Rectangle positionToCheck)
  {
    for (int corner = 0; corner < 4; ++corner)
    {
      ...
      if ((double) cornersOfThisRectangle.X < 0.0 || (double) cornersOfThisRectangle.Y < 0.0 || (double) cornersOfThisRectangle.X >= 768.0 || (double) cornersOfThisRectangle.Y >= 768.0 || !AbigailGame.isMapTilePassableForMonsters(AbigailGame.map[(int) cornersOfThisRectangle.X / 16 /*0x10*/ / 3, (int) cornersOfThisRectangle.Y / 16 /*0x10*/ / 3]))
        return true;
    }
    return false;
  }
  ...
  public static bool isCollidingWithMap(Rectangle positionToCheck)
  {
    ...
    {
      Vector2 cornersOfThisRectangle = Utility.getCornersOfThisRectangle(ref positionToCheck, corner);
      if ((double) cornersOfThisRectangle.X < 0.0 || (double) cornersOfThisRectangle.Y < 0.0 || (double) cornersOfThisRectangle.X >= 768.0 || (double) cornersOfThisRectangle.Y >= 768.0 || !AbigailGame.isMapTilePassable(AbigailGame.map[(int) cornersOfThisRectangle.X / 16 /*0x10*/ / 3, (int) cornersOfThisRectangle.Y / 16 /*0x10*/ / 3]))
        return true;
    }
    return false;
  }
  ...
  {
    Rectangle r = new Rectangle(position.X, position.Y, 48 /*0x30*/, 48 /*0x30*/);
    for (int corner = 0; corner < 4; ++corner)
    {
  ...
  public void draw(SpriteBatch b)
  {
    ...
    if (AbigailGame.onStartMenu)
    {
      b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 0.97f);
      b.Draw(Game1.mouseCursors, new Vector2((float) (Game1.viewport.Width / 2 - 3 * AbigailGame.TileSize), AbigailGame.topLeftScreenCoordinate.Y + (float) (5 * AbigailGame.TileSize)), new Rectangle?(new Rectangle(128 /*0x80*/, 1744, 96 /*0x60*/, 56)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
    }
    else if ((AbigailGame.gameOver || this.gamerestartTimer > 0) && !AbigailGame.endCutscene)
    {
      b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 0.0001f);
    ...
    else if (AbigailGame.endCutscene)
    {
      switch (AbigailGame.endCutscenePhase)
      {
        case 0:
          b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 0.0001f);
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(384, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White * (AbigailGame.endCutsceneTimer < 2000 ? (float) (1.0 * ((double) AbigailGame.endCutsceneTimer / 2000.0)) : 1f), 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 1000.0));
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize * 2 / 3)) + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(320 + AbigailGame.itemToHold * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White * (AbigailGame.endCutsceneTimer < 2000 ? (float) (1.0 * ((double) AbigailGame.endCutsceneTimer / 2000.0)) : 1f), 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 500.0));
          break;
        case 1:
        case 2:
        case 3:
          for (int x = 0; x < 16 /*0x10*/; ++x)
          {
            for (int y = 0; y < 16 /*0x10*/; ++y)
              b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) x, (float) y) * 16f * 3f + new Vector2(0.0f, (float) (AbigailGame.newMapPosition - 16 /*0x10*/ * AbigailGame.TileSize)), new Rectangle?(new Rectangle(464 + 16 /*0x10*/ * AbigailGame.map[x, y] + (AbigailGame.map[x, y] != 5 || (double) this.cactusDanceTimer <= 800.0 ? 0 : 16 /*0x10*/), 1680 - AbigailGame.world * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.0f);
          }
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (6 * AbigailGame.TileSize), (float) (3 * AbigailGame.TileSize)), new Rectangle?(new Rectangle(288, 1697, 64 /*0x40*/, 80 /*0x50*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.01f);
          if (AbigailGame.endCutscenePhase == 3)
          {
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (9 * AbigailGame.TileSize), (float) (7 * AbigailGame.TileSize)), new Rectangle?(new Rectangle(544, 1792 /*0x0700*/, 32 /*0x20*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.05f);
            if (AbigailGame.endCutsceneTimer < 3000)
            {
              b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black * (float) (1.0 - (double) AbigailGame.endCutsceneTimer / 3000.0), 0.0f, Vector2.Zero, SpriteEffects.None, 1f);
              break;
            }
            break;
          }
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (10 * AbigailGame.TileSize), (float) (8 * AbigailGame.TileSize)), new Rectangle?(new Rectangle(272 - AbigailGame.endCutsceneTimer / 300 % 4 * 16 /*0x10*/, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.02f);
          if (AbigailGame.endCutscenePhase == 2)
          {
            ...
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition, new Rectangle?(new Rectangle(384, 1760, 16 /*0x10*/, 13)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 500.0 + 1.0 / 1000.0));
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize * 2 / 3 - AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(320 + AbigailGame.itemToHold * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 0.004999999888241291));
          }
          b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black * (AbigailGame.endCutscenePhase != 1 || AbigailGame.endCutsceneTimer <= 12500 ? 0.0f : (float) ((AbigailGame.endCutsceneTimer - 12500) / 3000)), 0.0f, Vector2.Zero, SpriteEffects.None, 1f);
          break;
        case 4:
        case 5:
          b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 0.97f);
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (6 * AbigailGame.TileSize), (float) (3 * AbigailGame.TileSize)), new Rectangle?(new Rectangle(224 /*0xE0*/, 1744, 64 /*0x40*/, 48 /*0x30*/)), Color.White * (AbigailGame.endCutsceneTimer > 0 ? (float) (1.0 - ((double) AbigailGame.endCutsceneTimer - 2000.0) / 2000.0) : 1f), 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
    ...
    else
    {
      ...
      {
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition, new Rectangle?(new Rectangle(384 + (AbigailGame.zombieModeTimer / 200 % 2 == 0 ? 16 /*0x10*/ : 0), 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
        for (int y = (int) ((double) this.playerPosition.Y - (double) AbigailGame.TileSize); y > -AbigailGame.TileSize; y -= AbigailGame.TileSize)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2(this.playerPosition.X, (float) y), new Rectangle?(new Rectangle(368 + (y / AbigailGame.TileSize % 3 == 0 ? 16 /*0x10*/ : 0), 1744, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 1f);
        b.End();
        return;
      }
      for (int x = 0; x < 16 /*0x10*/; ++x)
      ...
      if (AbigailGame.scrollingMap)
      {
        ...
        {
          for (int y = 0; y < 16 /*0x10*/; ++y)
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) x, (float) y) * 16f * 3f + new Vector2(0.0f, (float) AbigailGame.newMapPosition), new Rectangle?(new Rectangle(464 + 16 /*0x10*/ * AbigailGame.nextMap[x, y] + (AbigailGame.nextMap[x, y] != 5 || (double) this.cactusDanceTimer <= 800.0 ? 0 : 16 /*0x10*/), 1680 - AbigailGame.world * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.0f);
        }
        b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, -1, 16 /*0x10*/ * AbigailGame.TileSize, (int) AbigailGame.topLeftScreenCoordinate.Y), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 1f);
        b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y + 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize, (int) AbigailGame.topLeftScreenCoordinate.Y + 2), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 1f);
      }
      if ((double) AbigailGame.deathTimer <= 0.0 && (AbigailGame.playerInvincibleTimer <= 0 || AbigailGame.playerInvincibleTimer / 100 % 2 == 0))
      {
        if (AbigailGame.holdItemTimer > 0)
        {
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(384, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 1000.0));
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize * 2 / 3)) + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(320 + AbigailGame.itemToHold * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 500.0));
        }
        else if (AbigailGame.zombieModeTimer > 0)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(352 + (AbigailGame.zombieModeTimer / 50 % 2 == 0 ? 16 /*0x10*/ : 0), 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 1000.0));
        else if (AbigailGame.playerMovementDirections.Count == 0 && AbigailGame.playerShootingDirections.Count == 0)
        {
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(496, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 1000.0));
        }
        else
        {
          ...
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(3f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(464 + num * 16 /*0x10*/, 1744, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 500.0 + 1.0 / 1000.0));
        }
      }
      if (AbigailGame.playingWithAbigail && this.player2deathtimer <= 0 && (this.player2invincibletimer <= 0 || this.player2invincibletimer / 100 % 2 == 0))
      {
        ...
        {
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + AbigailGame.player2Position + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(256 /*0x0100*/, 1728, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.playerPosition.Y / 10000.0 + 1.0 / 1000.0));
        }
        else
        {
          ...
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + AbigailGame.player2Position + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(224 /*0xE0*/ + num * 16 /*0x10*/, 1712, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) AbigailGame.player2Position.Y / 10000.0 + 1.0 / 500.0 + 1.0 / 1000.0));
        }
      }
      ...
      if (AbigailGame.shopping)
      {
        ...
        {
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.merchantBox.Location.X, (float) this.merchantBox.Location.Y), new Rectangle?(new Rectangle(464 + (AbigailGame.shoppingTimer / 100 % 2 == 0 ? 16 /*0x10*/ : 0), 1728, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.merchantBox.Y / 10000.0 + 1.0 / 1000.0));
        }
        else
        {
          ...
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.merchantBox.Location.X, (float) this.merchantBox.Location.Y), new Rectangle?(new Rectangle(496 + num1 * 16 /*0x10*/, 1728, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.merchantBox.Y / 10000.0 + 1.0 / 1000.0));
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (this.merchantBox.Location.X - AbigailGame.TileSize), (float) (this.merchantBox.Location.Y + AbigailGame.TileSize)), new Rectangle?(new Rectangle(529, 1744, 63 /*0x3F*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.merchantBox.Y / 10000.0 + 1.0 / 1000.0));
          foreach (KeyValuePair<Rectangle, int> storeItem in this.storeItems)
          {
            ...
            Rectangle? sourceRectangle = new Rectangle?(new Rectangle(320 + storeItem.Value * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/));
      ...
      foreach (AbigailGame.CowboyMonster monster in AbigailGame.monsters)
        monster.draw(b);
      if (AbigailGame.gopherRunning)
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) AbigailGame.gopherBox.X, (float) AbigailGame.gopherBox.Y), new Rectangle?(new Rectangle(320 + AbigailGame.waveTimer / 100 % 4 * 16 /*0x10*/, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) AbigailGame.gopherBox.Y / 10000.0 + 1.0 / 1000.0));
      if (AbigailGame.gopherTrain && AbigailGame.gopherTrainPosition > -AbigailGame.TileSize)
      {
        b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), Color.Black, 0.0f, Vector2.Zero, SpriteEffects.None, 0.95f);
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2(this.playerPosition.X - (float) (AbigailGame.TileSize / 2), (float) AbigailGame.gopherTrainPosition), new Rectangle?(new Rectangle(384 + AbigailGame.gopherTrainPosition / 30 % 4 * 16 /*0x10*/, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.96f);
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2(this.playerPosition.X + (float) (AbigailGame.TileSize / 2), (float) AbigailGame.gopherTrainPosition), new Rectangle?(new Rectangle(384 + AbigailGame.gopherTrainPosition / 30 % 4 * 16 /*0x10*/, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.96f);
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2(this.playerPosition.X, (float) (AbigailGame.gopherTrainPosition - AbigailGame.TileSize * 3)), new Rectangle?(new Rectangle(320 + AbigailGame.gopherTrainPosition / 30 % 4 * 16 /*0x10*/, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.96f);
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2(this.playerPosition.X - (float) (AbigailGame.TileSize / 2), (float) (AbigailGame.gopherTrainPosition - AbigailGame.TileSize)), new Rectangle?(new Rectangle(400, 1728, 32 /*0x20*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.97f);
        if (AbigailGame.holdItemTimer > 0)
        {
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(384, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.98f);
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize * 2 / 3)) + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(320 + AbigailGame.itemToHold * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.99f);
        }
        else
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + this.playerPosition + new Vector2(0.0f, (float) (-AbigailGame.TileSize / 4)), new Rectangle?(new Rectangle(464, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.98f);
      }
      else
      {
        ...
        if (this.heldItem != null)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate - new Vector2((float) (AbigailGame.TileSize + 18), -9f), new Rectangle?(new Rectangle(272 + this.heldItem.which * 16 /*0x10*/, 1808, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate - new Vector2((float) (AbigailGame.TileSize * 2), (float) (-AbigailGame.TileSize - 18)), new Rectangle?(new Rectangle(400, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        ...
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate - new Vector2((float) (AbigailGame.TileSize * 2), (float) (-AbigailGame.TileSize * 2 - 18)), new Rectangle?(new Rectangle(272, 1808, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        ...
        for (int index = 0; index < AbigailGame.whichWave + this.whichRound * 12; ++index)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (AbigailGame.TileSize * 16 /*0x10*/ + 3), (float) (index * 3 * 6)), new Rectangle?(new Rectangle(512 /*0x0200*/, 1760, 5, 5)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        ...
        if (!AbigailGame.shootoutLevel)
          b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X + 30, (int) AbigailGame.topLeftScreenCoordinate.Y - AbigailGame.TileSize / 2 + 3, (int) ((double) (16 /*0x10*/ * AbigailGame.TileSize - 30) * ((double) AbigailGame.waveTimer / 80000.0)), AbigailGame.TileSize / 4), AbigailGame.waveTimer < 8000 ? new Color(188, 51, 74) : new Color(147, 177, 38));
        if (AbigailGame.betweenWaveTimer > 0 && AbigailGame.whichWave == 0 && !AbigailGame.scrollingMap)
        {
          Vector2 position = new Vector2((float) (Game1.viewport.Width / 2 - 120), (float) (Game1.viewport.Height - 144 /*0x90*/ - 3));
          if (!Game1.options.gamepadControls)
            b.Draw(Game1.mouseCursors, position, new Rectangle?(new Rectangle(352, 1648, 80 /*0x50*/, 48 /*0x30*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.99f);
          else
            b.Draw(Game1.controllerMaps, position, new Rectangle?(Utility.controllerMapSourceRect(new Rectangle(681, 157, 160 /*0xA0*/, 96 /*0x60*/))), Color.White, 0.0f, Vector2.Zero, 1.5f, SpriteEffects.None, 0.99f);
        }
        if (this.bulletDamage > 1)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (-AbigailGame.TileSize - 3), (float) (16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize)), new Rectangle?(new Rectangle(416 + (this.ammoLevel - 1) * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        if (this.fireSpeedLevel > 0)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (-AbigailGame.TileSize - 3), (float) (16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize * 2)), new Rectangle?(new Rectangle(320 + (this.fireSpeedLevel - 1) * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        if (this.runSpeedLevel > 0)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (-AbigailGame.TileSize - 3), (float) (16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize * 3)), new Rectangle?(new Rectangle(368 + (this.runSpeedLevel - 1) * 16 /*0x10*/, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
        if (this.spreadPistol)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (-AbigailGame.TileSize - 3), (float) (16 /*0x10*/ * AbigailGame.TileSize - AbigailGame.TileSize * 4)), new Rectangle?(new Rectangle(464, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, 0.5f);
      }
      if (AbigailGame.screenFlash > 0)
        b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y, 16 /*0x10*/ * AbigailGame.TileSize, 16 /*0x10*/ * AbigailGame.TileSize), new Rectangle?(Game1.staminaRect.Bounds), new Color((int) byte.MaxValue, 214, 168), 0.0f, Vector2.Zero, SpriteEffects.None, 1f);
    }
    if (this.fadethenQuitTimer > 0)
    ...
    if (this.abigailPortraitTimer > 0)
    {
      b.Draw(this.abigail.Portrait, new Vector2(AbigailGame.topLeftScreenCoordinate.X + (float) (16 /*0x10*/ * AbigailGame.TileSize), (float) this.abigailPortraitYposition), new Rectangle?(new Rectangle(64 /*0x40*/ * (this.abigailPortraitExpression % 2), 64 /*0x40*/ * (this.abigailPortraitExpression / 2), 64 /*0x40*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
      if (this.abigailPortraitTimer < 5500 && this.abigailPortraitTimer > 500)
      {
        ...
        int x = LocalizedContentManager.CurrentLanguageCode == LocalizedContentManager.LanguageCode.zh || LocalizedContentManager.CurrentLanguageCode == LocalizedContentManager.LanguageCode.ru ? (int) ((double) AbigailGame.topLeftScreenCoordinate.X + (double) (16 /*0x10*/ * AbigailGame.TileSize)) + widthOfString / 4 : (int) ((double) AbigailGame.topLeftScreenCoordinate.X + (double) (16 /*0x10*/ * AbigailGame.TileSize));
        SpriteText.drawString(b, this.AbigailDialogue, x, (int) ((double) this.abigailPortraitYposition - 80.0), width: widthOfString, color: new Color?(SpriteText.color_Purple));
      }
    }
    b.End();
  ...
  public class CowboyPowerup
  {
    ...
    public void draw(SpriteBatch b)
    {
      if (this.duration <= 2000 && this.duration / 200 % 2 != 0)
        return;
      b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y + this.yOffset), new Rectangle?(new Rectangle(272 + this.which * 16 /*0x10*/, 1808, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
    }
  }
  ...
  public class JOTPKProgress : INetObject<NetFields>
  {
    ...
    public NetFields NetFields { get; } = new NetFields(nameof (JOTPKProgress));

    public JOTPKProgress()
    {
      this.NetFields.SetOwner((INetObject<NetFields>) this).AddField((INetSerializable) this.bulletDamage, nameof (bulletDamage)).AddField((INetSerializable) this.runSpeedLevel, nameof (runSpeedLevel)).AddField((INetSerializable) this.fireSpeedLevel, nameof (fireSpeedLevel)).AddField((INetSerializable) this.ammoLevel, nameof (ammoLevel)).AddField((INetSerializable) this.lives, nameof (lives)).AddField((INetSerializable) this.coins, nameof (coins)).AddField((INetSerializable) this.score, nameof (score)).AddField((INetSerializable) this.died, nameof (died)).AddField((INetSerializable) this.spreadPistol, nameof (spreadPistol)).AddField((INetSerializable) this.whichRound, nameof (whichRound)).AddField((INetSerializable) this.whichWave, nameof (whichWave)).AddField((INetSerializable) this.heldItem, nameof (heldItem)).AddField((INetSerializable) this.world, nameof (world)).AddField((INetSerializable) this.waveTimer, nameof (waveTimer)).AddField((INetSerializable) this.monsterChances, nameof (monsterChances));
    }
  }
    ...
    public virtual void draw(SpriteBatch b)
    {
      if (this.type == 6 && this.special)
      {
        if ((double) this.flashColorTimer > 0.0)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(480, 1696, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
        else
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(576, 1712, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
      }
      else
      {
        if (this.invisible)
          return;
        if ((double) this.flashColorTimer > 0.0)
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(352 + this.type * 16 /*0x10*/, 1696, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
        else
          b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(352 + (this.type * 2 + ((double) this.movementAnimationTimer < 250.0 ? 1 : 0)) * 16 /*0x10*/, 1712, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
            ...
            if (this.position.Contains((int) vector2_1.X + AbigailGame.TileSize / 2, (int) vector2_1.Y + AbigailGame.TileSize / 2))
            {
              ...
              switch (this.type)
              {
                ...
                case 6:
                  if (!this.invisible)
                  {
                    AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(352, 1728, 16 /*0x10*/, 16 /*0x10*/), 60f, 3, 0, new Vector2((float) this.position.X, (float) this.position.Y) + AbigailGame.topLeftScreenCoordinate, false, false, (float) this.position.Y / 10000f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
                    {
  ...
  public class Dracula : AbigailGame.CowboyMonster
  {
    ...
    {
      if (this.phase != -1)
        b.Draw(Game1.staminaRect, new Rectangle((int) AbigailGame.topLeftScreenCoordinate.X, (int) AbigailGame.topLeftScreenCoordinate.Y + 16 /*0x10*/ * AbigailGame.TileSize + 3, (int) ((double) (16 /*0x10*/ * AbigailGame.TileSize) * ((double) this.health / (double) this.fullHealth)), AbigailGame.TileSize / 3), new Color(188, 51, 74));
      if ((double) this.flashColorTimer > 0.0)
      {
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(464, 1696, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) this.position.Y / 10000f);
      }
      else
      {
        switch (this.phase)
        {
          ...
          case 2:
          case 3:
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(592 + this.phaseInternalTimer / 100 % 3 * 16 /*0x10*/, 1760, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) this.position.Y / 10000f);
            if (this.phase != -1)
              break;
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) (this.position.Y + AbigailGame.TileSize) + (float) Math.Sin((double) this.phaseInternalTimer / 1000.0) * 3f), new Rectangle?(new Rectangle(528, 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) this.position.Y / 10000f);
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (this.position.X - AbigailGame.TileSize / 2), (float) (this.position.Y - AbigailGame.TileSize * 2)), new Rectangle?(new Rectangle(608, 1728, 32 /*0x20*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) this.position.Y / 10000f);
            break;
          default:
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(592 + this.phaseInternalTimer / 100 % 2 * 16 /*0x10*/, 1712, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) this.position.Y / 10000f);
            break;
        }
      }
    }
    ...
    public override bool move(Vector2 playerPosition, GameTime time)
    {
      ...
      switch (this.phase)
      {
        ...
        case 1:
          ...
          {
            case 0:
              Point location1 = this.position.Location;
              ...
              if (this.position.Y > this.homePosition.Y + 6)
                ...
                this.position.Y += 6;
              if (this.position.Location.Equals(location1))
              {
                ++this.phaseInternalCounter;
            ...
            case 4:
              ...
              this.shootTimer = shootTimer2 - milliseconds4;
              if (this.shootTimer < 0)
              {
                Vector2 velocityTowardPoint = Utility.getVelocityTowardPoint(new Point(this.position.X + AbigailGame.TileSize / 2, this.position.Y), playerPosition + new Vector2((float) (AbigailGame.TileSize / 2), (float) (AbigailGame.TileSize / 2)), 8f);
    ...
    public void summonEnemies(Point origin, int which)
    {
      ...
      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (origin.X - AbigailGame.TileSize - AbigailGame.TileSize / 2), (float) origin.Y), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
      {
        delayBeforeAnimationStart = Game1.random.Next(800)
      });
      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (origin.X + AbigailGame.TileSize + AbigailGame.TileSize / 2), (float) origin.Y), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
      ...
      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) origin.X, (float) (origin.Y - AbigailGame.TileSize - AbigailGame.TileSize * 3 / 4)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
      {
        delayBeforeAnimationStart = Game1.random.Next(800)
      });
      AbigailGame.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792 /*0x0700*/, 16 /*0x10*/, 16 /*0x10*/), 80f, 5, 0, AbigailGame.topLeftScreenCoordinate + new Vector2((float) origin.X, (float) (origin.Y + AbigailGame.TileSize + AbigailGame.TileSize / 2)), false, false, 1f, 0.0f, Color.White, 3f, 0.0f, 0.0f, 0.0f, true)
      {
        delayBeforeAnimationStart = Game1.random.Next(800)
      });
      Game1.playSound("Cowboy_monsterDie");
  ...
  public class Outlaw : AbigailGame.CowboyMonster
  {
    ...
    public override void draw(SpriteBatch b)
    {
      ...
      if ((double) this.flashColorTimer > 0.0)
      {
        b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(496, 1696, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
      }
      else
      {
        switch (this.phase)
        {
          case -1:
          case 0:
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(560 + (this.phaseCountdown / 250 % 2 == 0 ? 16 /*0x10*/ : 0), 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
            if (this.phase != -1 || this.phaseCountdown <= 1000)
              break;
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) (this.position.X - AbigailGame.TileSize / 2), (float) (this.position.Y - AbigailGame.TileSize * 2)), new Rectangle?(new Rectangle(576 + (AbigailGame.whichWave > 5 ? 32 /*0x20*/ : 0), 1792 /*0x0700*/, 32 /*0x20*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
            break;
          default:
            ...
            b.Draw(Game1.mouseCursors, AbigailGame.topLeftScreenCoordinate + new Vector2((float) this.position.X, (float) this.position.Y), new Rectangle?(new Rectangle(592 + (this.phaseCountdown / 80 /*0x50*/ % 2 == 0 ? 16 /*0x10*/ : 0), 1776, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 3f, SpriteEffects.None, (float) ((double) this.position.Y / 10000.0 + 1.0 / 1000.0));
            break;
        }
      }
    }
    ...
    public override bool move(Vector2 playerPosition, GameTime time)
    {
      ...
      if (this.position.X > 17 * AbigailGame.TileSize || this.position.X < -AbigailGame.TileSize)
        this.position.X = 16 /*0x10*/ * AbigailGame.TileSize / 2;
      switch (this.phase)
      {
        case -1:
        case 0:
      ...
      if (this.position.X <= 16 /*0x10*/ * AbigailGame.TileSize)
      {
