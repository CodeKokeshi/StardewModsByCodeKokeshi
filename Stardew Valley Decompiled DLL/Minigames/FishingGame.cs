...
public class FishingGame : IMinigame
{
  ...
  {
    Game1.viewport.X = this.location.Map.Layers[0].LayerWidth * 64 /*0x40*/ / 2 - (int) ((double) (Game1.game1.localMultiplayerWindow.Width / 2) / (double) Game1.options.zoomLevel);
    Game1.viewport.Y = this.location.Map.Layers[0].LayerHeight * 64 /*0x40*/ / 2 - (int) ((double) (Game1.game1.localMultiplayerWindow.Height / 2) / (double) Game1.options.zoomLevel);
  }
