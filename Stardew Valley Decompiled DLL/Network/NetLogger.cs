...
public class NetLogger
{
  ...
  public double LogDuration
  {
    get
    {
      return this.isLogging ? this.priorMillis + (DateTime.UtcNow - this.timeLastStarted).TotalMilliseconds : this.priorMillis;
    }
  }
  ...
  public string Dump()
  {
    string path = Path.Combine(Program.GetLocalAppDataFolder("Profiling"), DateTime.UtcNow.Ticks.ToString() + ".csv");
