...
// Type: StardewValley.ItemStockInformation
...
public class ItemStockInformation
{
  ...
  public StardewValley.StackDrawType? StackDrawType;
  ...
  public ItemStockInformation(
    int price,
    int stock,
    string tradeItem = null,
    int? tradeItemCount = null,
    LimitedStockMode stockMode = LimitedStockMode.Global,
    string syncedKey = null,
    ISalable itemToSyncStack = null,
    StardewValley.StackDrawType? stackDrawType = null,
    List<string> actionsOnPurchase = null)
  {
    this.Price = price;
    this.Stock = stock;
