...
public class LZ4
{
  ...
  [DllImport("liblwjgl_lz4", EntryPoint = "Java_org_lwjgl_util_lz4_LZ4_LZ4_1compressBound", CallingConvention = (CallingConvention) 2)]
  ...
  [DllImport("liblwjgl_lz4", EntryPoint = "Java_org_lwjgl_util_lz4_LZ4_nLZ4_1compress_1default", CallingConvention = (CallingConvention) 2)]
  private static extern int lwjgl_compress_default(
    IntPtr env,
    IntPtr clazz,
    byte[] src,
    IntPtr dest,
  ...
  [DllImport("liblwjgl_lz4", EntryPoint = "Java_org_lwjgl_util_lz4_LZ4_nLZ4_1decompress_1safe", CallingConvention = (CallingConvention) 2)]
  private static extern int lwjgl_decompress_safe(
    IntPtr env,
    IntPtr clazz,
    IntPtr src,
    byte[] dest,
