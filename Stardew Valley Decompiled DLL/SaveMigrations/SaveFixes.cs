...
// Type: StardewValley.SaveMigrations.SaveFixes
...
public enum SaveFixes
{
  ...
  MigrateHoneyItems = 47, // 0x0000002F
  ...
  MapAdjustments_1_6 = 67, // 0x00000043
  ...
  MigrateWalletItems = 68, // 0x00000044
  ...
  MigrateResourceClumps = 69, // 0x00000045
  ...
  MigrateFishingRodAttachmentSlots = 70, // 0x00000046
  ...
  MarkStarterGiftBoxes = 75, // 0x0000004B
  ...
  MigrateMailEventsToTriggerActions = 76, // 0x0000004C
  ...
  ShiftFarmHouseFurnitureForExpansion = 77, // 0x0000004D
  ...
  PopulateConstructedBuildings = 88, // 0x00000058
  ...
  MigrateStatFields = 92, // 0x0000005C
  ...
  ConvertBuildingQuests = 95, // 0x0000005F
  ...
  FixDuplicateMissedMail = 98, // 0x00000062
  MAX = 99, // 0x00000063
}
