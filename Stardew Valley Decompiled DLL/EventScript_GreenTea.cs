...
internal class EventScript_GreenTea : ICustomEventScript
{
  ...
  public EventScript_GreenTea(Vector2 onScreenCenterPosition, Event e)
  {
    ...
    this.addStar(new Vector2((float) (this.topLeftX + 876), (float) (this.topLeftY + 256 /*0x0100*/)), e);
    ...
    this.addStar(new Vector2((float) (this.topLeftX + 1120), (float) (this.topLeftY + 256 /*0x0100*/)), e);
    this.currentPhase = 0;
  ...
  {
    b.Draw(Game1.staminaRect, new Rectangle(this.topLeftX + 208 /*0xD0*/, this.topLeftY + 8, this.width - 416, this.height - 16 /*0x10*/), new Rectangle?(Game1.staminaRect.Bounds), this.bgColor, 0.0f, Vector2.Zero, SpriteEffects.None, 0.05f);
    for (int index = 0; index < 5; ++index)
      b.Draw(this.tempText, new Vector2((float) (this.topLeftX + 208 /*0xD0*/ + index * 71 * 4), (float) (this.topLeftY + this.height / 2)), new Rectangle?(new Rectangle(386, 472, 71, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.1f);
    b.Draw(Game1.staminaRect, new Rectangle(this.topLeftX + 208 /*0xD0*/, this.topLeftY + this.height / 2 + 60, this.width - 416, this.height / 2 - 76), new Rectangle?(Game1.staminaRect.Bounds), this.hillColor, 0.0f, Vector2.Zero, SpriteEffects.None, 0.15f);
    ...
    this.buddy?.draw(b);
    b.Draw(Game1.staminaRect, new Rectangle(this.topLeftX + 208 /*0xD0*/, this.topLeftY + 8, 296, 1064), new Rectangle?(Game1.staminaRect.Bounds), this.lightLeafColor, 0.0f, Vector2.Zero, SpriteEffects.None, 0.16f);
    ...
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(148f, 27f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(142f, 40f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(148f, 70f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(138f, 102f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(148f, 150f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(135f, 186f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    ...
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(164f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(214f, 55f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(240f, 59f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(274f, 55f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(320f, 57f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(365f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.lightLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.2f);
    b.Draw(Game1.staminaRect, new Rectangle(this.topLeftX + 208 /*0xD0*/, this.topLeftY + 8, 140, 1064), new Rectangle?(Game1.staminaRect.Bounds), this.darkLeafColor, 0.0f, Vector2.Zero, SpriteEffects.None, 0.17f);
    ...
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(94f, 213f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(124f, 213f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(153f, 207f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(200f, 214f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(244f, 209f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(290f, 205f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(325f, 213f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY + 112 /*0x70*/)) + new Vector2(350f, 213f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(148f, 0.0f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(148f, 27f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(142f, 40f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(148f, 70f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(138f, 102f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(148f, 150f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(135f, 186f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) (this.topLeftX - 160 /*0xA0*/), (float) this.topLeftY) + new Vector2(148f, 220f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    ...
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(124f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(164f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(214f, 55f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(240f, 59f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(274f, 54f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(320f, 58f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(365f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) (this.topLeftY - 112 /*0x70*/)) + new Vector2(394f, 62f) * 4f, new Rectangle?(new Rectangle(462, 470, 50, 22)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    ...
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(128f, 156f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(108f, 200f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(130f, 78f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(117f, 33f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 1.57079637f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(184f, 44f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(228f, 42f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(311f, 38f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
    b.Draw(this.tempText, new Vector2((float) this.topLeftX, (float) this.topLeftY) + new Vector2(123f, 39f) * 4f, new Rectangle?(new Rectangle(79, 354, 41, 27)), this.darkLeafColor, 3.14159274f, Vector2.Zero, 4f, SpriteEffects.None, 0.21f);
  ...
  public bool update(GameTime time, Event e)
  {
    ...
    if (this.steamTimer <= 0)
    {
      if (e.aboveMapSprites == null)
        e.aboveMapSprites = new TemporaryAnimatedSpriteList();
      int num = Game1.random.Next(-48, 64 /*0x40*/);
      e.aboveMapSprites.Add(new TemporaryAnimatedSprite()
      {
        texture = this.tempText,
        local = true,
        position = new Vector2((float) (this.topLeftX + this.width / 2), (float) (this.topLeftY + this.height / 2)) + new Vector2((float) (num - 64 /*0x40*/), 64f),
        initialPosition = new Vector2((float) (this.topLeftX + this.width / 2), (float) (this.topLeftY + this.height / 2)) + new Vector2((float) (num - 64 /*0x40*/), 64f),
        motion = new Vector2(-0.1f, -1f),
        alphaFade = -0.01f,
        alphaFadeFade = -0.0001f,
        alpha = 0.1f,
        rotationChange = Utility.Lerp(-0.01f, 0.01f, (float) Game1.random.NextDouble()),
        sourceRect = new Rectangle(472, 450, 16 /*0x10*/, 14),
        scale = 4f,
      ...
      switch (this.currentPhase)
      {
        ...
        case 4:
          this.buddy = new TemporaryAnimatedSprite()
          {
            ...
            sourceRect = new Rectangle(0, 242, 27, 32 /*0x20*/),
            scale = 4f,
      ...
      switch (this.buddyPhase)
      {
        case 1:
          ...
          if (this.buddyTimer <= 0)
          {
            ...
            e.aboveMapSprites.Add(new TemporaryAnimatedSprite()
            {
              ...
              sourceRect = new Rectangle(0, 384, 16 /*0x10*/, 16 /*0x10*/),
              scale = 4f,
        ...
        case 2:
          if (this.buddyTimer <= 0)
          {
            ...
            e.aboveMapSprites.RemoveWhere<TemporaryAnimatedSprite>((Predicate<TemporaryAnimatedSprite>) (sprite => sprite.id == 777));
            break;
          }
          break;
        case 3:
        ...
        case 5:
          ...
          if (this.buddyTimer <= 0)
          {
            ...
            {
              Vector2 vector2 = Utility.getRandomPositionInThisRectangle(new Rectangle(-8, -8, 27, 32 /*0x20*/), Game1.random) * 4f;
  ...
  private void setBuddyFrame(int frame)
  {
    ...
    this.buddy.sourceRect.Y = 242 + frame / 5 * 32 /*0x20*/;
