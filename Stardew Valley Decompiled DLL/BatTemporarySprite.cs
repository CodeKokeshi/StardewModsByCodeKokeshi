...
public class BatTemporarySprite : TemporaryAnimatedSprite
{
  ...
  public override void draw(
    ...
    float extraAlpha = 1f)
  {
    spriteBatch.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, this.Position), new Rectangle?(new Rectangle(this.currentParentTileIndex * 64 /*0x40*/, 0, 64 /*0x40*/, 64 /*0x40*/)), Color.White, 0.0f, Vector2.Zero, 1f, SpriteEffects.None, (float) (((double) this.Position.Y + 32.0) / 10000.0));
  }
