...
public class DebugMetricsComponent : DrawableGameComponent
{
  ...
  private StringBuilder _stringBuilder = new StringBuilder(512 /*0x0200*/);
  ...
  protected override void LoadContent()
  {
    ...
    int width = 2;
    int height = 2;
    Texture2D texture2D = new Texture2D(this.GraphicsDevice, width, height, false, SurfaceFormat.Color);
    texture2D.Name = "@DebugMetricsComponent._opaqueWhite";
    this._opaqueWhite = texture2D;
