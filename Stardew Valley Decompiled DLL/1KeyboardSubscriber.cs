...
public class KeyboardDispatcher
{
  ...
  public void Poll()
  {
    ...
    bool flag = SdlClipboard.Platform == ClipboardPlatformType.OSX ? keyboardState.IsKeyDown(Keys.LeftWindows) || keyboardState.IsKeyDown(Keys.RightWindows) : keyboardState.IsKeyDown(Keys.LeftControl) || keyboardState.IsKeyDown(Keys.RightControl);
