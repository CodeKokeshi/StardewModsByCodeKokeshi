...
// Type: StardewValley.Objects.Trinkets.TrinketEffect
...
public class TrinketEffect
{
  ...
  public TrinketEffect(Trinket trinket) => this.Trinket = trinket;
  ...
  public virtual void Apply(Farmer farmer)
  {
    if (!(this.Trinket.ItemId == "ParrotEgg"))
      return;
    this.Companion = (Companion) new FlyingCompanion(1);
  ...
  public virtual void Unapply(Farmer farmer) => farmer.RemoveCompanion(this.Companion);
    ...
    bool isCriticalHit)
  {
    if (!(this.Trinket.ItemId == "ParrotEgg") || monster == null || monster.Health > 0)
      return;
    double num = (double) (this.GeneralStat + 1) * 0.1;
  ...
  public virtual bool GenerateRandomStats(Trinket trinket)
  {
    ...
    {
      case "IridiumSpur":
        this.GeneralStat = random.Next(5, 11);
        trinket.descriptionSubstitutionTemplates.Clear();
        trinket.descriptionSubstitutionTemplates.Add(this.GeneralStat.ToString());
        return true;
      case "ParrotEgg":
        int maxValue = Math.Min(4, 1 + (int) (Game1.player.totalMoneyEarned / 750000U));
        int generalStat = this.GeneralStat;
        this.GeneralStat = random.Next(0, maxValue);
        trinket.descriptionSubstitutionTemplates.Clear();
        ...
        return maxValue > 1 || this.GeneralStat != generalStat;
      default:
        return false;
    }
  }
