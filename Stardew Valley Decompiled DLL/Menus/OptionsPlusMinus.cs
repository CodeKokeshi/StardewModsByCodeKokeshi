...
public class OptionsPlusMinus : OptionsElement
{
    ...
    : base(label, x, y, 28, 28, whichOption)
  {
    ...
    this.bounds = new Rectangle(x, y, 56 + val2, 32 /*0x20*/);
    this.label = label;
    this.whichOption = whichOption;
    this.minusButton = new Rectangle(x, 16 /*0x10*/, 28, 32 /*0x20*/);
    this.plusButton = new Rectangle(this.bounds.Right - 32 /*0x20*/, 16 /*0x10*/, 28, 32 /*0x20*/);
  }
