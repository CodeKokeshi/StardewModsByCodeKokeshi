...
public class OptionsDropDown : OptionsElement
{
  ...
  public virtual void RecalculateBounds()
  {
    foreach (string downDisplayOption in this.dropDownDisplayOptions)
    {
      ...
      if ((double) x >= (double) (this.bounds.Width - 48 /*0x30*/))
        this.bounds.Width = (int) ((double) x + 64.0);
    }
    this.dropDownBounds = new Rectangle(this.bounds.X, this.bounds.Y, this.bounds.Width - 48 /*0x30*/, this.bounds.Height * this.dropDownOptions.Count);
  }
  ...
  public override void draw(SpriteBatch b, int slotX, int slotY, IClickableMenu context = null)
  {
    ...
    if (this.clicked)
    {
      ...
      b.Draw(Game1.mouseCursors, new Vector2((float) (slotX + this.bounds.X + this.bounds.Width - 48 /*0x30*/), (float) (slotY + this.bounds.Y)), new Rectangle?(OptionsDropDown.dropDownButtonSource), Color.Wheat * num, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.981f);
    }
    else
    {
      IClickableMenu.drawTextureBox(b, Game1.mouseCursors, OptionsDropDown.dropDownBGSource, slotX + this.bounds.X, slotY + this.bounds.Y, this.bounds.Width - 48 /*0x30*/, this.bounds.Height, Color.White * num, 4f, false);
      ...
      b.Draw(Game1.mouseCursors, new Vector2((float) (slotX + this.bounds.X + this.bounds.Width - 48 /*0x30*/), (float) (slotY + this.bounds.Y)), new Rectangle?(OptionsDropDown.dropDownButtonSource), Color.White * num, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.88f);
    }
  }
}
