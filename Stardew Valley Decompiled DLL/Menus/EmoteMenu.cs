...
public class EmoteMenu : IClickableMenu
{
  ...
  public EmoteMenu()
  {
    ...
    this.width = 256 /*0x0100*/;
    this.height = 256 /*0x0100*/;
  ...
  protected void _CreateEmoteButtons()
  {
    ...
    {
      int emote_index = -1;
      for (int index2 = 0; index2 < Farmer.EMOTES.Length; ++index2)
      {
      ...
      this._emoteButtons.Add(new ClickableTextureComponent(new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), this.menuBackgroundTexture, EmoteMenu.GetEmoteNonBubbleSpriteRect(emote_index), 4f));
    }
  ...
  {
    return emote_index <= 0 ? new Rectangle(48 /*0x30*/, 0, 16 /*0x10*/, 16 /*0x10*/) : new Rectangle(emote_index % 4 * 16 /*0x10*/ + 48 /*0x30*/, emote_index / 4 * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/);
  }

  public static Rectangle GetEmoteNonBubbleSpriteRect(int emote_index)
  {
    return new Rectangle(emote_index % 4 * 16 /*0x10*/, emote_index / 4 * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/);
  }
  ...
  protected void _RepositionButtons()
  {
    for (int index = 0; index < this._emoteButtons.Count; ++index)
    {
      ...
      float num = Utility.Lerp(0.0f, 6.28318548f, (float) index / (float) this._emoteButtons.Count);
  ...
  protected void _SnapToPlayerPosition()
  {
    ...
    this.xPositionOnScreen = (int) vector2.X + 32 /*0x20*/;
    this.yPositionOnScreen = (int) vector2.Y - 64 /*0x40*/;
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    if (this._selectedIndex >= 0 && this._selectedTime >= 250)
    {
      ...
      if (!this.gamepadMode)
      {
        ...
        b.Draw(this.menuBackgroundTexture, position, new Rectangle?(new Rectangle(64 /*0x40*/, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 2f, SpriteEffects.None, 0.99f);
      }
      else
      ...
      position.X += 32f;
      b.Draw(this.menuBackgroundTexture, position, new Rectangle?(new Rectangle(64 /*0x40*/, 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 2f, SpriteEffects.None, 0.99f);
    }
