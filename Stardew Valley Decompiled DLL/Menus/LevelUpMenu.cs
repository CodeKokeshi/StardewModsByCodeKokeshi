...
public class LevelUpMenu : IClickableMenu
{
  ...
  public const int basewidth = 768 /*0x0300*/;
  public const int baseheight = 512 /*0x0200*/;
  ...
  public LevelUpMenu()
    : base(Game1.uiViewport.Width / 2 - 384, Game1.uiViewport.Height / 2 - 256 /*0x0100*/, 768 /*0x0300*/, 512 /*0x0200*/)
  {
    Game1.player.team.endOfNightStatus.UpdateState("level");
    this.width = 768 /*0x0300*/;
    this.height = 512 /*0x0200*/;
    ClickableTextureComponent textureComponent = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + this.width + 4, this.yPositionOnScreen + this.height - 64 /*0x40*/ - IClickableMenu.borderWidth, 64 /*0x40*/, 64 /*0x40*/), Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 46), 1f);
    ...
    : base(Game1.uiViewport.Width / 2 - 384, Game1.uiViewport.Height / 2 - 256 /*0x0100*/, 768 /*0x0300*/, 512 /*0x0200*/)
  {
    ...
    this.title = Game1.content.LoadString("Strings\\UI:LevelUp_Title", (object) level, (object) Farmer.getSkillDisplayNameFromIndex(skill));
    ...
    {
      case 0:
        this.sourceRectForLevelIcon = new Rectangle(0, 0, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 1:
        this.sourceRectForLevelIcon = new Rectangle(16 /*0x10*/, 0, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 2:
        this.sourceRectForLevelIcon = new Rectangle(80 /*0x50*/, 0, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 3:
        this.sourceRectForLevelIcon = new Rectangle(32 /*0x20*/, 0, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 4:
        this.sourceRectForLevelIcon = new Rectangle(128 /*0x80*/, 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 5:
        this.sourceRectForLevelIcon = new Rectangle(64 /*0x40*/, 0, 16 /*0x10*/, 16 /*0x10*/);
        break;
    }
    int num = 0;
    foreach (KeyValuePair<string, string> craftingRecipe1 in CraftingRecipe.craftingRecipes)
    {
      int skillNumber;
      int minLevel;
      if (CraftingRecipe.TryParseLevelRequirement(craftingRecipe1.Key, craftingRecipe1.Value, false, out skillNumber, out minLevel) && skillNumber == skill && minLevel == level)
      {
        CraftingRecipe craftingRecipe2 = new CraftingRecipe(craftingRecipe1.Key, false);
        this.newCraftingRecipes.Add(craftingRecipe2);
        num += craftingRecipe2.bigCraftable ? 128 /*0x80*/ : 64 /*0x40*/;
      }
    }
    foreach (KeyValuePair<string, string> cookingRecipe in CraftingRecipe.cookingRecipes)
    {
      int skillNumber;
      int minLevel;
      if (CraftingRecipe.TryParseLevelRequirement(cookingRecipe.Key, cookingRecipe.Value, true, out skillNumber, out minLevel) && skillNumber == skill && minLevel == level)
      {
        CraftingRecipe craftingRecipe = new CraftingRecipe(cookingRecipe.Key, true);
        this.newCraftingRecipes.Add(craftingRecipe);
        num += craftingRecipe.bigCraftable ? 128 /*0x80*/ : 64 /*0x40*/;
      }
    }
    this.height = num + 256 /*0x0100*/ + this.extraInfoForLevel.Count * 64 /*0x40*/ * 3 / 4;
    Game1.player.freezePause = 100;
    this.gameWindowSizeChanged(Rectangle.Empty, Rectangle.Empty);
    if (this.isProfessionChooser)
    {
      this.leftProfession = new ClickableComponent(new Rectangle(this.xPositionOnScreen, this.yPositionOnScreen + 128 /*0x80*/, this.width / 2, this.height), "")
      {
        myID = 102,
        rightNeighborID = 103
      };
      this.rightProfession = new ClickableComponent(new Rectangle(this.width / 2 + this.xPositionOnScreen, this.yPositionOnScreen + 128 /*0x80*/, this.width / 2, this.height), "")
      {
        myID = 103,
        leftNeighborID = 102
      };
  ...
  public override void snapToDefaultClickableComponent()
  {
    if (this.isProfessionChooser)
    {
      ...
      Game1.setMousePosition(this.xPositionOnScreen + this.width + 64 /*0x40*/, this.yPositionOnScreen + this.height + 64 /*0x40*/);
    }
    else
    {
  ...
  {
    this.okButton.bounds = new Rectangle(this.xPositionOnScreen + this.width + 4, this.yPositionOnScreen + this.height - 64 /*0x40*/ - IClickableMenu.borderWidth, 64 /*0x40*/, 64 /*0x40*/);
    if (this.okButton.bounds.Right > Game1.uiViewport.Width)
      this.okButton.bounds.X = Game1.uiViewport.Width - 64 /*0x40*/;
    if (this.okButton.bounds.Bottom <= Game1.uiViewport.Height)
      return;
    this.okButton.bounds.Y = Game1.uiViewport.Height - 64 /*0x40*/;
  }
  ...
  public static void RevalidateHealth(Farmer farmer)
  {
    ...
    if (farmer.maxHealth >= num1)
      return;
    Game1.log.Verbose($"Fixing max health of: {farmer.Name} was {farmer.maxHealth.ToString()} (expected: {num1.ToString()})");
  ...
  public override void update(GameTime time)
  {
    ...
    else
    {
      ...
      this.littleStars.RemoveWhere<TemporaryAnimatedSprite>((Predicate<TemporaryAnimatedSprite>) (star => star.update(time)));
      if (Game1.random.NextDouble() < 0.03)
      {
        Vector2 position = new Vector2(0.0f, (float) (Game1.random.Next(this.yPositionOnScreen - 128 /*0x80*/, this.yPositionOnScreen - 4) / 20 * 4 * 5 + 32 /*0x20*/));
        position.X = !Game1.random.NextBool() ? (float) Game1.random.Next(this.xPositionOnScreen + this.width / 2 + 116, this.xPositionOnScreen + this.width - 160 /*0xA0*/) : (float) Game1.random.Next(this.xPositionOnScreen + this.width / 2 - 228, this.xPositionOnScreen + this.width / 2 - 132);
        if ((double) position.Y < (double) (this.yPositionOnScreen - 64 /*0x40*/ - 8))
      ...
      else
      {
        if (this.isActive && this.isProfessionChooser)
        {
          ...
          Game1.player.completelyStopAnimatingOrDoingAction();
          Game1.player.freezePause = 100;
          if (Game1.getMouseY() > this.yPositionOnScreen + 192 /*0xC0*/ && Game1.getMouseY() < this.yPositionOnScreen + this.height)
          {
        ...
        if (this.isActive && this.starIcon != null && !this.informationUp && (this.oldMouseState.LeftButton == ButtonState.Pressed || Game1.options.gamepadControls && Game1.oldPadState.IsButtonDown(Buttons.A)) && this.starIcon.containsPoint(this.oldMouseState.X, this.oldMouseState.Y))
        {
          ...
          foreach (KeyValuePair<string, string> craftingRecipe1 in CraftingRecipe.craftingRecipes)
          {
            string str = ArgUtility.Get(craftingRecipe1.Value.Split('/'), 4, "");
            if (str.Contains(Farmer.getSkillNameFromIndex(this.currentSkill)) && str.Contains(this.currentLevel.ToString() ?? ""))
            {
              CraftingRecipe craftingRecipe2 = new CraftingRecipe(craftingRecipe1.Key, false);
              this.newCraftingRecipes.Add(craftingRecipe2);
              Game1.player.craftingRecipes.TryAdd(craftingRecipe1.Key, 0);
              num += craftingRecipe2.bigCraftable ? 128 /*0x80*/ : 64 /*0x40*/;
            }
          }
          foreach (KeyValuePair<string, string> cookingRecipe in CraftingRecipe.cookingRecipes)
          {
            string str = ArgUtility.Get(cookingRecipe.Value.Split('/'), 3, "");
            if (str.Contains(Farmer.getSkillNameFromIndex(this.currentSkill)) && str.Contains(this.currentLevel.ToString() ?? ""))
            {
              CraftingRecipe craftingRecipe = new CraftingRecipe(cookingRecipe.Key, true);
              this.newCraftingRecipes.Add(craftingRecipe);
  ...
  {
    Game1.player.newLevels.RemoveWhere((Func<Point, bool>) (level => level.X == this.currentSkill && level.Y == this.currentLevel));
  }
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    foreach (TemporaryAnimatedSprite littleStar in this.littleStars)
      littleStar.draw(b);
    b.Draw(Game1.mouseCursors, new Vector2((float) (this.xPositionOnScreen + this.width / 2 - 116), (float) (this.yPositionOnScreen - 32 /*0x20*/ + 12)), new Rectangle?(new Rectangle(363, 87, 58, 22)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
    ...
    else
    {
      ...
      if (this.isProfessionChooser)
      {
        ...
        this.drawHorizontalPartition(b, this.yPositionOnScreen + 192 /*0xC0*/);
        this.drawVerticalIntersectingPartition(b, this.xPositionOnScreen + this.width / 2 - 32 /*0x20*/, this.yPositionOnScreen + 192 /*0xC0*/);
        Utility.drawWithShadow(b, Game1.buffsIcons, new Vector2((float) (this.xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + IClickableMenu.borderWidth), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 /*0x10*/)), this.sourceRectForLevelIcon, Color.White, 0.0f, Vector2.Zero, 4f, layerDepth: 0.88f);
        b.DrawString(Game1.dialogueFont, this.title, new Vector2((float) (this.xPositionOnScreen + this.width / 2) - Game1.dialogueFont.MeasureString(this.title).X / 2f, (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 /*0x10*/)), Game1.textColor);
        Utility.drawWithShadow(b, Game1.buffsIcons, new Vector2((float) (this.xPositionOnScreen + this.width - IClickableMenu.spaceToClearSideBorder - IClickableMenu.borderWidth - 64 /*0x40*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 /*0x10*/)), this.sourceRectForLevelIcon, Color.White, 0.0f, Vector2.Zero, 4f, layerDepth: 0.88f);
        string text = Game1.content.LoadString("Strings\\UI:LevelUp_ChooseProfession");
        b.DrawString(Game1.smallFont, text, new Vector2((float) (this.xPositionOnScreen + this.width / 2) - Game1.smallFont.MeasureString(text).X / 2f, (float) (this.yPositionOnScreen + 64 /*0x40*/ + IClickableMenu.spaceToClearTopBorder)), Game1.textColor);
        b.DrawString(Game1.dialogueFont, this.leftProfessionDescription[0], new Vector2((float) (this.xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + 32 /*0x20*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 160 /*0xA0*/)), this.leftProfessionColor);
        b.Draw(Game1.mouseCursors, new Vector2((float) (this.xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + this.width / 2 - 112 /*0x70*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 160 /*0xA0*/ - 16 /*0x10*/)), new Rectangle?(new Rectangle(this.professionsToChoose[0] % 6 * 16 /*0x10*/, 624 + this.professionsToChoose[0] / 6 * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
        for (int index = 1; index < this.leftProfessionDescription.Count; ++index)
          b.DrawString(Game1.smallFont, Game1.parseText(this.leftProfessionDescription[index], Game1.smallFont, this.width / 2 - 64 /*0x40*/), new Vector2((float) (this.xPositionOnScreen - 4 + IClickableMenu.spaceToClearSideBorder + 32 /*0x20*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 128 /*0x80*/ + 8 + 64 /*0x40*/ * (index + 1))), this.leftProfessionColor);
        b.DrawString(Game1.dialogueFont, this.rightProfessionDescription[0], new Vector2((float) (this.xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + this.width / 2), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 160 /*0xA0*/)), this.rightProfessionColor);
        b.Draw(Game1.mouseCursors, new Vector2((float) (this.xPositionOnScreen + IClickableMenu.spaceToClearSideBorder + this.width - 128 /*0x80*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 160 /*0xA0*/ - 16 /*0x10*/)), new Rectangle?(new Rectangle(this.professionsToChoose[1] % 6 * 16 /*0x10*/, 624 + this.professionsToChoose[1] / 6 * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
        for (int index = 1; index < this.rightProfessionDescription.Count; ++index)
          b.DrawString(Game1.smallFont, Game1.parseText(this.rightProfessionDescription[index], Game1.smallFont, this.width / 2 - 48 /*0x30*/), new Vector2((float) (this.xPositionOnScreen - 4 + IClickableMenu.spaceToClearSideBorder + this.width / 2), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 128 /*0x80*/ + 8 + 64 /*0x40*/ * (index + 1))), this.rightProfessionColor);
      }
      else
      {
        Game1.drawDialogueBox(this.xPositionOnScreen, this.yPositionOnScreen, this.width, this.height, false, true);
        ...
        b.DrawString(Game1.dialogueFont, this.title, new Vector2((float) (this.xPositionOnScreen + this.width / 2) - Game1.dialogueFont.MeasureString(this.title).X / 2f, (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 /*0x10*/)), Game1.textColor);
        Utility.drawWithShadow(b, Game1.buffsIcons, new Vector2((float) (this.xPositionOnScreen + this.width - IClickableMenu.spaceToClearSideBorder - IClickableMenu.borderWidth - 64 /*0x40*/), (float) (this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 16 /*0x10*/)), this.sourceRectForLevelIcon, Color.White, 0.0f, Vector2.Zero, 4f, layerDepth: 0.88f);
        int y = this.yPositionOnScreen + IClickableMenu.spaceToClearTopBorder + 80 /*0x50*/;
        ...
        foreach (CraftingRecipe newCraftingRecipe in this.newCraftingRecipes)
        {
          ...
          newCraftingRecipe.drawMenuView(b, (int) ((double) (this.xPositionOnScreen + this.width / 2) + (double) Game1.smallFont.MeasureString(text).X / 2.0 - 48.0), y - 16 /*0x10*/);
          y += (newCraftingRecipe.bigCraftable ? 128 /*0x80*/ : 64 /*0x40*/) + 8;
        }
