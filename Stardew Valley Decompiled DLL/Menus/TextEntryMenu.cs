...
public class TextEntryMenu : IClickableMenu
{
  ...
  public const int buttonSize = 16 /*0x10*/;
    ...
    : base((int) Utility.getTopLeftPositionForCenteringOnScreen(672, 352).X, (int) Utility.getTopLeftPositionForCenteringOnScreen(672, 352).Y, 672, 352)
  {
    ...
    for (int index1 = 0; index1 < this.letterMaps[0].Length; ++index1)
    {
      ...
      {
        ClickableTextureComponent textureComponent = new ClickableTextureComponent(new Rectangle(0, 0, 1024 /*0x0400*/, 1024 /*0x0400*/), Game1.mouseCursors2, new Rectangle(32 /*0x20*/, 176 /*0xB0*/, 16 /*0x10*/, 16 /*0x10*/), 4f);
    ...
    ClickableTextureComponent textureComponent1 = new ClickableTextureComponent(new Rectangle(0, 0, 128 /*0x80*/, 64 /*0x40*/), Game1.mouseCursors2, new Rectangle(32 /*0x20*/, 144 /*0x90*/, 32 /*0x20*/, 16 /*0x10*/), 4f);
    ...
    ClickableTextureComponent textureComponent2 = new ClickableTextureComponent(new Rectangle(0, 0, 320, 64 /*0x40*/), Game1.mouseCursors2, new Rectangle(0, 160 /*0xA0*/, 80 /*0x50*/, 16 /*0x10*/), 4f);
    ...
    ClickableTextureComponent textureComponent3 = new ClickableTextureComponent(new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), Game1.mouseCursors2, new Rectangle(64 /*0x40*/, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/), 4f);
    ...
    ClickableTextureComponent textureComponent4 = new ClickableTextureComponent(new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), Game1.mouseCursors2, new Rectangle(0, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/), 4f);
    ...
    ClickableTextureComponent textureComponent5 = new ClickableTextureComponent(new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), Game1.mouseCursors2, new Rectangle(16 /*0x10*/, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/), 4f);
  ...
  public void ShowKeyboard(int index, bool play_sound = true)
  {
    ...
    this.upperCaseButton.sourceRect = new Rectangle(0, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/);
    this.symbolsButton.sourceRect = new Rectangle(16 /*0x10*/, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/);
    switch (this._currentKeyboard)
    {
      case 1:
        this.upperCaseButton.sourceRect = new Rectangle(0, 176 /*0xB0*/, 16 /*0x10*/, 16 /*0x10*/);
        break;
      case 2:
        this.symbolsButton.sourceRect = new Rectangle(16 /*0x10*/, 176 /*0xB0*/, 16 /*0x10*/, 16 /*0x10*/);
        break;
    }
    if (!play_sound)
      return;
  ...
  public void RepositionElements()
  {
    ...
    this.yPositionOnScreen = (int) Utility.getTopLeftPositionForCenteringOnScreen(672, 256 /*0x0100*/).Y;
    for (int index1 = 0; index1 < this.keys.Count / this._lettersPerRow; ++index1)
    {
      for (int index2 = 0; index2 < this._lettersPerRow; ++index2)
        this.keys[index2 + index1 * this._lettersPerRow].bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/ + index2 * 16 /*0x10*/ * 4, this.yPositionOnScreen + 16 /*0x10*/ + index1 * 16 /*0x10*/ * 4, 64 /*0x40*/, 64 /*0x40*/);
    }
    this.upperCaseButton.bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/, this.yPositionOnScreen + 16 /*0x10*/ + 256 /*0x0100*/, this.upperCaseButton.bounds.Width, this.upperCaseButton.bounds.Height);
    this.symbolsButton.bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/ + 64 /*0x40*/, this.yPositionOnScreen + 16 /*0x10*/ + 256 /*0x0100*/, this.symbolsButton.bounds.Width, this.symbolsButton.bounds.Height);
    this.backspaceButton.bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/ + 448, this.yPositionOnScreen + 16 /*0x10*/ + 256 /*0x0100*/, this.backspaceButton.bounds.Width, this.backspaceButton.bounds.Height);
    this.spaceButton.bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/ + 128 /*0x80*/, this.yPositionOnScreen + 16 /*0x10*/ + 256 /*0x0100*/, this.spaceButton.bounds.Width, this.spaceButton.bounds.Height);
    this.okButton.bounds = new Rectangle(this.xPositionOnScreen + 16 /*0x10*/ + 576, this.yPositionOnScreen + 16 /*0x10*/ + 256 /*0x0100*/, this.okButton.bounds.Width, this.okButton.bounds.Height);
  }
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    if (this._target != null)
    {
      ...
      this._target.Y = this.yPositionOnScreen - 96 /*0x60*/;
      this._target.Draw(b);
      this._target.X = x;
      this._target.Y = y;
    }
