...
public class QuestContainerMenu : MenuWithInventory
{
    ...
    : base(highlight_method, true)
  {
    ...
    int num = 64 /*0x40*/ * (count / rows);
    this.ItemsToGrabMenu = new InventoryMenu(Game1.uiViewport.Width / 2 - num / 2, this.yPositionOnScreen + 64 /*0x40*/, false, inventory, capacity: count, rows: rows);
