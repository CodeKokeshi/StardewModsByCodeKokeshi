...
public class InventoryPage : IClickableMenu
{
    ...
    : base(x, y, width, height)
  {
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 256 /*0x0100*/ - 12, 64 /*0x40*/, 64 /*0x40*/), "Left Ring")
    {
      myID = 102,
      downNeighborID = 103,
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 320 - 12, 64 /*0x40*/, 64 /*0x40*/), "Right Ring")
    {
      myID = 103,
      upNeighborID = 102,
      downNeighborID = 104,
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 384 - 12, 64 /*0x40*/, 64 /*0x40*/), "Boots")
    {
      myID = 104,
      upNeighborID = 103,
      rightNeighborID = 109,
    ...
    this.portrait = new ClickableComponent(new Rectangle(this.xPositionOnScreen + 192 /*0xC0*/ - 8 - 64 /*0x40*/ + 32 /*0x20*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 256 /*0x0100*/ - 8 + 64 /*0x40*/, 64 /*0x40*/, 96 /*0x60*/), "32");
    ClickableTextureComponent textureComponent1 = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + width / 3 + 576 + 32 /*0x20*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 192 /*0xC0*/ + 64 /*0x40*/, 64 /*0x40*/, 104), Game1.mouseCursors, new Rectangle(564 + Game1.player.trashCanLevel * 18, 102, 18, 26), 4f);
    ...
    ClickableTextureComponent textureComponent2 = new ClickableTextureComponent("", new Rectangle(this.xPositionOnScreen + width, this.yPositionOnScreen + height / 3 - 64 /*0x40*/ + 8, 64 /*0x40*/, 64 /*0x40*/), "", Game1.content.LoadString("Strings\\UI:ItemGrab_Organize"), Game1.mouseCursors, new Rectangle(162, 440, 16 /*0x10*/, 16 /*0x10*/), 4f);
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/ + 208 /*0xD0*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 256 /*0x0100*/ - 12, 64 /*0x40*/, 64 /*0x40*/), "Hat")
    {
      myID = 101,
      leftNeighborID = 102,
      downNeighborID = 108,
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/ + 208 /*0xD0*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 320 - 12, 64 /*0x40*/, 64 /*0x40*/), "Shirt")
    {
      myID = 108,
      upNeighborID = 101,
      downNeighborID = 109,
    ...
    this.equipmentIcons.Add(new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/ + 208 /*0xD0*/, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + 384 - 12, 64 /*0x40*/, 64 /*0x40*/), "Pants")
    {
      myID = 109,
      upNeighborID = 108,
      rightNeighborID = num2,
    ...
    if (num1 != 0)
    {
      ...
      {
        ClickableComponent clickableComponent = new ClickableComponent(new Rectangle(this.xPositionOnScreen + 48 /*0x30*/ + 280, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 4 + (4 + index) * 64 /*0x40*/ - 12, 64 /*0x40*/, 64 /*0x40*/), "Trinket")
        {
          myID = 120 + index,
    ...
    {
      ClickableTextureComponent textureComponent3 = new ClickableTextureComponent("", new Rectangle(this.xPositionOnScreen + width, this.yPositionOnScreen + 96 /*0x60*/, 64 /*0x40*/, 64 /*0x40*/), "", Game1.content.LoadString("Strings\\UI:GameMenu_JunimoNote_Hover"), Game1.mouseCursors, new Rectangle(331, 374, 15, 14), 4f);
  ...
  {
    return f == null ? Game1.player.CursorSlotItem != null : f(Game1.player.CursorSlotItem);
  }
...
label_43:
  ...
  {
    this.drawHorizontalPartition(b, this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 192 /*0xC0*/);
    ...
    b.Draw(Game1.timeOfDay >= 1900 ? Game1.nightbg : Game1.daybg, new Vector2((float) (this.xPositionOnScreen + 192 /*0xC0*/ - 64 /*0x40*/ - 8), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 256 /*0x0100*/ - 8)), Color.White);
    FarmerRenderer.isDrawingForUI = true;
    Game1.player.FarmerRenderer.draw(b, new FarmerSprite.AnimationFrame(0, Game1.player.bathingClothes.Value ? 108 : 0, false, false), Game1.player.bathingClothes.Value ? 108 : 0, new Rectangle(0, Game1.player.bathingClothes.Value ? 576 : 0, 16 /*0x10*/, 32 /*0x20*/), new Vector2((float) (this.xPositionOnScreen + 192 /*0xC0*/ - 8 - 32 /*0x20*/), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 320 - 32 /*0x20*/ - 8)), Vector2.Zero, 0.8f, 2, Color.White, 0.0f, 1f, Game1.player);
    if (Game1.timeOfDay >= 1900)
      Game1.player.FarmerRenderer.draw(b, new FarmerSprite.AnimationFrame(0, Game1.player.bathingClothes.Value ? 108 : 0, false, false), Game1.player.bathingClothes.Value ? 108 : 0, new Rectangle(0, Game1.player.bathingClothes.Value ? 576 : 0, 16 /*0x10*/, 32 /*0x20*/), new Vector2((float) (this.xPositionOnScreen + 192 /*0xC0*/ - 8 - 32 /*0x20*/), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 320 - 32 /*0x20*/ - 8)), Vector2.Zero, 0.8f, 2, Color.DarkBlue * 0.3f, 0.0f, 1f, Game1.player);
    FarmerRenderer.isDrawingForUI = false;
    Utility.drawTextWithShadow(b, Game1.player.Name, Game1.dialogueFont, new Vector2((float) (this.xPositionOnScreen + 192 /*0xC0*/ - 8) - Game1.dialogueFont.MeasureString(Game1.player.Name).X / 2f, (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 448 + 8)), Game1.textColor);
    float num = 32f;
    string text1 = Game1.content.LoadString("Strings\\UI:Inventory_FarmName", (object) Game1.player.farmName);
    Utility.drawTextWithShadow(b, text1, Game1.dialogueFont, new Vector2((float) ((double) this.xPositionOnScreen + (double) num + 512.0 + 32.0 - (double) Game1.dialogueFont.MeasureString(text1).X / 2.0), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + 256 /*0x0100*/ + 4)), Game1.textColor);
    ...
    if (this.checkHeldItem())
      Game1.player.CursorSlotItem.drawInMenu(b, new Vector2((float) (Game1.getOldMouseX() + 16 /*0x10*/), (float) (Game1.getOldMouseY() + 16 /*0x10*/)), 1f);
