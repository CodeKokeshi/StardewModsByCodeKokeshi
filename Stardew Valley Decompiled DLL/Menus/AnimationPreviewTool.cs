...
public class AnimationPreviewTool : IClickableMenu
{
    ...
    : base(Game1.uiViewport.Width / 2 - (632 + IClickableMenu.borderWidth * 2) / 2, Game1.uiViewport.Height / 2 - (600 + IClickableMenu.borderWidth * 2) / 2 - 64 /*0x40*/, 632 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2 + 64 /*0x40*/)
  {
    ...
    {
      ClickableTextureComponent textureComponent = new ClickableTextureComponent(new Rectangle(0, 0, 200, 48 /*0x30*/), (Texture2D) null, new Rectangle(), 1f);
    ...
    {
      new ClickableTextureComponent("Hair Heading", new Rectangle(0, 0, 64 /*0x40*/, 16 /*0x10*/), "Hair", "", (Texture2D) null, new Rectangle(), 1f)
    }));
    this.hairLabel = new ClickableTextureComponent("Hair Label", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), "0", "", (Texture2D) null, new Rectangle(), 1f);
    ...
    ClickableTextureComponent textureComponent2 = new ClickableTextureComponent("Hair Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 44), 1f);
    textureComponent2.myID = -1;
    collection1[0] = textureComponent2;
    collection1[1] = this.hairLabel;
    ClickableTextureComponent textureComponent3 = new ClickableTextureComponent("Hair Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 33), 1f);
    ...
    this.components.Add(new List<ClickableTextureComponent>((IEnumerable<ClickableTextureComponent>) new ClickableTextureComponent[1]
    {
      new ClickableTextureComponent("Shirt Heading", new Rectangle(0, 0, 64 /*0x40*/, 16 /*0x10*/), "Shirt", "", (Texture2D) null, new Rectangle(), 1f)
    }));
    this.shirtLabel = new ClickableTextureComponent("Shirt Label", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), "0", "", (Texture2D) null, new Rectangle(), 1f);
    ...
    ClickableTextureComponent textureComponent4 = new ClickableTextureComponent("Shirt Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 44), 1f);
    textureComponent4.myID = -1;
    collection2[0] = textureComponent4;
    collection2[1] = this.shirtLabel;
    ClickableTextureComponent textureComponent5 = new ClickableTextureComponent("Shirt Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 33), 1f);
    ...
    this.components.Add(new List<ClickableTextureComponent>((IEnumerable<ClickableTextureComponent>) new ClickableTextureComponent[1]
    {
      new ClickableTextureComponent("Pants Heading", new Rectangle(0, 0, 64 /*0x40*/, 16 /*0x10*/), "Pants", "", (Texture2D) null, new Rectangle(), 1f)
    }));
    this.pantsLabel = new ClickableTextureComponent("Pants Label", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), "0", "", (Texture2D) null, new Rectangle(), 1f);
    ...
    ClickableTextureComponent textureComponent6 = new ClickableTextureComponent("Pants Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 44), 1f);
    textureComponent6.myID = -1;
    collection3[0] = textureComponent6;
    collection3[1] = this.pantsLabel;
    ClickableTextureComponent textureComponent7 = new ClickableTextureComponent("Pants Style", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), (string) null, "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 33), 1f);
    ...
    this.components.Add(new List<ClickableTextureComponent>((IEnumerable<ClickableTextureComponent>) new ClickableTextureComponent[1]
    {
      new ClickableTextureComponent("Toggle Gender", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), "Toggle Gender", "", Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 25), 1f)
    }));
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    b.Draw(Game1.daybg, new Vector2((float) (this.xPositionOnScreen + 64 /*0x40*/ + 42 - 2), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder - 16 /*0x10*/)), Color.White);
    Game1.player.FarmerRenderer.draw(b, Game1.player.FarmerSprite.CurrentAnimationFrame, Game1.player.FarmerSprite.CurrentFrame, Game1.player.FarmerSprite.SourceRect, new Vector2((float) (this.xPositionOnScreen - 2 + 42 + 128 /*0x80*/ - 32 /*0x20*/), (float) (this.yPositionOnScreen + IClickableMenu.borderWidth - 16 /*0x10*/ + IClickableMenu.spaceToClearTopBorder + 32 /*0x20*/)), Vector2.Zero, 0.8f, Color.White, 0.0f, 1f, Game1.player);
    b.End();
