...
{
  public new const int width = 1280 /*0x0500*/;
  ...
  public JojaCDMenu(Texture2D noteTexture)
    : base(Game1.uiViewport.Width / 2 - 640, Game1.uiViewport.Height / 2 - 288, 1280 /*0x0500*/, 576, true)
  {
    Game1.player.forceCanMove();
    this.noteTexture = noteTexture;
    int x = this.xPositionOnScreen + 4;
    int y = this.yPositionOnScreen + 208 /*0xD0*/;
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    b.Draw(this.noteTexture, Utility.getTopLeftPositionForCenteringOnScreen(1280 /*0x0500*/, 576), new Rectangle?(new Rectangle(0, 0, 320, 144 /*0x90*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.79f);
    base.draw(b);
    foreach (ClickableComponent checkbox in this.checkboxes)
    {
      if (checkbox.name.Equals("complete"))
        b.Draw(this.noteTexture, new Vector2((float) (checkbox.bounds.Left + 16 /*0x10*/), (float) (checkbox.bounds.Y + 16 /*0x10*/)), new Rectangle?(new Rectangle(0, 144 /*0x90*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.8f);
    }
