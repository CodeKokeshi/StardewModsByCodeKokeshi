...
public class NumberSelectionMenu : IClickableMenu
{
    ...
    int defaultNumber = 0)
  {
    ...
    int height = (int) vector2.Y + IClickableMenu.borderWidth * 2 + 160 /*0xA0*/;
    ...
    ClickableTextureComponent textureComponent1 = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + IClickableMenu.borderWidth, this.yPositionOnScreen + IClickableMenu.borderWidth + this.height / 2, 48 /*0x30*/, 44), Game1.mouseCursors, new Rectangle(352, 495, 12, 11), 4f);
    ...
    ClickableTextureComponent textureComponent2 = new ClickableTextureComponent(new Rectangle(this.xPositionOnScreen + IClickableMenu.borderWidth + 64 /*0x40*/ + this.numberSelectedBox.Width, this.yPositionOnScreen + IClickableMenu.borderWidth + this.height / 2, 48 /*0x30*/, 44), Game1.mouseCursors, new Rectangle(365, 495, 12, 11), 4f);
  ...
  {
    get => new Vector2((float) (Game1.uiViewport.Width / 2), (float) (Game1.uiViewport.Height / 2));
  }
  ...
  public override void gamePadButtonHeld(Buttons b)
  {
    ...
    {
      case 101:
        int num2 = Math.Max(this.currentValue - num1, this.minValue);
      ...
      case 102:
        ...
        int num3 = Math.Min(val1, Math.Min(this.maxValue, val2));
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    if (this.price != -1)
      b.DrawString(Game1.dialogueFont, Game1.content.LoadString("Strings\\StringsFromCSFiles:LoadGameMenu.cs.11020", (object) (this.price * this.currentValue)), new Vector2((float) (this.rightButton.bounds.Right + 32 /*0x20*/ + (this.priceShake > 0 ? Game1.random.Next(-1, 2) : 0)), (float) (this.rightButton.bounds.Y + (this.priceShake > 0 ? Game1.random.Next(-1, 2) : 0))), this.currentValue * this.price > Game1.player.Money ? Color.Red : Game1.textColor);
