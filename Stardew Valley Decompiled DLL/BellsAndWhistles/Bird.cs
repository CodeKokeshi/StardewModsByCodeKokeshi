...
public class Bird
{
  ...
  public virtual void Update(GameTime time)
  {
    ...
    switch (this.birdState)
    {
      ...
      case Bird.BirdState.Flying:
        float num1 = Utility.distance((float) (this.endPosition.X * 64 /*0x40*/) + 32f, this.position.X, (float) (this.endPosition.Y * 64 /*0x40*/) + 32f, this.position.Y);
        ...
        this.position = new Vector2(Utility.Lerp((float) (this.startPosition.X * 64 /*0x40*/) + 32f, (float) (this.endPosition.X * 64 /*0x40*/) + 32f, this.pathPosition), Utility.Lerp((float) (this.startPosition.Y * 64 /*0x40*/) + 32f, (float) (this.endPosition.Y * 64 /*0x40*/) + 32f, this.pathPosition));
        if ((double) this.pathPosition < 1.0)
          break;
        this.position = new Vector2((float) (this.endPosition.X * 64 /*0x40*/) + 32f, (float) (this.endPosition.Y * 64 /*0x40*/) + 32f);
