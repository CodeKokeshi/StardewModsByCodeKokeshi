  ...
  public override bool update(GameTime time, GameLocation environment)
  {
    ...
    if (this.characterCheckTimer < 0)
    {
      ...
      if (character != null && this.state != 1)
      {
        ...
        {
          new FarmerSprite.AnimationFrame((int) (short) (this.baseFrame + 10), 80 /*0x50*/),
          new FarmerSprite.AnimationFrame((int) (short) (this.baseFrame + 11), 80 /*0x50*/),
          new FarmerSprite.AnimationFrame((int) (short) (this.baseFrame + 12), 80 /*0x50*/),
    ...
    switch (this.state)
    {
      ...
      case 2:
        ...
        {
          environment.temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64 /*0x40*/, 64 /*0x40*/), 150f, 8, 0, new Vector2(this.position.X - 32f, this.position.Y - 32f), false, Game1.random.NextBool(), 1f / 1000f, 0.01f, Color.White, 1f, 3f / 1000f, 0.0f, 0.0f));
          break;
        }
        break;
      case 3:
