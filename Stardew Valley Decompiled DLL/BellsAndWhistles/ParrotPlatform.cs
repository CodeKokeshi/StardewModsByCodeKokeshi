...
public class ParrotPlatform
{
    ...
    bool only_show_accessible = true)
  {
    ...
    destinations.Add(new KeyValuePair<string, KeyValuePair<string, Point>>("Docks", new KeyValuePair<string, Point>("IslandSouth", new Point(6, 32 /*0x20*/))));
    return destinations;
  }
    ...
    : this()
  {
    ...
    this.position = new Vector2((float) (tile_x * 64 /*0x40*/), (float) (tile_y * 64 /*0x40*/));
  ...
  public virtual void StartDeparture()
  {
    ...
    this._takeoffEvent = new Event($"continue/follow/farmer {Game1.player.TilePoint.X.ToString()} {Game1.player.TilePoint.Y.ToString()} {Game1.player.facingDirection?.ToString()}/playerControl parrotRide", (string) null, "-1")
    {
  ...
  public virtual void Update(GameTime time)
  {
    ...
    {
      bool flag = new Microsoft.Xna.Framework.Rectangle((int) this.position.X / 64 /*0x40*/, (int) this.position.Y / 64 /*0x40*/, 3, 1).Contains(Game1.player.TilePoint);
    ...
    if (this.takeoffState >= ParrotPlatform.TakeoffState.Flying && (double) this.parrots[0].height >= 64.0)
    {
      ...
      Game1.player.drawOffset = new Vector2(0.0f, (float) (-(double) this.height * 4.0));
  ...
  {
    int num = 16 /*0x10*/;
    return rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X, (int) this.position.Y, 192 /*0xC0*/, num)) || rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X, (int) this.position.Y + 128 /*0x80*/ - num, 64 /*0x40*/, num)) || rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X + 128 /*0x80*/, (int) this.position.Y + 128 /*0x80*/ - num, 64 /*0x40*/, num)) || this.takeoffState > ParrotPlatform.TakeoffState.Idle && rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X + 64 /*0x40*/, (int) this.position.Y + 128 /*0x80*/ - num, 64 /*0x40*/, num)) || rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X, (int) this.position.Y, num, 128 /*0x80*/)) || rectangle.Intersects(new Microsoft.Xna.Framework.Rectangle((int) this.position.X + 192 /*0xC0*/ - num, (int) this.position.Y, num, 128 /*0x80*/));
  }

  public virtual bool OccupiesTile(Vector2 tile_pos)
  {
    return (double) tile_pos.X >= (double) this.position.X / 64.0 && (double) tile_pos.X < (double) this.position.X / 64.0 + 3.0 && (double) tile_pos.Y >= (double) this.position.Y / 64.0 && (double) tile_pos.Y < (double) this.position.Y / 64.0 + 2.0;
  }

  public virtual Vector2 GetDrawPosition()
  {
    return this.position - new Vector2(0.0f, (float) (128.0 + (double) this.height * 4.0)) + this.shake;
  }

  public virtual void Draw(SpriteBatch b)
  {
    b.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, this.position - new Vector2(0.0f, 128f) + new Vector2(-2f, 38f) * 4f + new Vector2(48f, 32f) * 4f / 2f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(48 /*0x30*/, 73, 48 /*0x30*/, 32 /*0x20*/)), Color.White, 0.0f, new Vector2(48f, 32f) / 2f, (float) (4.0 * (1.0 - (double) Math.Min(1f, this.height / 480f))), SpriteEffects.None, 0.0f);
    b.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, this.GetDrawPosition()), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, 0, 48 /*0x30*/, 68)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, this.position.Y / 10000f);
    b.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, this.GetDrawPosition()), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(48 /*0x30*/, 0, 48 /*0x30*/, 68)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, (float) (((double) this.position.Y + 128.0) / 10000.0));
  ...
  public class Parrot
  {
    ...
    public const int END_HEIGHT = 64 /*0x40*/;
    ...
    public virtual void Draw(SpriteBatch b)
    {
      ...
      if (this._platform.takeoffState <= ParrotPlatform.TakeoffState.Boarding)
      {
        ...
        b.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, vector2_1 - new Vector2(0.0f, this.height * 4f) + vector2_2 * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(num2 * 24, 0, 24, 24)), Color.White, 0.0f, new Vector2(12f, 19f), 4f, this.facingRight ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (float) (((double) vector2_1.Y + 0.10000000149011612 + 192.0) / 10000.0));
      }
      else
      {
        int num3 = this.flapping ? 1 : 0;
        if (this.flapping && (double) this.nextFlap <= 0.05000000074505806)
          num3 = 2;
        int num4 = 5;
        if (this.facingUp)
          num4 = 8;
        b.Draw(this.texture, Game1.GlobalToLocal(Game1.viewport, vector2_1 - new Vector2(0.0f, this.height * 4f) + vector2_2 * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle((num4 + num3) * 24, 0, 24, 24)), Color.White, 0.0f, new Vector2(12f, 19f), 4f, this.facingRight ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (float) (((double) vector2_1.Y + 0.10000000149011612 + 128.0) / 10000.0));
        ...
        float num5 = 1E-06f;
        float num6 = 0.0f;
        float num7 = (float) (((double) vector2_3.Y + 0.05000000074505806) / 10000.0);
        foreach (Vector2 point in this.points)
        {
          b.Draw(this._platform.texture, point, new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(16 /*0x10*/, 68, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, new Vector2(8f, 8f), 4f, SpriteEffects.None, num7 + num6);
          num6 += num5;
          if (nullable.HasValue)
          {
            Vector2 vector2_4 = point - nullable.Value;
            int num8 = (int) Math.Ceiling((double) vector2_4.Length() / 4.0);
            float rotation = (float) (-Math.Atan2((double) vector2_4.X, (double) vector2_4.Y) + 1.5707963705062866);
            b.Draw(this._platform.texture, nullable.Value, new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, 68, 16 /*0x10*/, 16 /*0x10*/)), Color.White, rotation, new Vector2(0.0f, 8f), new Vector2((float) (4 * num8) / 16f, 4f), SpriteEffects.None, num7 + num6);
            num6 += num5;
          }
