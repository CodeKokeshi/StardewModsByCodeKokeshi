...
public class Woodpecker : Critter
{
  ...
  public Woodpecker(Tree tree, Vector2 position)
  {
    ...
    this.baseFrame = 320;
    this.sprite = new AnimatedSprite(Critter.critterTexture, 320, 16 /*0x10*/, 16 /*0x10*/);
  }

  public override void drawAboveFrontLayer(SpriteBatch b)
  {
    this.sprite.draw(b, Game1.GlobalToLocal(Game1.viewport, this.position + new Vector2(-80f, this.yJumpOffset - 64f + this.yOffset)), 1f, 0, 0, Color.White, this.flip, 4f);
  }
  ...
  public override bool update(GameTime time, GameLocation environment)
  {
    ...
    if (this.characterCheckTimer < 0)
    {
      ...
      if ((character != null || this.tree.stump.Value) && !this.flyingAway)
      {
