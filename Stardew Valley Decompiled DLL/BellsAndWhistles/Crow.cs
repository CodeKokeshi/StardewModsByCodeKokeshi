...
public class Crow : Critter
{
  ...
  public Crow(int tileX, int tileY)
    : base(14, new Vector2((float) (tileX * 64 /*0x40*/), (float) (tileY * 64 /*0x40*/)))
  {
      ...
      case 0:
        if (this.sprite.CurrentAnimation == null)
        {
          List<FarmerSprite.AnimationFrame> animation = new List<FarmerSprite.AnimationFrame>()
          {
            ...
            new FarmerSprite.AnimationFrame((int) (short) (this.baseFrame + 1), 170, false, this.flip),
            new FarmerSprite.AnimationFrame((int) (short) (this.baseFrame + 2), 170, false, this.flip)
          };
