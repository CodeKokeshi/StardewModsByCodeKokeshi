...
// Type: StardewValley.Internal.ItemQueryContext
...
public class ItemQueryContext
{
  ...
  public ItemQueryContext()
    : this((GameLocation) null, (Farmer) null, (Random) null, (string) null)
  {
  }
    ...
    : this(parentContext?.Location, parentContext?.Player, parentContext?.Random, parentContext?.SourcePhrase)
  {
    ...
    if (sourceLabel == null)
      return;
    this.SourcePhrase = parentContext == null || parentContext.SourcePhrase == null ? sourceLabel : $"{parentContext.SourcePhrase} > {sourceLabel}";
  }
