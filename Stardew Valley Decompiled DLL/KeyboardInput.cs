  ...
  private static IntPtr HookProc(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam)
  {
    ...
    switch (msg)
    {
      ...
      case 256 /*0x0100*/:
        ...
        if (keyDown != null)
        {
          keyDown((object) null, new KeyEventArgs((Keys) (int) wParam));
          break;
        }
        break;
      case 257:
        ...
        if (keyUp != null)
        {
          keyUp((object) null, new KeyEventArgs((Keys) (int) wParam));
          break;
        }
        break;
      case 258:
        ...
        if (charEntered != null)
        {
          charEntered((object) null, new CharacterEventArgs((char) (int) wParam, lParam.ToInt32()));
          break;
        }
        break;
      case 641:
