...
public static class DataLoader
{
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static List<ModWallpaperOrFlooring> AdditionalWallpaperFlooring(
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static List<StardewValley.GameData.FishPonds.FishPondData> FishPondData(
    LocalizedContentManager content)
  {
    return DataLoader.Load<List<StardewValley.GameData.FishPonds.FishPondData>>(content, "Data\\FishPondData");
  }
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static Dictionary<string, IncomingPhoneCallData> IncomingPhoneCalls(
    LocalizedContentManager content)
  {
  ...
  public static Dictionary<string, LocationContextData> LocationContexts(
    LocalizedContentManager content)
  {
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static Dictionary<string, MonsterSlayerQuestData> MonsterSlayerQuests(
    LocalizedContentManager content)
  {
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static Dictionary<string, StardewValley.GameData.Museum.MuseumRewards> MuseumRewards(
    LocalizedContentManager content)
  {
    return DataLoader.Load<Dictionary<string, StardewValley.GameData.Museum.MuseumRewards>>(content, "Data\\MuseumRewards");
  }
  ...
  /// <param name="content">The content manager through which to load data.</param>
  public static Dictionary<string, PassiveFestivalData> PassiveFestivals(
    LocalizedContentManager content)
  {
