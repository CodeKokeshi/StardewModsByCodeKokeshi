...
label_3:
  ...
  {
    return (Func<T, DeepCloneState, T>) DeepClonerCache.GetOrAddStructAsObject<object>(typeof (T), (Func<Type, object>) (t => DeepClonerGenerator.GenerateCloner(t, false)));
  }

  private static object GenerateCloner(Type t, bool asObject)
  {
    return DeepClonerSafeTypes.CanReturnSameObject(t) && asObject && !t.IsValueType() ? (object) null : DeepClonerExprGenerator.GenerateClonerInternal(t, asObject);
  }
