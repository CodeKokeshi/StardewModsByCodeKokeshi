...
// Type: StardewValley.TokenizableStrings.TokenStringBuilder
...
public static class TokenStringBuilder
{
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (AchievementName), achievementId.ToString());
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (ArticleFor), word);
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (CapitalizeFirstLetter), text);
  }
  ...
  {
    return fallbackItemName == null ? TokenStringBuilder.BuildTokenWithArgumentString(nameof (ItemName), itemId) : TokenStringBuilder.BuildTokenWithArgumentString(nameof (ItemName), itemId, fallbackItemName);
  }
  ...
  /// <remarks>Consider using <see cref="M:StardewValley.TokenizableStrings.TokenStringBuilder.ItemNameFor(StardewValley.Item,System.String)" /> instead if you have an item instance, which accounts for variations like flavored items automatically.</remarks>
  public static string ItemNameWithFlavor(
    Object.PreserveType preserveType,
    string preservedId,
    string fallbackItemName = null)
  {
    return fallbackItemName == null ? TokenStringBuilder.BuildTokenWithArgumentString(nameof (ItemNameWithFlavor), preserveType.ToString(), preservedId) : TokenStringBuilder.BuildTokenWithArgumentString(nameof (ItemNameWithFlavor), preserveType.ToString(), preservedId, fallbackItemName);
  }
  ...
  public static string ItemNameFor(Item item, string fallbackItemName = null)
  {
    ...
    {
      if (!string.IsNullOrWhiteSpace(@object.displayNameFormat))
        return @object.displayNameFormat;
      Object.PreserveType? nullable = @object.preserve.Value;
      if (nullable.HasValue)
      {
        nullable = @object.preserve.Value;
        return TokenStringBuilder.ItemNameWithFlavor(nullable.Value, @object.preservedParentSheetIndex.Value, fallbackItemName);
      }
    }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (LocalizedText), translationKey);
  }
  ...
  {
    return fallbackText == null ? TokenStringBuilder.BuildTokenWithArgumentString(nameof (MonsterName), monsterId) : TokenStringBuilder.BuildTokenWithArgumentString(nameof (MonsterName), monsterId, fallbackText);
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (MovieName), movieId);
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (NumberWithSeparators), number.ToString());
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (SpecialOrderName), orderId);
  }
  ...
  {
    return TokenStringBuilder.BuildTokenWithArgumentString(nameof (ToolName), itemId, upgradeLevel.ToString());
  }
  ...
  public static string BuildTokenWithArgumentString(
    string tokenName,
    string arg1,
    string arg2,
    string arg3)
