...
public class IslandHut : IslandLocation
{
  ...
  public override void draw(SpriteBatch b)
  {
    if (this.treeHitLocal)
      b.Draw(Game1.mouseCursors2, Game1.GlobalToLocal(Game1.viewport, new Vector2(10f, 7f) * 64f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(16 /*0x10*/, 192 /*0xC0*/, 16 /*0x10*/, 32 /*0x20*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0f);
    base.draw(b);
  }
  ...
  public virtual int ShowNutHint()
  {
    ...
    {
      Random random = Utility.CreateRandom((double) Game1.uniqueIDForThisGame, (double) Game1.Date.TotalDays * 642.0);
  ...
  {
    base.initNetFields();
    this.NetFields.AddField((INetSerializable) this.treeNutObtained, "treeNutObtained").AddField(this.hitTreeEvent.NetFields, "hitTreeEvent.NetFields").AddField((INetSerializable) this.firstParrotDone, "firstParrotDone").AddField(this.parrotBoyEvent.NetFields, "parrotBoyEvent.NetFields").AddField((INetSerializable) this.hintForToday, "hintForToday");
  ...
  private void ParrotBoyEvent_onEvent()
  {
    ...
    {
      if (!(Game1.locationRequest?.Location?.NameOrUniqueName == this.NameOrUniqueName) || Game1.warpingForForcedRemoteEvent)
        return;
      Game1.addMailForTomorrow("sawParrotBoyIntro", true);
  ...
  public virtual void SpitTreeNut()
  {
    ...
    this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Microsoft.Xna.Framework.Rectangle(32 /*0x20*/, 192 /*0xC0*/, 16 /*0x10*/, 32 /*0x20*/), 1250f, 1, 1, new Vector2(10f, 7f) * 64f, false, false, 0.0001f, 0.0f, Color.White, 4f, 0.0f, 0.0f, 0.0f)
    {
      shakeIntensity = 1f
    });
    ...
    for (int index = 0; index < 5; ++index)
      this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(352, 1200, 16 /*0x10*/, 16 /*0x10*/), 50f, 11, 3, new Vector2(10f, 5f) * 64f, false, false, 0.1f, 0.01f, Color.White, 4f, 0.0f, 0.0f, 0.0f)
      {
        motion = {
    ...
    DelayedAction.functionAfterDelay((Action) (() => Game1.createItemDebris(ItemRegistry.Create("(O)73"), new Vector2(10.5f, 7f) * 64f, 0, (GameLocation) this, 0)), 1250);
  ...
  protected override void resetLocalState()
  {
    ...
    if (Game1.netWorldState.Value.GoldenWalnutsFound < 10)
    {
      ...
      this.temporarySprites.Add(new TemporaryAnimatedSprite("Characters\\ParrotBoy", new Microsoft.Xna.Framework.Rectangle(32 /*0x20*/, 128 /*0x80*/, 16 /*0x10*/, 32 /*0x20*/), new Vector2(5f, 0.5f) * 64f, false, 0.0f, Color.White)
      {
        id = 777,
        scale = 4f,
        totalNumberOfLoops = 99999,
