...
public class Wisp
{
  ...
  public Vector2[] oldPositions = new Vector2[16 /*0x10*/];
  ...
  public virtual void Update(GameTime time)
  {
    ...
    this.position.X -= Math.Max(0.4f, Math.Min(1f, (float) this.index * 0.01f)) - (float) ((double) this.index * 0.0099999997764825821 * Math.Sin(2.0 * Math.PI * (double) time.TotalGameTime.Milliseconds / 8000.0));
