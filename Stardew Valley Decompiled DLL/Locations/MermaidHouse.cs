...
public class MermaidHouse : GameLocation
{
  ...
  {
    switch (this.getTileIndexAt(tileLocation, "Buildings", "mermaid_tiles"))
    {
      case 56:
  ...
  public void playClamTone(int which, Farmer who)
  {
    ...
    Game1.playSound("clam_tone", new int?(num));
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    foreach (TemporaryAnimatedSprite sparkle in this.sparkles)
      sparkle.draw(b, true);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(58f, 54f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(this.mermaidFrames[Math.Min((int) ((double) this.stopWatch.ElapsedMilliseconds / 769.23077392578125), this.mermaidFrames.Length - 1)] * 28, 80 /*0x50*/, 28, 36)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0009f);
    ...
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(97f, 29f) * 4f + new Vector2((float) (Math.Cos((double) this.stopWatch.ElapsedMilliseconds / 1000.0 + 0.10000000149011612) * 4.0 * 4.0), (float) (Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0 + 0.10000000149011612) * 4.0 * 4.0))), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(2 + (int) ((double) this.showTimer % 400.0 / 100.0) * 19, (int) sbyte.MaxValue, 19, 18)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0009f);
  ...
  public override void drawAboveAlwaysFrontLayer(SpriteBatch b)
  {
    ...
    {
      b.Draw(this.mermaidSprites, new Vector2((float) (index - (int) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0)), (float) (num - num * 3 / 4)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(144 /*0x90*/, 32 /*0x20*/, 112 /*0x70*/, 48 /*0x30*/)), Color.Lime * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + 112 /*0x70*/) - (float) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0), (float) ((double) num - (double) num / 4.0 + Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0) * 64.0)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(177, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + (int) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0)), (float) (num * 2 - num * 3 / 4)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(144 /*0x90*/, 32 /*0x20*/, 112 /*0x70*/, 48 /*0x30*/)), Color.Cyan * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + 112 /*0x70*/) + (float) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0), (float) ((double) (num * 2) - (double) num / 4.0 + Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0 + 4.0) * 64.0)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(161, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index - (int) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0)), (float) (num * 3 - num * 3 / 4)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(144 /*0x90*/, 32 /*0x20*/, 112 /*0x70*/, 48 /*0x30*/)), Color.Orange * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + 112 /*0x70*/) - (float) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0), (float) ((double) (num * 3) - (double) num / 4.0 + Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0 + 3.0) * 64.0)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(129, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + (int) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0)), (float) (num * 4 - num * 3 / 4)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(144 /*0x90*/, 32 /*0x20*/, 112 /*0x70*/, 48 /*0x30*/)), Color.HotPink * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
      b.Draw(this.mermaidSprites, new Vector2((float) (index + 112 /*0x70*/) + (float) ((double) this.stopWatch.ElapsedMilliseconds / 6.0 % 448.0), (float) ((double) (num * 4) - (double) num / 4.0 + Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0 + 2.0) * 64.0)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(145, 0, 16 /*0x10*/, 16 /*0x10*/)), Color.White * this.blackBGAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 1f / 1000f);
    }
    b.Draw(this.mermaidSprites, new Vector2((float) (Game1.graphics.GraphicsDevice.Viewport.Bounds.Center.X - 112 /*0x70*/) + (float) (Math.Sin((double) this.stopWatch.ElapsedMilliseconds / 1000.0) * 64.0 * 2.0), (float) (Game1.graphics.GraphicsDevice.Viewport.Bounds.Center.Y - 140) + (float) (Math.Cos((double) this.stopWatch.ElapsedMilliseconds / 1000.0 * 2.0 + Math.PI / 2.0) * 64.0)), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle((int) (57L * (this.stopWatch.ElapsedMilliseconds % 1538L / 769L)), 0, 57, 70)), Color.White * this.bigMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
    ...
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-20f, 50f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-20f, 50f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Orange * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0011f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-30f, 90f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-30f, 90f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Cyan * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0011f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-40f, 130f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(-40f, 130f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Lime * this.finalLeftMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0011f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(150f, 50f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(150f, 50f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Orange * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 0.0011f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(160f, 90f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(160f, 90f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Cyan * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 0.0011f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(170f, 130f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(192 /*0xC0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.White * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 1f / 1000f);
    b.Draw(this.mermaidSprites, Game1.GlobalToLocal(new Vector2(170f, 130f) * 4f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(208 /*0xD0*/, 0, 16 /*0x10*/, 32 /*0x20*/)), Color.Lime * this.finalRightMermaidAlpha, 0.0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 0.0011f);
  ...
  public override void UpdateWhenCurrentLocation(GameTime time)
  {
    ...
    if (!Game1.shouldTimePass())
    {
      if (this.stopWatch != null && this.stopWatch.IsRunning)
        this.stopWatch.Stop();
      if (cue?.Name == "mermaidSong" && !cue.IsPaused && cue.IsPlaying)
        cue.Pause();
    }
    else
    {
      if (this.stopWatch != null && !this.stopWatch.IsRunning && cue?.Name == "mermaidSong" && cue.IsPaused)
        this.stopWatch.Start();
      if (cue?.Name == "mermaidSong" && cue.IsPaused)
        cue.Resume();
    }
    TimeSpan elapsedGameTime;
    if (Game1.shouldTimePass())
    {
      double showTimer1 = (double) this.showTimer;
      double showTimer2 = (double) this.showTimer;
      elapsedGameTime = time.ElapsedGameTime;
      double milliseconds1 = (double) elapsedGameTime.Milliseconds;
      this.showTimer = (float) (showTimer2 + milliseconds1);
      if ((cue?.Name == "mermaidSong" && cue.IsPlaying || (double) Game1.options.musicVolumeLevel <= 0.0 && (double) Game1.options.ambientVolumeLevel <= 0.0) && !this.stopWatch.IsRunning)
        this.stopWatch.Start();
      if ((double) this.curtainMovement != 0.0)
      {
        ...
        double num = curtainMovement * milliseconds2;
        this.curtainOpenPercent = Math.Max(0.0f, Math.Min(1f, (float) (curtainOpenPercent + num)));
      }
      if (showTimer1 < 3000.0 && (double) this.showTimer >= 3000.0)
        Game1.changeMusicTrack("mermaidSong");
      Stopwatch stopWatch = this.stopWatch;
      if ((stopWatch != null ? (stopWatch.ElapsedMilliseconds > 0L ? 1 : 0) : 0) != 0 && this.stopWatch.ElapsedMilliseconds < 1000L)
        this.curtainMovement = 0.0004f;
      this.sparkles.RemoveWhere<TemporaryAnimatedSprite>((Predicate<TemporaryAnimatedSprite>) (sparkle => sparkle.update(time)));
      this.alwaysFrontTempSprites.RemoveWhere<TemporaryAnimatedSprite>((Predicate<TemporaryAnimatedSprite>) (sprite => sprite.update(time)));
      ...
      if (this.stopWatch.ElapsedMilliseconds > 27692L && this.stopWatch.ElapsedMilliseconds < 55385L)
      {
        if ((double) this.oldStopWatchTime % 769.0 > (double) (this.stopWatch.ElapsedMilliseconds % 769L))
        {
          ...
          double x = (double) Game1.random.Next((int) ((double) Game1.graphics.GraphicsDevice.Viewport.Width / (double) Game1.options.zoomLevel) - 64 /*0x40*/);
          viewport = Game1.graphics.GraphicsDevice.Viewport;
          double y = (double) viewport.Height / (double) Game1.options.zoomLevel;
        ...
        for (int index1 = 0; index1 < this.bubbles.Count; ++index1)
        {
          ...
          elapsedGameTime = time.ElapsedGameTime;
          double num = 0.10000000149011612 * (double) elapsedGameTime.Milliseconds;
          double y2 = y1 - num;
      ...
      {
        TemporaryAnimatedSpriteList frontTempSprites = this.alwaysFrontTempSprites;
    ...
    this.fairyTimer = (float) (fairyTimer - milliseconds);
    if ((double) this.fairyTimer < 200.0)
    {
      Farmer pearlRecipient = this.pearlRecipient;
      if ((pearlRecipient != null ? (pearlRecipient.FacingDirection == 0 ? 1 : 0) : 0) != 0)
