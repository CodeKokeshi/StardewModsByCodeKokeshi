...
public class TrashBear : NPC
{
  ...
  public TrashBear()
    : base(new AnimatedSprite("Characters\\TrashBear", 0, 32 /*0x20*/, 32 /*0x20*/), new Vector2(102f, 95f) * 64f, 0, nameof (TrashBear))
  {
  ...
  {
    base.initNetFields();
    this.NetFields.AddField((INetSerializable) this.cutsceneEvent, "cutsceneEvent").AddField((INetSerializable) this.eatEvent, "eatEvent");
    this.cutsceneEvent.onEvent += new NetEvent0.Event(this.doCutscene);
    this.eatEvent.onEvent += new AbstractNetEvent1<string>.Event(this.doEatEvent);
  }
  ...
  public void updateItemWanted()
  {
    ...
    if (NetWorldState.checkAnywhereForWorldStateID("trashBear3"))
      seedB = 3;
    int randomSeed = Utility.CreateRandomSeed(777111.0, (double) seedB);
    this.itemWantedIndex = Utility.getRandomPureSeasonalItem(Game1.season, randomSeed);
    if (seedB <= 1)
      return;
    int num1 = Utility.CreateRandom((double) Game1.uniqueIDForThisGame, (double) randomSeed).Next(CraftingRecipe.cookingRecipes.Count);
    int num2 = 0;
    foreach (string str in CraftingRecipe.cookingRecipes.Values)
    {
      if (num2 == num1)
      {
        this.itemWantedIndex = ArgUtility.SplitBySpaceAndGet(ArgUtility.Get(str.Split('/'), 2), 0);
        break;
      }
      ++num2;
    }
  ...
  public void doEatEvent(string item_index)
  {
    ...
    Game1.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(dataOrErrorItem.GetTextureName(), dataOrErrorItem.GetSourceRect(), 1500f, 1, 0, this.Position + new Vector2(96f, -92f), false, false, (float) (this.StandingPixel.Y + 1) / 10000f, 0.0f, Color.White, 4f, 0.0f, 0.0f, 0.0f));
  }

  private void throwUpItem(Farmer who)
  {
    ParsedItemData dataOrErrorItem = ItemRegistry.GetDataOrErrorItem("(O)" + this.itemBeingEaten);
    Game1.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(dataOrErrorItem.GetTextureName(), dataOrErrorItem.GetSourceRect(), 1000f, 1, 0, this.Position + new Vector2(96f, -108f), false, false, (float) (this.StandingPixel.Y + 1) / 10000f, 0.0f, Color.White, 4f, -0.01f, 0.0f, 0.0f)
    {
  ...
  private void chew(Farmer who)
  {
    ...
    {
      Rectangle sourceRect = dataOrErrorItem.GetSourceRect().Clone();
      sourceRect.X += 8;
      sourceRect.Y += 8;
      sourceRect.Width = 4;
      sourceRect.Height = 4;
      Game1.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(textureName, sourceRect, 400f, 1, 0, this.Position + new Vector2(64f, -48f), false, false, (float) ((double) this.StandingPixel.Y / 10000.0 + 0.0099999997764825821), 0.0f, Color.White, 4f, 0.0f, 0.0f, 0.0f)
      {
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    float num2 = (float) ((tilePoint.Y + 1) * 64 /*0x40*/) / 10000f;
    float num3 = num1 - 40f;
    b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, new Vector2((float) (tilePoint.X * 64 /*0x40*/ + 32 /*0x20*/), (float) (tilePoint.Y * 64 /*0x40*/ - 96 /*0x60*/ - 48 /*0x30*/) + num3)), new Rectangle?(new Rectangle(141, 465, 20, 24)), Color.White * 0.75f, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, num2 + 1E-06f);
    ...
    b.Draw(texture, Game1.GlobalToLocal(Game1.viewport, new Vector2((float) (tilePoint.X * 64 /*0x40*/ + 64 /*0x40*/ + 8), (float) (tilePoint.Y * 64 /*0x40*/ - 64 /*0x40*/ - 32 /*0x20*/ - 8) + num3)), new Rectangle?(sourceRect), Color.White, 0.0f, new Vector2(8f, 8f), 4f, SpriteEffects.None, num2 + 1E-05f);
  }
}
