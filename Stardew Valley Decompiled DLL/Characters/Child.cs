...
public class Child : NPC
{
  ...
  {
    base.initNetFields();
    this.NetFields.AddField((INetSerializable) this.setStateEvent, "setStateEvent").AddField((INetSerializable) this.darkSkinned, "darkSkinned").AddField((INetSerializable) this.daysOld, "daysOld").AddField((INetSerializable) this.idOfParent, "idOfParent").AddField((INetSerializable) this.mutex.NetFields, "mutex.NetFields").AddField((INetSerializable) this.hat, "hat");
    this.age.fieldChangeVisibleEvent += (FieldChange<NetInt, int>) ((a, b, c) => this.reloadSprite(false));
  ...
  public override void reloadSprite(bool onlyAppearance = false)
  {
    ...
    {
      Farmer player = Game1.GetPlayer(this.idOfParent.Value);
      if (this.idOfParent.Value == 0L || player == null)
      {
    ...
    if (this.Sprite == null)
      this.Sprite = new AnimatedSprite("Characters\\Baby" + (this.darkSkinned.Value ? "_dark" : ""), 0, 22, 16 /*0x10*/);
    if (this.Age >= 3)
    {
    ...
    else
    {
      ...
      this.Sprite.SpriteHeight = this.Age == 1 ? 32 /*0x20*/ : 16 /*0x10*/;
      this.Sprite.currentFrame = 0;
      switch (this.Age)
      {
        case 1:
  ...
  {
    if (this.Age < 2 || this.Sprite.currentFrame <= 7 && this.Sprite.SpriteHeight == 16 /*0x10*/)
      return;
  ...
  public override void resetForNewDay(int dayOfMonth)
  {
    ...
    if (!(this.currentLocation is FarmHouse currentLocation) || currentLocation.GetChildBed(this.GetChildIndex()) != null)
      return;
    this.sleptInBed.Value = false;
  }

  protected override string translateName() => this.name.Value.TrimEnd();
  ...
  public override void dayUpdate(int dayOfMonth)
  {
    ...
    Random daySaveRandom = Utility.CreateDaySaveRandom((double) (num * 2));
    ++this.daysOld.Value;
    ...
    {
      this.speed = 1;
      Point openPointInHouse = (this.currentLocation as FarmHouse).getRandomOpenPointInHouse(daySaveRandom, 1, 200);
      if (!openPointInHouse.Equals(Point.Zero))
        this.setTilePosition(openPointInHouse);
      else
        this.Position = new Vector2(31f, 14f) * 64f + new Vector2(0.0f, -24f);
      this.Sprite.CurrentAnimation = (List<FarmerSprite.AnimationFrame>) null;
    }
    if (this.Age == 3)
    {
      ...
      {
        Point childBedSpot = (this.currentLocation as FarmHouse).GetChildBedSpot(this.GetChildIndex());
        if (!childBedSpot.Equals(Point.Zero))
          this.setTilePosition(childBedSpot);
      }
      this.Sprite.CurrentAnimation = (List<FarmerSprite.AnimationFrame>) null;
    }
    this.reloadSprite(false);
  ...
  public bool isInCrib()
  {
    ...
    return tilePoint.X >= 30 && tilePoint.X <= 32 /*0x20*/ && tilePoint.Y >= 13 && tilePoint.Y <= 14;
  }

  /// <inheritdoc />
  public override bool hasDarkSkin() => this.darkSkinned.Value;

  public void toss(Farmer who)
  {
    if (this.IsInvisible || Game1.timeOfDay >= 1800 || this.Sprite.SpriteHeight <= 16 /*0x10*/)
      return;
    if (who == Game1.player)
  ...
  public void performToss(Farmer who)
  {
    ...
    if (stats != null)
    {
      int num = (int) stats.Increment("timesTossedBaby", 1);
    }
  ...
  public override Microsoft.Xna.Framework.Rectangle getMugShotSourceRect()
  {
    ...
    {
      case 0:
        return new Microsoft.Xna.Framework.Rectangle(0, 0, 22, 16 /*0x10*/);
      case 1:
        return new Microsoft.Xna.Framework.Rectangle(0, 42, 22, 24);
      case 2:
        return new Microsoft.Xna.Framework.Rectangle(0, 112 /*0x70*/, 22, 16 /*0x10*/);
      case 3:
        return new Microsoft.Xna.Framework.Rectangle(0, 4, 16 /*0x10*/, 24);
      default:
  ...
  private void doSetState(int state)
  {
    switch (state)
    {
      case 0:
        ...
        this.Sprite.setCurrentAnimation(new List<FarmerSprite.AnimationFrame>()
        {
          new FarmerSprite.AnimationFrame(32 /*0x20*/, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(33, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(34, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(35, 160 /*0xA0*/)
        });
        break;
      case 1:
        ...
        this.Sprite.setCurrentAnimation(new List<FarmerSprite.AnimationFrame>()
        {
          new FarmerSprite.AnimationFrame(28, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(29, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(30, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(31 /*0x1F*/, 160 /*0xA0*/)
        });
        break;
      case 2:
        ...
        this.Sprite.setCurrentAnimation(new List<FarmerSprite.AnimationFrame>()
        {
          new FarmerSprite.AnimationFrame(24, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(25, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(26, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(27, 160 /*0xA0*/)
        });
        break;
      case 3:
        ...
        this.Sprite.setCurrentAnimation(new List<FarmerSprite.AnimationFrame>()
        {
          new FarmerSprite.AnimationFrame(36, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(37, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(38, 160 /*0xA0*/),
          new FarmerSprite.AnimationFrame(39, 160 /*0xA0*/)
        });
        break;
      case 4:
        this.Halt();
  ...
  public void tenMinuteUpdate()
  {
    ...
    if (this.Age == 2)
      this.setCrawlerInNewDirection();
    else if (Game1.timeOfDay % 100 == 0 && this.Age == 3 && Game1.timeOfDay < 1900)
    {
      ...
      if (this.controller.pathToEndPoint != null && currentLocation.isTileOnMap(this.controller.pathToEndPoint.Last<Point>()))
        return;
      this.controller = (PathFindController) null;
    }
    else
    {
      if (this.Age != 3 || Game1.timeOfDay != 1900)
        return;
      this.IsWalkingInSquare = false;
      this.Halt();
      FarmHouse currentLocation = this.currentLocation as FarmHouse;
  ...
  public void toddlerReachedDestination(Character c, GameLocation l)
  {
    if (Game1.random.NextDouble() < 0.8 && c.FacingDirection == 2)
      this.Sprite.setCurrentAnimation(new List<FarmerSprite.AnimationFrame>()
      {
        new FarmerSprite.AnimationFrame(16 /*0x10*/, 120, 0, false, false),
        ...
        new FarmerSprite.AnimationFrame(16 /*0x10*/, 100, 0, false, false),
  ...
  public override bool canTalk()
  {
    ...
    return Game1.player.friendshipData.TryGetValue(this.Name, out friendship) && !friendship.TalkedToToday;
  }
  ...
  public override void update(GameTime time, GameLocation location)
  {
    ...
    if ((double) this.yJumpVelocity <= 18.0)
      return;
    Utility.addSmokePuff(location, this.Position + new Vector2(32f, (float) this.yJumpOffset), baseScale: this.yJumpVelocity / 8f, scaleChange: 0.01f, alphaFade: 0.01f);
  }
  ...
  public void resetForPlayerEntry(GameLocation l)
  {
    switch (this.Age)
    {
      case 0:
        ...
        break;
      case 1:
        this.Position = new Vector2(31f, 14f) * 64f + new Vector2(0.0f, -12f);
        if (Game1.timeOfDay >= 1800 && this.Sprite != null)
        {
          this.Sprite.StopAnimation();
          this.Sprite.SpriteHeight = 16 /*0x10*/;
  ...
  public override void draw(SpriteBatch b, float alpha = 1f)
  {
    ...
    if (!this.IsInvisible && this.hat.Value != null && this.hat.Value.hairDrawType.Value != 0)
    {
  ...
  public override void draw(SpriteBatch b)
  {
    ...
    if (this.IsEmoting && !Game1.eventUp)
    {
      ...
      localPosition.Y -= (float) (32 /*0x20*/ + this.Sprite.SpriteHeight * 4 - (this.Age == 1 || this.Age == 3 ? 64 /*0x40*/ : 0));
      localPosition.X += this.Age == 1 ? 8f : 0.0f;
      b.Draw(Game1.emoteSpriteSheet, localPosition, new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(this.CurrentEmoteIndex * 16 /*0x10*/ % Game1.emoteSpriteSheet.Width, this.CurrentEmoteIndex * 16 /*0x10*/ / Game1.emoteSpriteSheet.Width * 16 /*0x10*/, 16 /*0x10*/, 16 /*0x10*/)), Color.White, 0.0f, Vector2.Zero, 4f, SpriteEffects.None, (float) this.StandingPixel.Y / 10000f);
    }
    bool flag1 = true;
    if (this.hat.Value == null)
      return;
    ...
    this.hat.Value.draw(b, this.getLocalPosition(Game1.viewport) + vector2 + new Vector2(30f, -42f), 1.33333337f, 1f, layerDepth, direction);
  }
