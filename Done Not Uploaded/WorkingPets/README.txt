...
If the pet is doing a sleep/"zzz" emote, the mod will let them rest (it won’t force-move them during that time).
Once the emote ends, they’ll continue working/following normally.
...
- Not follow you outside the farm (Follow Outside Farm is off by default; can be enabled through GMCM)

"How to use in-game"

- Load your save.
- Walk up to your pet and interact/talk.
