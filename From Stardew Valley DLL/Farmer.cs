...
public class Farmer : Character, IComparable
{
	...
	private readonly NetEvent1Field<StardewValley.Object, NetRef<StardewValley.Object>> drinkAnimationEvent = new NetEvent1Field<StardewValley.Object, NetRef<StardewValley.Object>>();

	private readonly NetEvent1Field<StardewValley.Object, NetRef<StardewValley.Object>> eatAnimationEvent = new NetEvent1Field<StardewValley.Object, NetRef<StardewValley.Object>>();
	...
	[XmlIgnore]
	public StardewValley.Object ActiveObject
	{
		get
		{
			return ActiveItem as StardewValley.Object;
		}
		set
		{
			ActiveItem = value;
	...
	public void makeThisTheActiveObject(StardewValley.Object o)
	{
	...
	public void onGiftGiven(NPC npc, StardewValley.Object item)
	{
	...
	public void dayupdate(int timeWentToSleep)
	{
		...
		foreach (StardewValley.Object value in base.currentLocation.netObjects.Values)
		{
	...
	public static void showEatingItem(Farmer who)
	{
		...
		else if ((who.itemToEat as StardewValley.Object)?.preservedParentSheetIndex.Value != null)
		{
			if (who.itemToEat.ItemId.Equals("SmokedFish"))
			{
				ParsedItemData dataOrErrorItem2 = ItemRegistry.GetDataOrErrorItem("(O)" + (who.itemToEat as StardewValley.Object).preservedParentSheetIndex.Value);
		...
		if (!(item is SpecialItem specialItem))
		{
			if (!(item is Slingshot) && !(item is MeleeWeapon) && !(item is Boots))
			{
				if (!(item is Hat))
				{
					...
					{
						if (!(item is StardewValley.Object) && !(item is Tool))
						{
							if (!(item is Ring))
							{
								if (item == null)
						...
						else if (item is StardewValley.Object obj && obj.bigCraftable.Value)
						{
	...
	public void addItemsByMenuIfNecessary(List<Item> itemsToAdd, ItemGrabMenu.behaviorOnItemSelect itemSelectedCallback = null, bool forceQueue = false)
	{
		...
		if (itemsToAdd.Count > 0 && itemsToAdd[0]?.QualifiedItemId == "(O)434")
		{
			...
			{
				eatObject(itemsToAdd[0] as StardewValley.Object, overrideFullness: true);
			}
			else
			{
	...
	public virtual void StopSitting(bool animate = true)
	{
		...
		if (furniture.IsSeatHere(base.currentLocation))
		{
			...
			foreach (Vector2 exit_position in exit_positions)
			{
				...
				StardewValley.Object tile_object = base.currentLocation.getObjectAtTile((int)exit_position.X, (int)exit_position.Y, ignorePassables: true);
	...
	public bool couldInventoryAcceptThisItem(Item item)
	{
		...
		default:
		{
			for (int i = 0; i < maxItems.Value; i++)
			{
				if (Items.Count > i && (Items[i] == null || (item is StardewValley.Object && Items[i] is StardewValley.Object && Items[i].Stack + item.Stack <= Items[i].maximumStackSize() && (Items[i] as StardewValley.Object).canStackWith(item))))
				{
					return true;
				}
			}
	...
	public void OnItemReceived(Item item, int countAdded, Item mergedIntoStack, bool hideHudNotification = false)
	{
		...
		if (actualItem is StardewValley.Object { specialItem: not false } obj)
		{
		...
		if (actualItem.HasTypeObject() && actualItem is StardewValley.Object obj2)
		{
	...
	public static void drinkGlug(Farmer who)
	{
		...
		if (Game1.currentLocation == who.currentLocation)
		{
			Game1.playSound((who.itemToEat is StardewValley.Object o && o.preserve.Value == StardewValley.Object.PreserveType.Pickle) ? "eat" : "gulp");
		}
	...
	{
		TemporaryAnimatedSprite tempSprite = null;
		StardewValley.Object toShow = ((!(who.mostRecentlyGrabbedItem is StardewValley.Object grabbedObj)) ? ((who.ActiveObject == null) ? null : who.ActiveObject) : grabbedObj);
		if (toShow == null)
		{
			return;
		}
		...
		if (CanMove)
		{
			...
			if (health <= 0 && !Game1.killScreen && Game1.timeOfDay < 2600)
			{
				...
				if (Utility.GetDayOfPassiveFestival("DesertFestival") > 0 && Game1.player.currentLocation is MineShaft && Game1.mine.getMineArea() == 121)
				{
					...
					if (eggsRemoved > 0)
					{
						itemsLostLastDeath.Add(new StardewValley.Object("CalicoEgg", eggsRemoved));
					}
				}
	...
	public void doneEating()
	{
		...
		StardewValley.Object consumed = itemToEat as StardewValley.Object;
	...
	public void eatObject(StardewValley.Object o, bool overrideFullness = false)
	{
		...
		if (Game1.objectData.TryGetValue(o.ItemId, out var data) && data.IsDrink)
		{
			...
			drinkAnimationEvent.Fire(o.getOne() as StardewValley.Object);
		}
		else if (o.Edibility != -300)
		{
			...
			eatAnimationEvent.Fire(o.getOne() as StardewValley.Object);
		}
		freezePause = 20000;
		CanMove = false;
		isEating = true;
	...
	private void performDrinkAnimation(StardewValley.Object item)
	{
		if (isEmoteAnimating)
		{
			EndEmoteAnimation();
	...
	private void performEatAnimation(StardewValley.Object item)
	{
		if (isEmoteAnimating)
		{
			EndEmoteAnimation();
	...
	public void grabObject(StardewValley.Object obj)
	{
		if (isEmoteAnimating)
		{
			EndEmoteAnimation();
