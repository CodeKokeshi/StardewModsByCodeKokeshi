...
public class GameLocation : INetObject<NetFields>, IEquatable<GameLocation>, IAnimalLocation, IHaveModData
{
	...
	[XmlIgnore]
	public readonly NetVector2Dictionary<StardewValley.Object, NetRef<StardewValley.Object>> netObjects = new NetVector2Dictionary<StardewValley.Object, NetRef<StardewValley.Object>>();

	[XmlIgnore]
	public readonly OverlayDictionary<Vector2, StardewValley.Object> overlayObjects = new OverlayDictionary<Vector2, StardewValley.Object>(tilePositionComparer);
	...
	{
		return CheckItemPlantRules(itemId, isGardenPot: false, IsGreenhouse || IsFarm || (GetData()?.CanPlantHere ?? false) || (StardewValley.Object.isWildTreeSeed(itemId) && IsOutdoors && doesTileHavePropertyNoNull(tileX, tileY, "Type", "Back") == "Dirt") || (map?.Properties.ContainsKey("ForceAllowTreePlanting") ?? false), out deniedMessage);
	}
	...
	protected virtual void OnObjectAdded(Vector2 tile, StardewValley.Object obj)
	{
		obj.Location = this;
	...
	{
		int number = 0;
		foreach (StardewValley.Object value in objects.Values)
		{
	...
	public virtual void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		if (Game1.gameMode == 3 && this == Game1.currentLocation)
		{
			...
			if (Game1.player != null)
			{
				...
				StardewValley.Object sign = null;
		...
		StardewValley.Object CheckForSign(int offsetX, int offsetY)
		{
	...
	public void createQuestionDialogue(string question, Response[] answerChoices, string dialogKey, StardewValley.Object actionObject)
	{
		lastQuestionKey = dialogKey;
		Game1.drawObjectQuestionDialogue(question, answerChoices);
	...
	public virtual void monsterDrop(Monster monster, int x, int y, Farmer who)
	{
		...
		{
			StardewValley.Object o = tryToCreateUnseenSecretNote(who);
			if (o != null)
			{
	...
	public bool tryPlaceObject(Vector2 tile, StardewValley.Object o)
	{
	...
	public virtual void DayUpdate(int dayOfMonth)
	{
		...
		objects.Lock();
		foreach (KeyValuePair<Vector2, StardewValley.Object> pair3 in objects.Pairs)
		{
		...
		if (map != null && (isOutdoors.Value || map.Properties.ContainsKey("ForceSpawnForageables")) && !map.Properties.ContainsKey("skipWeedGrowth"))
		{
			if (Game1.dayOfMonth % 7 == 0 && !(this is Farm))
			{
				...
				KeyValuePair<Vector2, StardewValley.Object>[] array4 = objects.Pairs.ToArray();
				for (int num = 0; num < array4.Length; num++)
				{
					KeyValuePair<Vector2, StardewValley.Object> pair4 = array4[num];
		...
		if (dayOfMonth == 9 && Name.Equals("Backwoods"))
		{
			...
			tryPlaceObject(new Vector2(18f, 18f), ItemRegistry.Create<StardewValley.Object>("(O)SeedSpot"));
		}
	...
	{
		KeyValuePair<Vector2, StardewValley.Object>[] array = objects.Pairs.ToArray();
	...
	public void setUpLocationSpecificFlair()
	{
		...
		case 13:
			if (value == "LewisBasement")
			{
				...
				StardewValley.Object o = ItemRegistry.Create<StardewValley.Object>("(O)789");
	...
	public void OnHarvestedForage(Farmer who, StardewValley.Object forage)
	{
	...
	public void ActivateKitchen()
	{
		...
		foreach (StardewValley.Object item in objects.Values)
		{
	...
	public void doStarpoint(string which)
	{
		if (!(which == "3"))
		{
			...
			{
				StardewValley.Object reward = ItemRegistry.Create<StardewValley.Object>("(BC)162");
		...
		{
			StardewValley.Object reward2 = ItemRegistry.Create<StardewValley.Object>("(BC)161");
	...
	public virtual bool performAction(string[] action, Farmer who, Location tileLocation)
	{
		...
		if (who.IsLocalPlayer)
		{
					...
					if (who?.ActiveObject?.QualifiedItemId == "(O)103")
					{
						...
						tempSprite.reachedStopCoordinate = delegate
						{
							...
							DelayedAction.functionAfterDelay(delegate
							{
								...
								{
									who.addItemByMenuIfNecessary(new StardewValley.Object("FarAwayStone", 1));
			...
			case "HMTGF":
				...
				{
					StardewValley.Object reward = ItemRegistry.Create<StardewValley.Object>("(BC)155");
					if (!Game1.player.couldInventoryAcceptThisItem(reward) && Game1.player.ActiveObject.stack.Value > 1)
					{
						Game1.showRedMessage(Game1.content.LoadString("Strings\\StringsFromCSFiles:Crop.cs.588"));
						break;
			...
			case "BuildingSilo":
			{
				...
				StardewValley.Object activeObj = who.ActiveObject;
	...
	public int getNumberOfMachinesReadyForHarvest()
	{
		...
		if (houseName != null)
		{
			foreach (StardewValley.Object value2 in Game1.RequireLocation(houseName).objects.Values)
			{
		...
		foreach (Building building in buildings)
		{
			...
			foreach (StardewValley.Object value3 in indoors.objects.Values)
			{
	...
	public virtual StardewValley.Object getObjectAt(int x, int y, bool ignorePassables = false)
	{
		Vector2 v = new Vector2(x / 64, y / 64);
		foreach (Furniture f in furniture)
		{
	...
	public StardewValley.Object getObjectAtTile(int x, int y, bool ignorePassables = false)
	{
	...
	private bool checkDestroyItem(StardewValley.Object o, Vector2 tilePositionToTry, bool showDestroyedObject)
	{
	...
	public StardewValley.Object removeObject(Vector2 location, bool showDestroyedObject)
	{
		objects.TryGetValue(location, out var o);
		if (o != null && (o.CanBeGrabbed || showDestroyedObject))
		{
			...
			StardewValley.Object tmp = objects[location];
	...
	public void setObjectAt(float x, float y, StardewValley.Object o)
	{
		Vector2 v = new Vector2(x, y);
		objects[v] = o;
	}
	...
	public virtual bool answerDialogueAction(string questionAndAnswer, string[] questionParams)
	{
		...
		case "Bouquet_Yes":
			if (Game1.player.Money >= 500)
			{
				...
				{
					Game1.player.Money -= 500;
					StardewValley.Object bouquet = ItemRegistry.Create<StardewValley.Object>("(O)458");
		...
		case "Mariner_Buy":
			...
			{
				Game1.player.Money -= 5000;
				StardewValley.Object mermaidPendant2 = ItemRegistry.Create<StardewValley.Object>("(O)460");
	...
	public void setObject(Vector2 v, StardewValley.Object o)
	{
		objects[v] = o;
	}
	...
	public virtual void shiftContents(int dx, int dy, Func<Vector2, object, bool> where = null)
	{
		...
		List<KeyValuePair<Vector2, StardewValley.Object>> list = new List<KeyValuePair<Vector2, StardewValley.Object>>(objects.Pairs);
		objects.Clear();
		foreach (KeyValuePair<Vector2, StardewValley.Object> v in list)
		{
	...
	public virtual void spawnObjects()
	{
		...
		foreach (KeyValuePair<Vector2, StardewValley.Object> v in objects.Pairs)
		{
		...
		while (r.NextDouble() < chanceForNewArtifactAttempt)
		{
			...
			if (CanItemBePlacedHere(location2) && !IsTileOccupiedBy(location2) && !hasTileAt(xCoord2, yCoord2, "AlwaysFront") && !hasTileAt(xCoord2, yCoord2, "Front") && !isBehindBush(location2) && (doesTileHaveProperty(xCoord2, yCoord2, "Diggable", "Back") != null || (GetSeason() == Season.Winter && doesTileHaveProperty(xCoord2, yCoord2, "Type", "Back") != null && doesTileHaveProperty(xCoord2, yCoord2, "Type", "Back").Equals("Grass"))))
			{
				...
				objects.Add(location2, ItemRegistry.Create<StardewValley.Object>(r.NextBool(0.166) ? "(O)SeedSpot" : "(O)590"));
			}
	...
	public void spawnWeedsAndStones(int numDebris = -1, bool weedsOnly = false, bool spawnFromOldWeeds = true)
	{
		...
		for (int i = 0; i < numWeedsAndStones; i++)
		{
			...
			StardewValley.Object obj = ItemRegistry.Create<StardewValley.Object>(whatToAdd);
	...
	protected void drawDebris(SpriteBatch b)
	{
		...
		foreach (Debris d in debris)
		{
			...
			if (d.item != null)
			{
				...
				if (d.item is StardewValley.Object obj && obj.bigCraftable.Value)
				{
	...
	public StardewValley.Object tryToCreateUnseenSecretNote(Farmer who)
	{
		if (currentEvent != null && currentEvent.isFestival)
		{
			return null;
		...
		return ItemRegistry.Create<StardewValley.Object>(noteItemId);
	}
	...
	public virtual void seasonUpdate(bool onLoad = false)
	{
		...
		if (IsOutdoors && !onLoad)
		{
			...
			for (int num = 0; num < array.Length; num++)
			{
				KeyValuePair<Vector2, StardewValley.Object> pair = array[num];
	...
	public static StardewValley.Object GetHayFromAnySilo(GameLocation currentLocation)
	{
		...
		return hay;
		static bool TryGetHayFrom(GameLocation location, out StardewValley.Object foundHay)
		{
			...
			foundHay = ItemRegistry.Create<StardewValley.Object>("(O)178");
	...
	public void ForEachDirt(Func<HoeDirt, bool> action, bool includeGardenPots = true)
	{
		...
		using Dictionary<Vector2, StardewValley.Object>.ValueCollection.Enumerator enumerator2 = objects.Values.GetEnumerator();
		...
		for (int x = 0; x < map.Layers[0].LayerWidth; x++)
		{
			for (int y = 0; y < map.Layers[0].LayerHeight; y++)
			{
				...
				case 15:
					...
					{
						objects.Add(tile, ItemRegistry.Create<StardewValley.Object>(getWeedForSeason(Game1.random, GetSeason())));
					}
					break;
				case 16:
					if (CanLoadPathObjectHere(tile))
					{
						objects.Add(tile, ItemRegistry.Create<StardewValley.Object>(Game1.random.Choose("(O)343", "(O)450")));
					}
					break;
				case 17:
					if (CanLoadPathObjectHere(tile))
				...
				case 18:
					if (CanLoadPathObjectHere(tile))
					{
						objects.Add(tile, ItemRegistry.Create<StardewValley.Object>(Game1.random.Choose("(O)294", "(O)295")));
					}
					break;
				}
			}
