...
public class NPC : Character, IComparable
{
	...
	public void performSpecialScheduleChanges()
	{
		...
		foreach (KeyValuePair<int, SchedulePathDescription> v in Schedule)
		{
			...
			case "IslandSouth":
			{
				...
				StardewValley.Object sign = ItemRegistry.Create<StardewValley.Object>("(BC)TextSign");
		...
		if (!foundBus && !Game1.isGreenRain)
		{
			...
			Game1.netWorldState.Value.canDriveYourselfToday.Value = true;
			StardewValley.Object sign2 = (StardewValley.Object)ItemRegistry.Create("(BC)TextSign");
	...
	public int getGiftTasteForThisItem(Item item)
	{
		...
		int tasteForItem = 8;
		if (item is StardewValley.Object { Category: var categoryNumber } obj)
		{
			...
			if (who.hasQuest("130"))
			{
				...
				if (dialogue != null)
				{
					if (!probe)
					{
						...
						{
							StardewValley.Object o = ItemRegistry.Create<StardewValley.Object>("(O)" + (activeObj.ParentSheetIndex + 1));
							o.specialItem = true;
	...
	public virtual bool checkAction(Farmer who, GameLocation l)
	{
		...
		if (base.Name == who.spouse && who.IsLocalPlayer && Sprite.CurrentAnimation == null)
		{
			...
			if (friendship != null && friendship.Points >= 3125 && who.mailReceived.Add("CF_Spouse"))
			{
				...
				StardewValley.Object stardrop = ItemRegistry.Create<StardewValley.Object>("(O)434");
	...
	public virtual void receiveGift(StardewValley.Object o, Farmer giver, bool updateGiftLimitInfo = true, float friendshipChangeMultiplier = 1f, bool showResponse = true)
	{
		if (CanReceiveGifts())
		{
	...
	public virtual Dialogue GetGiftReaction(Farmer giver, StardewValley.Object gift, int taste)
	{
	...
	public virtual void popOffAnyNonEssentialItems()
	{
		...
		{
			Point tile = base.TilePoint;
			StardewValley.Object tile_object = base.currentLocation.getObjectAtTile(tile.X, tile.Y);
