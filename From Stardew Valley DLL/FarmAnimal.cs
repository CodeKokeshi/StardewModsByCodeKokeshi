...
public class FarmAnimal : Character
{
	...
	public void dayUpdate(GameLocation environment)
	{
		...
		if (whichProduce != null && home != null)
		{
			...
			StardewValley.Object producedObject = ItemRegistry.Create<StardewValley.Object>("(O)" + whichProduce);
			...
			foreach (StardewValley.Object location_object in insideHome.objects.Values)
			{
			...
			if (spawn_object)
			{
				...
				if (hasEatenAnimalCracker.Value)
				{
					StardewValley.Object o = (StardewValley.Object)producedObject.getOne();
	...
	public virtual bool behaviors(GameTime time, GameLocation location)
	{
		...
		{
			StardewValley.Object produce = ItemRegistry.Create<StardewValley.Object>(currentProduce.Value);
	...
	public virtual void DigUpProduce(GameLocation location, StardewValley.Object produce)
	{
