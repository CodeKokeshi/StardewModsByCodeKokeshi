...
public class ItemGrabMenu : MenuWithInventory
{
	...
	public override void receiveRightClick(int x, int y, bool playSound = true)
	{
		...
		if (base.heldItem == null && showReceivingMenu)
		{
			...
			else if (base.heldItem is StardewValley.Object obj && obj?.QualifiedItemId == "(O)434")
			{
				base.heldItem = null;
	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		...
		if (base.heldItem == null && showReceivingMenu)
		{
			...
			if (base.heldItem is StardewValley.Object stardrop && stardrop?.QualifiedItemId == "(O)434")
			{
				base.heldItem = null;
				exitThisMenu(playSound: false);
			...
			if (source == 4)
			{
				...
				for (int i = 0; i < items.Count; i++)
				{
					if (items[i]?.QualifiedItemId == "(O)434")
					{
						...
						exitThisMenu(playSound: false);
						Game1.player.eatObject(items[i] as StardewValley.Object, overrideFullness: true);
						return;
					}
				}
			}
