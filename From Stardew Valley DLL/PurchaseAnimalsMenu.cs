...
// StardewValley.Menus.PurchaseAnimalsMenu
using System;
...
public class PurchaseAnimalsMenu : IClickableMenu
{
	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		...
		{
			if (readOnly || !c.containsPoint(x, y) || (c.item as StardewValley.Object).Type != null)
			{
				continue;
			}
	...
	public override void draw(SpriteBatch b)
	{
		...
		if (hovered != null)
		{
			...
			{
				IClickableMenu.drawHoverText(b, Game1.parseText((hovered.item as StardewValley.Object).Type, Game1.dialogueFont, 320), Game1.dialogueFont);
			}
			else
			{
