...
public class Event
{
	...
	public static class DefaultCommands
	{
		...
		public static void MakeInvisible(Event @event, string[] args, EventContext context)
		{
			...
			for (int y = originY; y < originY + height; y++)
			{
				...
				{
					StardewValley.Object o = location.getObjectAtTile(x, y);
		...
		public static void AddBigProp(Event @event, string[] args, EventContext context)
		{
			...
			StardewValley.Object prop = ItemRegistry.Create<StardewValley.Object>("(BC)" + itemId);
		...
		public static void AwardFestivalPrize(Event @event, string[] args, EventContext context)
		{
			...
			case "memento":
			{
				StardewValley.Object o = ItemRegistry.Create<StardewValley.Object>("(O)864");
				o.specialItem = true;
		...
		public static void FarmerEat(Event @event, string[] args, EventContext context)
		{
			...
			StardewValley.Object toEat = ItemRegistry.Create<StardewValley.Object>("(O)" + itemId);
	...
	public List<StardewValley.Object> props = new List<StardewValley.Object>();
		...
		case 13:
			...
			case 'a':
				if (key == "pamYobaStatue")
				{
					...
					location.objects.Add(new Vector2(26f, 9f), ItemRegistry.Create<StardewValley.Object>("(BC)34"));
					GameLocation gameLocation = Game1.RequireLocation("Trailer_Big");
					gameLocation.objects.Remove(new Vector2(26f, 9f));
					gameLocation.objects.Add(new Vector2(26f, 9f), ItemRegistry.Create<StardewValley.Object>("(BC)34"));
				}
				break;
			case 'p':
		...
		case 15:
			...
			case 'e':
				...
				case "harveyDinnerSet":
				{
					...
					StardewValley.Object o = location.getObjectAtTile((int)centerPoint.X, (int)centerPoint.Y);
					if (o != null)
					{
						o.isTemporarilyInvisible = true;
					}
	...
	public void draw(SpriteBatch b)
	{
		...
		foreach (StardewValley.Object prop in props)
		{
			prop.drawAsProp(b);
		}
		...
		case 10:
			...
			case 'h':
				if (id == "haleyBeach")
				{
					...
					StardewValley.Object item = ItemRegistry.Create<StardewValley.Object>("(O)742");
			...
			case 'i':
				if (id == "iceFishing")
				{
					...
					rod.attachments[1] = ItemRegistry.Create<StardewValley.Object>("(O)687");
		...
		if (isFestival)
		{
			...
			case "festival_fall16":
				...
				case 176:
					...
					{
						Game1.player.eatObject(ItemRegistry.Create<StardewValley.Object>("(O)241"), overrideFullness: true);
					}
					return true;
				case 308:
				case 309:
	...
	public bool checkForCollision(Microsoft.Xna.Framework.Rectangle position, Farmer who)
	{
		...
		{
			foreach (StardewValley.Object value in temporaryLocation.objects.Values)
			{
	...
	private void governorTaste()
	{
		...
		{
			StardewValley.Object o = luauIngredient as StardewValley.Object;
			int itemLevel = 5;
