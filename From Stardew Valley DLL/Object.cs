...
public class Object : Item
{
		...
		if (Type == "Crafting" && !(t is MeleeWeapon) && t.isHeavyHitter())
		{
			...
			if (!(qualifiedItemId == "(BC)254"))
			{
				...
				if (IsSprinkler() && heldObject.Value != null)
				{
					...
					{
						StardewValley.Object value = heldObject.Value.heldObject.Value;
						...
						if (chest2 != null)
						{
							chest2.GetMutex().RequestLock(delegate
							{
								...
								StardewValley.Object value2 = heldObject.Value;
								heldObject.Value = null;
	...
	public virtual void cutWeed(Farmer who)
	{
		...
		if (toDrop != null)
		{
			location.debris.Add(new Debris(new StardewValley.Object(toDrop, 1), tileLocation.Value * 64f + new Vector2(32f, 32f)));
		}
		...
		case "(BC)164":
		{
			...
			if (Game1.random.NextDouble() < 0.9)
			{
				...
				if (manorHouse.CanItemBePlacedHere(new Vector2(22f, 6f)))
				{
					...
					rot();
					manorHouse.objects.Add(new Vector2(22f, 6f), ItemRegistry.Create<StardewValley.Object>("(BC)164"));
				}
				break;
			}
			...
			if (animalShop.CanItemBePlacedHere(new Vector2(11f, 6f)))
			{
				...
				rot();
				animalShop.objects.Add(new Vector2(11f, 6f), ItemRegistry.Create<StardewValley.Object>("(BC)164"));
			}
			break;
		}
		case "(O)747":
	...
	public virtual bool performObjectDropInAction(Item dropInItem, bool probe, Farmer who, bool returnFalseIfItemConsumed = false)
	{
		...
		if (IsSprinkler())
		{
			if (heldObject.Value == null && (dropIn.QualifiedItemId == "(O)915" || dropIn.QualifiedItemId == "(O)913"))
			{
				...
				StardewValley.Object attached_object = dropIn.getOne() as StardewValley.Object;
	...
	public static Item OutputSolarPanel(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		int minutes = machine.MinutesUntilReady;
		GameLocation location = machine.Location;
		StardewValley.Object held_object = machine.heldObject.Value;
		if (held_object == null)
		{
			held_object = ItemRegistry.Create<StardewValley.Object>("(O)787");
	...
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputStatueOfEndlessFortune(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		...
		return new StardewValley.Object(index, 1);
	}

	/// <summary>Get the output item to produce for a Deconstructor.</summary>
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputDeconstructor(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		overrideMinutesUntilReady = null;
		...
		StardewValley.Object bestIngredient = null;
		...
		for (int i = 0; i < ingredients.Length; i += 2)
		{
			...
			StardewValley.Object ingredient = new StardewValley.Object(text, count);
	...
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputAnvil(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		overrideMinutesUntilReady = null;
	...
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputGeodeCrusher(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		overrideMinutesUntilReady = null;
	...
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputIncubator(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
	...
	/// <inheritdoc cref="T:StardewValley.Delegates.MachineOutputDelegate" />
	public static Item OutputSeedMaker(StardewValley.Object machine, Item inputItem, bool probe, MachineItemOutput outputData, Farmer player, out int? overrideMinutesUntilReady)
	{
		overrideMinutesUntilReady = null;
		...
		{
			return new StardewValley.Object("499", 1);
		}
		if (r.NextDouble() < 0.02)
		{
			return new StardewValley.Object("770", r.Next(1, 5));
		}
		return new StardewValley.Object(seed, r.Next(1, 4));
	}
	...
	public virtual bool OutputMachine(MachineData machine, MachineOutputRule outputRule, Item inputItem, Farmer who, GameLocation location, bool probe, bool heldObjectOnly = false)
	{
		...
		heldObject.Value = (StardewValley.Object)newHeldItem;
		if (!heldObjectOnly)
		{
	...
	public virtual void updateWhenCurrentLocation(GameTime time)
	{
		...
		if (_hasHeldObject)
		{
			StardewValley.Object heldObject = this.heldObject.Get();
			...
			for (int y = (int)center.Y - radius; (float)y < center.Y + (float)radius; y++)
			{
				if (Math.Round(Utility.distance(x, center.X, y, center.Y)) == (double)(radius - 1))
				{
					...
					if (gameLocation.CanItemBePlacedHere(location) && !gameLocation.IsTileOccupiedBy(location) && !gameLocation.hasTileAt(x, y, "AlwaysFront") && !gameLocation.hasTileAt(x, y, "Front") && !gameLocation.isBehindBush(location) && (gameLocation.doesTileHaveProperty(x, y, "Diggable", "Back") != null || (gameLocation.GetSeason() == Season.Winter && gameLocation.doesTileHaveProperty(x, y, "Type", "Back") == "Grass")))
					{
						...
						gameLocation.objects.Add(location, ItemRegistry.Create<StardewValley.Object>("(O)590"));
					}
	...
	protected virtual bool CheckForActionOnMiniObelisk(Farmer who, bool justCheckingForActivity = false)
	{
		...
		foreach (KeyValuePair<Vector2, StardewValley.Object> o in location.objects.Pairs)
		{
	...
	protected bool CheckForActionOnMachine(Farmer who, bool justCheckingForActivity = false)
	{
		...
		if (readyForHarvest.Value)
		{
			...
			MachineData machineData = GetMachineData();
			StardewValley.Object outputObj = heldObject.Value;
	...
	private string getFluteBlockSoundFromHeldObject(StardewValley.Object o)
	{
		...
		else
		{
			...
			case "(BC)96":
				...
				if (MinutesUntilReady <= 0)
				{
					...
					environment.objects.Add(tileLocation.Value, ItemRegistry.Create<StardewValley.Object>("(BC)98"));
	...
	protected override Item GetOneNew()
	{
		if (!bigCraftable.Value)
		{
			return new StardewValley.Object(base.ItemId, 1);
		}
		return new StardewValley.Object(tileLocation.Value, base.ItemId);
	}
	...
	protected override void GetOneCopyFrom(Item source)
	{
		...
		if (source is StardewValley.Object fromObj)
		{
			Scale = fromObj.scale;
	...
	public override bool canBePlacedHere(GameLocation l, Vector2 tile, CollisionMask collisionMask = CollisionMask.All, bool showError = false)
	{
		...
		case -74:
		{
			...
			StardewValley.Object obj = l.getObjectAtTile((int)tile.X, (int)tile.Y);
	...
	public virtual bool placementAction(GameLocation location, int x, int y, Farmer who = null)
	{
		...
		else
		{
			if (IsTapper())
			{
				if (location.terrainFeatures.TryGetValue(placementTile, out var terrainFeature3) && terrainFeature3 is Tree tree3 && tree3.growthStage.Value >= 5 && !tree3.stump.Value && !location.objects.ContainsKey(placementTile) && (!tree3.isTemporaryGreenRainTree.Value || Game1.season != Season.Summer))
				{
					...
					{
						StardewValley.Object tapper = (StardewValley.Object)getOne();
				...
				if (length <= 7)
				{
					...
					case 7:
						...
						case '8':
							...
							case "(BC)108":
							{
								StardewValley.Object tub = (StardewValley.Object)getOne();
						...
						case '5':
						{
							...
							StardewValley.Object autoGrabber = ItemRegistry.Create<StardewValley.Object>("(BC)165");
				...
				if (dirt3 != null)
				{
					...
					if (dirt3.canPlantThisSeedHere(seedId, who.ActiveObject.Category == -19))
					{
						if (dirt3.plant(seedId, who, who.ActiveObject.Category == -19) && who.IsLocalPlayer)
						{
							if (base.Category == -74)
							{
								foreach (StardewValley.Object o2 in location.Objects.Values)
								{
									...
									StardewValley.Object value = o2.heldObject.Value.heldObject.Value;
									Chest chest2 = value as Chest;
									if (chest2 == null)
									{
										continue;
		...
		{
			StardewValley.Object toPlace = (StardewValley.Object)getOne();
